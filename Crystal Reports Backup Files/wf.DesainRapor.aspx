                                                    ...
                                                    <ItemTemplate>
                                                        <tr class="<%# (Container.DisplayIndex % 2 == 0 ? "standardrow" : "oddrow") %>">
                                                            ...
                                                            <td style="font-weight: bold; padding: 10px; vertical-align: middle; text-align: center; width: 100px;">
                                                                ...
                                                                </label><label title=" Desain Ekskul " onclick="ShowProgress(true); setTimeout(function() { <%= txtID.ClientID %>.value = '<%# Eval("Kode").ToString() %>';<%= btnShowDesainEkskul.ClientID %>.click(); }, 500);" class="badge" style="background-color: darkred; cursor: pointer; font-weight: normal; font-size: x-small; border-top-left-radius: 0px; border-bottom-left-radius: 0px;">
                                        ...
                                        <asp:View runat="server" ID="vDesain">
                                            ...
                                            <div class="fbtn-container" id="div_button_settings_rapor_design" runat="server">
		                                        <div class="fbtn-inner">
                                                    ...
                                                    <div class="fbtn-dropup" style="z-index: 999999;">
				                                        <asp:LinkButton OnClientClick="ShowProgress(true);" CssClass="fbtn fbtn-green waves-attach waves-circle waves-effect" runat="server" id="lnkAddKategoriPencapaianEkskul" style="background-color: black; color: white;" OnClick="lnkAddKategoriPencapaianEkskul_Click">
                                                        ...
                                                        <asp:LinkButton OnClientClick="ShowProgress(true);" CssClass="fbtn fbtn-green waves-attach waves-circle waves-effect" runat="server" ID="lnkAddSubKategoriPencapaianEkskul" style="background-color: black;" OnClick="lnkAddSubKategoriPencapaianEkskul_Click">
                                                        ...
                                                        <asp:LinkButton OnClientClick="ShowProgress(true);" CssClass="fbtn fbtn-green waves-attach waves-circle waves-effect" runat="server" ID="lnkAddPoinKategoriPencapaianEkskul" style="background-color: black;" OnClick="lnkAddPoinKategoriPencapaianEkskul_Click">
                                                        ...
                                                        <asp:LinkButton OnClientClick="ShowProgress(true);" CssClass="fbtn fbtn-green waves-attach waves-circle waves-effect" runat="server" ID="lnkAddRekomendasiEkskul" style="background-color: black;" OnClick="lnkAddRekomendasiEkskul_Click">
