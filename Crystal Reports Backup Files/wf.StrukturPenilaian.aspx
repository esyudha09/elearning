<%@ Page Title="" Language="C#" MasterPageFile="~/Application_Masters/Main.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="wf.StrukturPenilaian.aspx.cs" Inherits="AI_ERP.Application_Modules.EDUCATION.Penilaian.SMP.wf_StrukturPenilaian" %>
                                                        ...
                                                        <tr class="<%# 
                                                            ...
                                                            <td style="font-weight: bold; padding: 10px; vertical-align: middle; text-align: left; padding-top: 2px; padding-bottom: 2px; color: grey;">
                                                                ...
                                                                <label title=" Struktur Nilai " onclick="DoScrollPos(); <%= txtID.ClientID %>.value = '<%# Eval("Kode").ToString() %>';<%= btnShowStrukturNilai.ClientID %>.click();"
                                                                    style="<%= (AI_ERP.Application_Modules.EDUCATION.Penilaian.SMP.wf_StrukturPenilaian.LockInput() ? " display: none; " : "") %> cursor: pointer; font-weight: normal; font-size: small; border-radius: 0px; color: darkblue;">
                                                                    ...
                                                                    style="
                                                                            <%#
                                                                                (
                                                                                    ...
                                                                                    ) == AI_ERP.Application_Libs.Libs.JenisKurikulum.SMP.KURTILAS
                                                                                    ? " display: none; "
                                                                                    : ""
                                                                                )
                                                                    ...
                                                                    style="
                                                                            <%#
                                                                                (
                                                                                    AI_ERP.Application_DAOs.Elearning.SMP.DAO_Rapor_StrukturNilai.GetKurikulumByLevel(
                                                                                        Eval("Rel_Kelas").ToString(), Eval("TahunAjaran").ToString(), Eval("Semester").ToString()
                                                                                    ) == AI_ERP.Application_Libs.Libs.JenisKurikulum.SMP.KTSP
                                                                                    ? " display: none; "
                                                                                    : ""
                                                                                )
                                                                            %> cursor: pointer; font-weight: normal; font-size: small; border-radius: 0px; color: darkblue;">
