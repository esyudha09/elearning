<%@ Page Title="" Language="C#" ValidateRequest="false" MasterPageFile="~/Application_Masters/Main.Master" AutoEventWireup="true" CodeBehind="wf.NilaiSiswaSikap.aspx.cs" Inherits="AI_ERP.Application_Modules.EDUCATION.Penilaian.SMA.wf_NilaiSiswaSikap" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function SaveNilaiSikap(tahun_ajaran, semester, rel_mapel, rel_kelasdet, rel_siswa, sikap_spiritual, sikap_sosial) {
            var s_url = "<%= ResolveUrl(AI_ERP.Application_Libs.Routing.URL.APIS.SMA.NILAI_SISWA.DO_SAVE.FILE + "/DoUpdateSikap") %>";
