<%@ Page Title="" Language="C#" MasterPageFile="~/Application_Masters/Main.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="wf.Ortu.MateriPembelajaran.aspx.cs" Inherits="AI_ERP.Application_Modules.EDUCATION.Elearning.wf_Ortu_MateriPembelajaran" %>
                                                    ...
                                                    <ItemTemplate>
                                                        <tr class="<%# (Container.DisplayIndex % 2 == 0 ? "standardrow" : "oddrow") %>">
                                                            ...
                                                            <td style="font-weight: bold; padding: 10px; vertical-align: middle; text-align: left;">
                                                                <img
                                                                    src="<%# 
                                                                            ResolveUrl("~/Application_Controls/Res/ImageViewer.aspx?ID=" + Eval("Rel_Pegawai").ToString() + "&Jenis=Pegawai" + "&Time=" + DateTime.Now.ToString())
                                                                            %>"
                                                                    style="height: 55px; width: 52px; border-radius: 100%; margin-bottom: 10px;" />
                                                                &nbsp;
                                                ...
                                                <div class="row">
													<div class="col-md-12" style="padding-left: 40px; padding-right: 40px;">
														...
														<div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
															<label class="label-input" style="font-weight: bold; text-transform: none; margin-bottom: 5px; color: black;">
																Materi Pembelajaran
															</label>
                                                            <br />
															<asp:TextBox Visible="false" runat="server" ID="txtTemplateMateri" CssClass="mcetiny_materi"></asp:TextBox>
                                                            <asp:Literal runat="server" ID="ltrCaptionMateriDet"></asp:Literal>
                                                            <hr style="margin: 10px; margin-left: 0px; margin-right: 0px;" />
                                                            <asp:Literal runat="server" ID="ltrMateriPembelajaran"></asp:Literal>
														</div>
