<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AutocompleteKategoriPencapaian.ascx.cs" Inherits="AI_ERP.Application_Controls.Elearning.TK.AutocompleteKategoriPencapaian.AutocompleteKategoriPencapaian" %>
    ...
    function <%=txtNama.ClientID%>_SHOW_AUTOCOMPLETE(){
        $('[id*=<%=txtNama.ClientID%>]').typeahead({
            ...
            source: function (request, response) {
                $.ajax({
                    url: '<%=ResolveUrl("~/APIs/Elearning/TK/KategoriPencapaian.svc/ShowAutocompleteKategoriPencapaian?kata_kunci=") %>' + request,
                    dataType: "json",
                    type: "GET",
