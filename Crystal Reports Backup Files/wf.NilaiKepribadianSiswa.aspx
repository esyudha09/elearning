<%@ Page Title="" Language="C#" MasterPageFile="~/Application_Masters/Main.Master" AutoEventWireup="true" CodeBehind="wf.NilaiKepribadianSiswa.aspx.cs" Inherits="AI_ERP.Application_Modules.EDUCATION.Penilaian.SMP.wf_NilaiKepribadianSiswa" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel runat="server" ID="upMain">
        <ContentTemplate>
            ...
            <asp:Button UseSubmitBehavior="false" OnClientClick="ShowProgress(true);" runat="server" ID="btnShowIsiCatatan" OnClick="btnShowIsiCatatan_Click" Style="position: absolute; left: -1000px; top: -1000px;" />        
                        ...
                        <div class="modal-dialog modal-xs">
                            <div class="modal-content" style="border: none; border-top-left-radius: 6px; border-top-right-radius: 6px;">
                                                    ...
                                                    <div class="row" style="margin-left: 15px; margin-right: 15px; margin-top: 20px;">
                                                        <div class="col-xs-12">
                                                            <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                                <label class="label-input" for="<%= txtKelakuan.ClientID %>" style="text-transform: none;">Kelakuan</label>
                                                                <asp:TextBox CssClass="form-control" runat="server" ID="txtKelakuan"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row" style="margin-left: 15px; margin-right: 15px; margin-top: 20px;">
                                                        <div class="col-xs-12">
                                                            <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                                <label class="label-input" for="<%= txtKerajinan.ClientID %>" style="text-transform: none;">Kerajinan</label>
                                                                <asp:TextBox CssClass="form-control" runat="server" ID="txtKerajinan"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row" style="margin-left: 15px; margin-right: 15px; margin-top: 20px;">
                                                        <div class="col-xs-12">
                                                            <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                                <label class="label-input" for="<%= txtKerapian.ClientID %>" style="text-transform: none;">Kerapian</label>
                                                                <asp:TextBox CssClass="form-control" runat="server" ID="txtKerapian"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                    </div>
										        </div>  
                                ...
                                <div class="modal-footer">                            
                                    <p class="text-right">
                                        <asp:LinkButton CssClass="btn btn-flat btn-brand-accent waves-attach waves-effect" runat="server" ID="lnkOKSaveCatatan" OnClick="lnkOKSaveCatatan_Click" Text="  SIMPAN  "></asp:LinkButton>
