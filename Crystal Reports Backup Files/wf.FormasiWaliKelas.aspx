<%@ Page Title="" Language="C#" MasterPageFile="~/Application_Masters/Main.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="wf.FormasiWaliKelas.aspx.cs" Inherits="AI_ERP.Application_Modules.MASTER.wf_FormasiWaliKelas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function EndRequest() {
            ...
            InitModalFocus();
            <%= txtWaliKelas.NamaClientID %>_SHOW_AUTOCOMPLETE();
                                    ...
                                    <table style="width: 100%;">
                                        <tr>
                                            <td style="background-color: #295BC8; padding: 10px; font-weight: normal; vertical-align: middle; color: white; padding-left: 20px; font-size: 15px;">
                                                <img src="<%= ResolveUrl("~/Application_CLibs/images/svg/professor-1.svg") %>" 
								                                ...
								                                <thead>
								                                    <tr style="background-color: #3367d6;">
                                                                        ...
                                                                        <th style="background-color: #3367d6; text-align: left; padding-left: 10px; vertical-align: middle;">
                                                                            ...
                                                                            <asp:Literal runat="server" ID="imgh_kelasdet" Visible="false"></asp:Literal>
									                                    </th>
                                                                        <th style="background-color: #3367d6; text-align: left; padding-left: 10px; vertical-align: middle;">
                                                                            <asp:LinkButton ID="H_WaliKelas" runat="server" CommandName="Sort" CommandArgument="Walas" style="color: white; font-weight: bold;">
                                                                                Wali Kelas
                                                                            </asp:LinkButton>
                                                                            <asp:Literal runat="server" ID="imgh_walikelas" Visible="false"></asp:Literal>
									                                    </th>
								                                    </tr>
							                                    </thead>
							                                    <tbody>     
                                                    ...
                                                    <ItemTemplate>
                                                        <tr class="<%# (Container.DisplayIndex % 2 == 0 ? "standardrow" : "oddrow") %>">
                                                            ...
                                                            <td style="font-weight: bold; padding: 10px; vertical-align: middle; text-align: left;">
                                                                ...
                                                                &nbsp;
                                                                <span class="badge" style="font-weight: normal; text-transform: none; text-decoration: none; background-color: #bfbfbf;">
                                                                    Sm.
                                                                    <%# 
                                                            ...
                                                            <td style="font-weight: bold; padding: 10px; vertical-align: middle; text-align: left;">
                                                                <span style="color: grey; font-weight: normal; text-transform: none; text-decoration: none;">
                                                                    <%# 
                                                                        AI_ERP.Application_Libs.Libs.GetHTMLSimpleText(Eval("Walas").ToString())
                                                                    %>
                                                                </span>
                                                            </td>
                                                        </tr>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div style="width: 100%; background-color: white; padding-top: 15px;">
                                            ...
                                            <div class="row" style="margin-left: 30px; margin-right: 30px;">
                                                <div class="col-xs-12" style="padding-left:  0px; padding-right: 0px;">
                                                    <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                        <label class="label-input" for="<%= txtWaliKelas.NamaClientID %>" style="text-transform: none;">Wali Kelas</label>
                                                        <asp:RequiredFieldValidator ValidationGroup="vldInput" runat="server" ID="vldWaliKelas"
                                                            ControlToValidate="txtWaliKelas$txtNama" Display="Dynamic" style="float: right; font-weight: bold;"
                                                            Text="<i class='fa fa-exclamation-triangle'></i>" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                                        <ucl:AutocompletePegawai runat="server" ID="txtWaliKelas" />
                                                    </div>
                                                </div>
                                            </div>                                                                                       
										</div>  
