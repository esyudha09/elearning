<%@ Page Title="" Language="C#" MasterPageFile="~/Application_Masters/Main.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="wf.FormasiGuruKelas.aspx.cs" Inherits="AI_ERP.Application_Modules.MASTER.wf_FormasiGuruKelas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function EndRequest() {
            ...
            InitModalFocus();
            <%= txtGuruKelas.NamaClientID %>_SHOW_AUTOCOMPLETE();
            <%= txtGuruPendamping.NamaClientID %>_SHOW_AUTOCOMPLETE();
                        ...
                        for (var i = 0; i < arr_kelas.length; i++) {
                            ...
                            if (arr_kelas[i].indexOf(kk_unit) >= 0) {
                                ...
                                if (arr_item_kelas.length === 2) {
                                    ...
                                    if(option.value === <%= txtKelasUnit.ClientID %>.value){
                                    ...
                                    <table style="width: 100%;">
                                        <tr>
                                            <td style="background-color: #295BC8; padding: 10px; font-weight: normal; vertical-align: middle; color: white; padding-left: 20px; font-size: 15px;">
                                                <img src="<%= ResolveUrl("~/Application_CLibs/images/svg/boss-1.svg") %>" 
                                                    ...
                                                    <ItemTemplate>
                                                        <tr class="<%# 
                                                            ...
                                                            <td style="font-weight: bold; padding: 10px; vertical-align: middle; text-align: left;">
                                                                ...
                                                                <%# 
                                                                    AI_ERP.Application_Libs.Libs.GetHTMLBadgeUnit(Eval("Sekolah").ToString())
                                                                %>
                                                                <br />
                                                                ...
                                                                <span style="color: #1DA1F2; font-weight: bold; text-transform: none; text-decoration: none;">
                                                                    <%# 
                                                                        ...
                                                                        (
                                                                            ...
                                                                            AI_ERP.Application_Libs.Libs.GetHTMLSimpleText(Eval("GuruKelas").ToString()).Trim() != AI_ERP.Application_Libs.Libs.GetHTMLSimpleText(Eval("GuruPendamping").ToString()).Trim()
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div style="width: 100%; background-color: white; padding-top: 15px;">
                                            ...
                                            <div class="row" style="margin-left: 30px; margin-right: 30px;">
                                                <div class="col-xs-12" style="padding-left:  0px; padding-right: 0px;">
                                                    <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                        <label class="label-input" for="<%= txtGuruKelas.NamaClientID %>" style="text-transform: none;">Guru Kelas/Wali Kelas</label>
                                                        <asp:RequiredFieldValidator ValidationGroup="vldInput" runat="server" ID="vldGuruKelas"
                                                            ControlToValidate="txtGuruKelas$txtNama" Display="Dynamic" style="float: right; font-weight: bold;"
                                                            Text="<i class='fa fa-exclamation-triangle'></i>" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                                        <ucl:AutocompletePegawaiByUnit runat="server" ID="txtGuruKelas" />
                                                    </div>
                                                </div>
                                            </div>                                           
                                            <div runat="server" id="div_guru_pendamping" class="row" style="margin-left: 30px; margin-right: 30px;">
                                                <div class="col-xs-12" style="padding-left:  0px; padding-right: 0px;">
                                                    <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                        <label class="label-input" for="<%= txtGuruPendamping.NamaClientID %>" style="text-transform: none;">Guru Pendamping</label>
                                                        <ucl:AutocompletePegawaiByUnit runat="server" ID="txtGuruPendamping" />
                                                    </div>
                                                </div>
                                            </div>                                                                                       
										</div>  
