...
{
    public partial class wf_PengaturanSMP : System.Web.UI.Page
    {
        public const string SessionViewDataName = "PAGEPENGATURANSMP";
        ...
        {
            cboKurikulumRaporLevel7.Items.Add("");
            cboKurikulumRaporLevel7.Items.Add(new ListItem { Value = Libs.JenisKurikulum.SMP.KTSP, Text = Libs.JenisKurikulum.SMP.KTSP });
            cboKurikulumRaporLevel7.Items.Add(new ListItem { Value = Libs.JenisKurikulum.SMP.KURTILAS, Text = Libs.JenisKurikulum.SMP.KURTILAS });

            cboKurikulumRaporLevel8.Items.Add("");
            cboKurikulumRaporLevel8.Items.Add(new ListItem { Value = Libs.JenisKurikulum.SMP.KTSP, Text = Libs.JenisKurikulum.SMP.KTSP });
            cboKurikulumRaporLevel8.Items.Add(new ListItem { Value = Libs.JenisKurikulum.SMP.KURTILAS, Text = Libs.JenisKurikulum.SMP.KURTILAS });

            cboKurikulumRaporLevel9.Items.Add("");
            cboKurikulumRaporLevel9.Items.Add(new ListItem { Value = Libs.JenisKurikulum.SMP.KTSP, Text = Libs.JenisKurikulum.SMP.KTSP });
            cboKurikulumRaporLevel9.Items.Add(new ListItem { Value = Libs.JenisKurikulum.SMP.KURTILAS, Text = Libs.JenisKurikulum.SMP.KURTILAS });
        }
        ...
        protected void InitFields()
        {
            ...
            cboKurikulumRaporLevel7.SelectedValue = "";
            cboKurikulumRaporLevel8.SelectedValue = "";
            cboKurikulumRaporLevel9.SelectedValue = "";
        }
            ...
            if (txtID.Value.Trim() != "")
            {
                ...
                if (m != null)
                {
                    if (m.TahunAjaran != null)
                    {
                        ...
                        cboKurikulumRaporLevel7.SelectedValue = m.KurikulumRaporLevel7;
                        cboKurikulumRaporLevel8.SelectedValue = m.KurikulumRaporLevel8;
                        cboKurikulumRaporLevel9.SelectedValue = m.KurikulumRaporLevel9;
            ...
            try
            {
                ...
                if (txtID.Value.Trim() == "")
                {
                    DAO_Rapor_Pengaturan.Insert(new Rapor_Pengaturan
                    {
                        ...
                        KurikulumRaporLevel7 = cboKurikulumRaporLevel7.SelectedValue,
                        KurikulumRaporLevel8 = cboKurikulumRaporLevel8.SelectedValue,
                        KurikulumRaporLevel9 = cboKurikulumRaporLevel9.SelectedValue
                    });
                }
                else
                {
