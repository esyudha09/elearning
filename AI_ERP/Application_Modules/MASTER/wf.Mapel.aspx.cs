...
{
    public partial class wf_Mapel : System.Web.UI.Page
    {
        ...
        private void BindListView(bool isbind = true, string keyword = "")
        {
            ...
            if (IsByAdminUnit())
            {
                if (keyword.Trim() != "")
                {
                    ...
                    sql_ds.SelectCommand = DAO_Mapel.SP_SELECT_ALL_BY_UNIT_FOR_SEARCH;
                }
                else
                {
                    sql_ds.SelectParameters.Clear();
                    sql_ds.SelectParameters.Add("Rel_Sekolah", QS.GetUnit());
                    sql_ds.SelectCommand = DAO_Mapel.SP_SELECT_ALL_BY_UNIT;
                }
            }
            else
            {
                if (keyword.Trim() != "")
                {
                    sql_ds.SelectParameters.Clear();
                    sql_ds.SelectParameters.Add("nama", keyword);
                    sql_ds.SelectCommand = DAO_Mapel.SP_SELECT_ALL_FOR_SEARCH;
                }
                else
                {
                    sql_ds.SelectParameters.Clear();
                    sql_ds.SelectCommand = DAO_Mapel.SP_SELECT_ALL;
                }
            }                            
