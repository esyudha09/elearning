...
{
    public partial class wf_Ortu_MateriPembelajaran : System.Web.UI.Page
    {
        public const string SessionViewDataName = "PAGEDATAORTUMATERI";
            ...
            if (txtID.Value.Trim() != "")
            {
                ...
                if (m != null)
                {
                    if (m.Materi != null)
                    {
                        ...
                        Pegawai m_pegawai = DAO_Pegawai.GetByID_Entity(m.Rel_Pegawai.ToString());

                        ltrCaptionMateriDet.Text =
                                             "<img " +
                                                "src=\"" +
                                                     ResolveUrl("~/Application_Controls/Res/ImageViewer.aspx?ID=" + m.Rel_Pegawai + "&Jenis=Pegawai" + "&Time=" + DateTime.Now.ToString()) +
                                                     "\"" +
                                                     "style=\"height: 55px; width: 52px; border-radius: 100%; margin-bottom: 10px;\" /> " +

                                             "<br />" +
                                             "<span style=\"font-weight: bold;\">" + m_pegawai.Nama + "</span>" +
                                             "<br />" +
                        ...
                        ltrMateriPembelajaran.Text = m.Materi;
