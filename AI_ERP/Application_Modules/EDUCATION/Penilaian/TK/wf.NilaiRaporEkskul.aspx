<%@ Page Title="" Language="C#" MasterPageFile="~/Application_Masters/Main.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="wf.NilaiRaporEkskul.aspx.cs" Inherits="AI_ERP.Application_Modules.EDUCATION.Penilaian.TK.wf_NilaiRaporEkskul" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">    
    <script type="text/javascript">
        ...
        function EndRequest() {
            ...
            switch (jenis_act) {
                ...
                case "<%= JenisAction.Delete %>":
                    HideModal();
                    break;
                case "<%= JenisAction.DoShowListSiswa %>":
                    ShowProgress(false);
                    document.body.style.paddingRight = "0px";
                    $('#ui_modal_list_siswa').modal({ backdrop: 'static', keyboard: false, show: true });
        ...
        function txtLTSCK_Kehadiran() { return document.getElementById("<%= txtLTSCK_Kehadiran.ClientID %>"); }
        ...
        function SaveNilaiRapor(deskripsi) {
               ...
               )
            {
                ...
                var s_url = '<%= ResolveUrl(AI_ERP.Application_Libs.Routing.URL.APIS.TK.NILAI_SISWA.DO_SAVE.FILE + "/Do") %>' +
                            '?' +
                            't=' + tahun_ajaran + '&' +
                            'sm=' + semester + '&' +
                            's=' + siswa + '&' +
        ...
        function SaveCK(deskripsi) {
            if (
                    txtTahunAjaran() !== null && txtTahunAjaran() !== undefined &&
                    txtSemester() !== null && txtSemester() !== undefined &&
                    txtIDSiswa() !== null && txtIDSiswa() !== undefined &&
                    txtKelasDet() !== null && txtKelasDet() !== undefined &&
                    txtLTSCK_Kehadiran() !== null && txtLTSCK_Kehadiran() !== undefined
               )
            {
                var tahun_ajaran = txtTahunAjaran().value;
                var semester = txtSemester().value;
                var siswa = txtIDSiswa().value;
                var rel_kelasdet = txtKelasDet().value;
                var lst_ck_abs = txtLTSCK_Kehadiran().value;
                
                var s_url = '<%= ResolveUrl(AI_ERP.Application_Libs.Routing.URL.APIS.TK.NILAI_SISWA.DO_SAVE.FILE + "/DoCK") %>' +
                            '?' +
                            't=' + tahun_ajaran + '&' +
                            'sm=' + semester + '&' +
                            's=' + siswa + '&' +
                            'kd=' + rel_kelasdet + '&' +
                            'lst_ck_abs=' + lst_ck_abs;
        ...
        function ProcessPengaturan() {
            var url = "<%= ResolveUrl(AI_ERP.Application_Libs.Routing.URL.APPLIACTION_MODULES.EDUCATION.Penilaian.TK.BUAT_NILAI_RAPOR_STANDAR.ROUTE) %>";
            ...
            if(s_kriteria.trim() !== ""){
                ...
                url += "&kd=" + <%= txtKelasDet.ClientID %>.value;
                url += (GetIDSiswa().trim() !== "" ? "&s=" + GetIDSiswa() : "");
                url += "&kt=" + s_kriteria;
                url += "&m=" + <%= txtKodeMapel.ClientID %>.value;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:UpdatePanel runat="server" ID="upMainDeskripsi" UpdateMode="Conditional" ChildrenAsTriggers="false">
        <ContentTemplate>
            ...
            <asp:Button UseSubmitBehavior="false" runat="server" ID="btnShowDataListSiswa" OnClick="btnShowDataListSiswa_Click" style="position: absolute; left: -1000px; top: -1000px;" />
    ...
    <asp:UpdatePanel runat="server" ID="upMain">
        <ContentTemplate>
            ...
            <asp:HiddenField runat="server" ID="txtIDGuru" />
                                                ...
                                                <asp:ListView ID="lvData" DataSourceID="sql_ds" runat="server" OnSorting="lvData_Sorting" OnPagePropertiesChanging="lvData_PagePropertiesChanging">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr class="<%# (Container.DisplayIndex % 2 == 0 ? "standardrow" : "oddrow") %>">
                                                            <td style="text-align: center; padding: 10px; vertical-align: middle; width: 40px; color: #bfbfbf;">
                                                            ...
                                                            <td style="font-weight: bold; padding: 10px; vertical-align: middle; text-align: left;">
                                                                ...
                                                                &nbsp;
                                                                <span style="color: #833700; font-weight: bold; text-transform: none; text-decoration: none;">
                                                                    <%# 
                                                                        Eval("NamaKelasDet").ToString()
                                                                    %>
                                                                </span>
                                                                <%# 
                                                                    AI_ERP.Application_Modules.EDUCATION.Penilaian.TK.wf_NilaiRaporEkskul.IsPosted(
                                                                ...
                                                                <span style="color: #1DA1F2; font-weight: bold; text-transform: none; text-decoration: none;">
                                                                    <%# 
                                                                        Eval("NamaMapel").ToString()
                                                                    %>
                                                                </span>
                                                                <br />
                                                                <%# 
                                                                    (
                                                                        !AI_ERP.Application_Modules.EDUCATION.Penilaian.TK.wf_NilaiRaporEkskul.IsUdahDiaturNilaiDefault(
                                                                            Eval("Kode").ToString(),
                                                                            Eval("KodeKelasDet").ToString(),
                                                                            Eval("KodeMapel").ToString()                                                                            
                                                                        ) == true
                                                                        ? (
                                                                                AI_ERP.Application_Libs.Libs.URL_IDENTIFIER.IsAdaIDUrlIdAdminUnit() 
                                                                                ? ""
                                                                                : "<label title=\" Pengaturan \" onclick=\"" + txtJenisNilaiDefault.ClientID + ".value = ''; ShowProgress(true); setTimeout(function(){ " + txtKodeMapel.ClientID + ".value = '" + Eval("KodeMapel").ToString() + "'; " + txtID.ClientID + ".value = '" + Eval("Kode").ToString() + "'; " + txtKelasDet.ClientID + ".value = '" + Eval("KodeKelasDet").ToString() + "'; " + btnShowPengaturanNilaiStandar.ClientID + ".click(); }, 500);\" style=\"cursor: pointer; font-weight: normal; font-size: small; color: green; margin-top: 10px;\">" +
                                                                        ...
                                                                        : (
                                                                          ...
                                                                          "<label title=\" Buka \" onclick=\"ShowProgress(true); " + txtKodeMapel.ClientID + ".value = '" + Eval("KodeMapel").ToString() + "'; " + txtKelasDet.ClientID + ".value = '" + Eval("KodeKelasDet").ToString() + "'; " + txtID.ClientID + ".value = '" + Eval("Kode").ToString() + "'; " + btnShowDesain.ClientID + ".click();\" style=\"cursor: pointer; font-weight: normal; font-size: small; color: green; margin-top: 10px;\">" +
                                                                            "&nbsp;" +
                                                                            "<i class=\"fa fa-folder-open\"></i>" +
                                                                            "&nbsp;" +
                                                                            "Buka" +
                                                                            "&nbsp;" +
                                                                            AI_ERP.Application_Modules.EDUCATION.Penilaian.TK.wf_NilaiRaporEkskul.GetHTMLNotifJumlahSiswa(
                                                                                Eval("KodeKelasDet").ToString(),
                                                                                Eval("Kode").ToString(),
                                                                                Eval("KodeMapel").ToString()   
                                                                            ) +
                                                                          ...
                                                                          "<span style=\"color: #dddddd;\">&nbsp;&nbsp;|&nbsp;&nbsp;</span>" +
                                                                          (
                                                                            AI_ERP.Application_Modules.EDUCATION.Penilaian.TK.wf_NilaiRaporEkskul.GetJumlahNoReadOnly(
                                                                                Eval("KodeKelasDet").ToString(),
                                                                                Eval("Kode").ToString(),
                                                                                Eval("KodeMapel").ToString()   
                                                                            ) == 0
                                                                            ? "<label title=\" Upload \" style=\"font-weight: normal; font-size: small; color: #bfbfbf; margin-top: 10px;\">" +
                                                                                ...
                                                                                "&nbsp;" +
                                                                              "</label>"
                                                                            : "<label title=\" Upload \" onclick=\"ShowProgress(true); " + (AI_ERP.Application_Libs.Libs.URL_IDENTIFIER.IsAdaIDUrlIdAdminUnit()  ? txtKelasDet.ClientID + ".value = '" + Eval("KodeKelasDet").ToString() + "'; " : "") + txtKodeMapel.ClientID + ".value = '" + Eval("KodeMapel").ToString() + "'; " + txtID.ClientID + ".value = '" + Eval("Kode").ToString() + "';" + btnShowConfirmPostingByKelas.ClientID + ".click();\" style=\"cursor: pointer; font-weight: normal; font-size: small; color: green; margin-top: 10px;\">" +
                                                                                "&nbsp;" +
                                                                                "<i class=\"fa fa-upload\"></i>" +
                                                                                "&nbsp;" +
                                                                                "Upload" +
                                                        ...
                                                        <div class="table-responsive" style="margin-top: 0px; margin-bottom: 0px; box-shadow: 0 -1px 0 rgba(0, 0, 0, 0), 0 0 3px rgba(0, 0, 0, 0.18), 0 1px 3px rgba(0, 0, 0, 0.0);">
					                                        <div id="div_body_nilai_rapor" runat="server"
                                                                ...
                                                                <div id="div_header_nilai_rapor"  runat="server" style="width: 100%; background-color: #295BC8; padding: 10px;">
                                                                    ...
                                                                    &nbsp;
                                                                    <span style="font-weight: bold; color: white;">Nilai Ekstrakurikuler</span>
                                                                ...
                                                                <div class="tile-wrap" style="margin-top: 0px; margin-bottom: 0px; padding-left: 10px;">
							                                        <div class="tile" style="background: transparent; box-shadow: none;">
								                                        ...
								                                        <div class="tile-inner">
                                                                            ...
                                                                            <br />
                                                                            <label style="font-weight: normal; font-size: small; color: white; margin-top: 5px;">
                                                                                <span style="font-weight: bold;">Kehadiran LTS</span><br />(Jml.Hadir/Jml.Pertemuan)&nbsp;&nbsp;<br />
                                                                                <asp:TextBox onblur="SaveCK();" runat="server" ID="txtLTSCK_Kehadiran" style="background: transparent; border-style: none; border-bottom-style: dashed; border-bottom-width: 1px; padding: 5px; font-weight: bold; font-size: small; outline: none; border-bottom-color: #2bb4c2;"></asp:TextBox>
                                                                            </label>
                                                                ...
                                                                <div style="color: yellow; padding-left: 10px;">
                                                                    ...
                                                                    <a onclick="ShowProgress(true); <%= btnShowDataListSiswa.ClientID %>.click();"
                                                                        ...
                                                                        <td 
                                                                            <%# 
                                                                                ...
                                                                                (
                                                                                    ...
                                                                                    ? "colspan=\"" +  
                                                                                      AI_ERP.Application_Modules.EDUCATION.Penilaian.TK.wf_NilaiRaporEkskul.GetColspanKriteriaPenilaian(
                                                                                            txtID.Value, 1
                                                                                      ) +  
                                                                                      "\" "
                                                                                    : ""
                                                                                                ...
                                                                                                <%# 
                                                                                                    ...
                                                                                                    (
                                                                                                        ...
                                                                                                        ? (
                                                                                                                ...
                                                                                                                AI_ERP.Application_Modules.EDUCATION.Penilaian.TK.wf_NilaiRaporEkskul.IsReadonly(
                                                                                                                    ...
                                                                                                                    txtKodeMapel.Value
                                                                                                                        ...
                                                                                                                        AI_ERP.Application_Modules.EDUCATION.Penilaian.TK.wf_NilaiRaporEkskul.GetHTMLDeskripsiPenilaian(
                                                                                                                                txtTahunAjaran.Value,
                                                                                                                                txtSemester.Value,
                                                                                                                                txtKelasDet.Value,
                                                                                                                                txtIDSiswa.Value,
                                                                                ...
                                                                                <div "<%#                                                                                 
                                                                                    ...
                                                                                    <table style="width: 100%; margin: 0px;
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <%# 
                                                                                                AI_ERP.Application_Modules.EDUCATION.Penilaian.TK.wf_NilaiRaporEkskul.GetHTMLRdoKriteriaPenilaian(
                                                                                                        txtTahunAjaran.Value,
                                                                                                        txtSemester.Value,
                                                                                                        txtKelasDet.Value,
                                                                                                        txtIDSiswa.Value,
