...
namespace AI_ERP.Application_Modules.EDUCATION.Penilaian.TK
{
    ...
    {
        public const string SessionViewDataName = "PAGEPROSESDATARAPORTK";
        ...
        protected void InitInput()
        {
            ...
            foreach (var item in DAO_Rapor_Design.GetAll_Entity().Select(m => m.TahunAjaran).Distinct().ToList())
            {
        ...
        {
            Rapor_Arsip m = DAO_Rapor_Arsip.GetByID_Entity(txtID.Value);
        ...
        protected void btnOKSaveTemplateEmailRapor_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DAO_Rapor_Arsip.UpdateEmailRapor(
                    txtID.Value,
