<%@ Page Title="" Language="C#" MasterPageFile="~/Application_Masters/Main.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="wf.DesainRapor.aspx.cs" Inherits="AI_ERP.Application_Modules.EDUCATION.Penilaian.KB.wf_DesainRapor" %>
                                                    ...
                                                    <ItemTemplate>
                                                        <tr class="<%# (Container.DisplayIndex % 2 == 0 ? "standardrow" : "oddrow") %>">
                                                            ...
                                                            <td style="font-weight: bold; padding: 10px; vertical-align: middle; text-align: center; width: 100px;">
                                                                ...
                                                                <label title=" Desain Rapor " onclick="ShowProgress(true); setTimeout(function() { <%= txtID.ClientID %>.value = '<%# Eval("Kode").ToString() %>';<%= btnShowDesain.ClientID %>.click(); }, 500);" class="badge" style="background-color: dimgrey; cursor: pointer; font-weight: normal; font-size: x-small; border-top-right-radius: 0px; border-bottom-right-radius: 0px;">
                                                                    <i class="fa fa-edit"></i>
                                                                </label><label title=" Desain Ekskul " onclick="<%# txtTahunAjaran.ClientID + ".value='" + Eval("TahunAjaran").ToString() + "';" %> <%# txtSemester.ClientID + ".value='" + Eval("Semester").ToString() + "';" %> ShowProgress(true); setTimeout(function() { <%= txtID.ClientID %>.value = '<%# Eval("Kode").ToString() %>';<%= btnShowDesainEkskul.ClientID %>.click(); }, 500);" class="badge" style="background-color: darkred; cursor: pointer; font-weight: normal; font-size: x-small; border-top-left-radius: 0px; border-bottom-left-radius: 0px;">
                                                            ...
                                                            <td style="font-weight: bold; padding: 10px; vertical-align: middle; text-align: left;">
                                                                ...
                                                                <br />
                                                                <%# 
                                                                    "<span style=\"font-weight: bold;\">" + Eval("JenisRapor").ToString().Trim() + "</span>"
                                                                %>
                                                            </td>
                                                        </tr>
                                                    </ItemTemplate>
                                        ...
                                        <asp:View runat="server" ID="vDesain">
                                                                    ...
                                                                    <tr class="<%# 
                                                                        ...
                                                                        <td style="width: 30px;">                                                                            
                                                                            <div class="checkbox checkbox-adv"
                                                                                <%# 
                                                                                    AI_ERP.Application_Modules.EDUCATION.Penilaian.KB.wf_DesainRapor.IsLocked(Eval("Rel_Rapor_Design").ToString()) 
                                                                                    ? " style=\"display: none;\" "
                                                                                    : ""
                                                                                %>
                                                                                >
                                                                            ...
                                                                            <div class="row" style="margin-left: 0px; margin-right: 0px;">
                                                                                ...
                                                                                <div class="col-md-2" style="padding-right: 0px;">
                                                                                    <div style="<%# 
                                                                                        ...
                                                                                        <sup>
                                                                                            <button onclick="<%= txtIDKriteriaEdit.ClientID %>.value = '<%# Eval("Kode").ToString() %>'; <%= txtIDJenisInput.ClientID %>.value = '<%= AI_ERP.Application_Modules.EDUCATION.Penilaian.KB.wf_DesainRapor.JenisInput.ItemKriteria.ToString() %>'; <%= btnShowEditItemKriteria.ClientID %>.click(); return false;" title=" Ubah " onclick="return false;" class="btn btn-flat btn-brand-accent waves-attach waves-effect pull-right" 
                                                                                     ...
                                                                                     style="padding: 0px; padding-right: 5px;">
                                                                                        ...
                                                                                        <table style="margin: 0px; width: 100%; box-shadow: none;">
                                                                                            <tr>
                                                                                                ...
                                                                                                <td <%# (AI_ERP.Application_Entities.Elearning.KB.JenisKomponenRapor)Convert.ToInt16(Eval("JenisKomponen")) == 
                                                                                                            AI_ERP.Application_Entities.Elearning.KB.JenisKomponenRapor.Rekomendasi  
                                                                                                        ? " colspan=\"2\" "
                                                                                                        : ""
                                                                                                    %>
                                                                                    ...
                                                                                    <span style="color: slategrey;">
                                                                                        <i class="fa fa-cog" 
                                                                                            <%# 
                                                                                                ...
                                                                                                AI_ERP.Application_DAOs.Elearning.KB.DAO_Rapor_DesignDet_GuruKhusus.GetByHeader_Entity(Eval("Kode").ToString()).Count > 0
                                                                                                ? " style=\"color: #ff6a00;\" "
                                                                                                : ""
                                                                                            %>></i>
                                                                                    </span>
                                                                            ...
                                                                            <div class="row" style="margin-left: 0px; margin-right: 0px;">
                                                                                     ...
                                                                                     style="padding: 0px; padding-right: 5px;">
                                                                                        ...
                                                                                        <table style="margin: 0px; width: 100%; box-shadow: none;">
                                                                                            <tr>
                                                                                                <td style="width: 30px; padding: 0px; background: transparent; 
                                                                                                    <%# (AI_ERP.Application_Entities.Elearning.KB.JenisKomponenRapor)Convert.ToInt16(Eval("JenisKomponen")) == 
                                                                                                            AI_ERP.Application_Entities.Elearning.KB.JenisKomponenRapor.MapelEkskul ||
                                                                                                        (AI_ERP.Application_Entities.Elearning.KB.JenisKomponenRapor)Convert.ToInt16(Eval("JenisKomponen")) == 
                                                                                                            AI_ERP.Application_Entities.Elearning.KB.JenisKomponenRapor.Rekomendasi   
                                                                                                        ? " display : none; "
                                                                                                        : ""
                                                                                                        ...
                                                                                                        (
                                                                                                            ...
                                                                                                            : (
                                                                                                                    ...
                                                                                                                    ? "<div style=\"width: 100%; margin: 0px; padding: 0px; border-style: solid; border-width: 1px; border-color: #e7cc9a; background-color: lightgoldenrodyellow; padding-bottom: 0px; padding-top: 0px; border-radius: 0px;\">" +
                                                                                                                        ...
                                                                                                                        AI_ERP.Application_Modules.EDUCATION.Penilaian.KB.wf_DesainRapor.GetHTMLMapelEkskul(Eval("Rel_KomponenRapor").ToString()) +
                                                                                                                      "</div>"
                                                                                                                    : ""
                                                                                                              )
                                                                                                        )
                                                                                ...
                                                                                <div class="col-md-2"
                                                                                    ...
                                                                                    <div style="<%# 
                                                                                        ...
                                                                                        %>">
                                                                                        <sup>
                                                                                            <button onclick="<%= txtIDJenisInput.ClientID %>.value='<%= AI_ERP.Application_Modules.EDUCATION.Penilaian.KB.wf_DesainRapor.JenisInput.ItemEkskul.ToString() %>'; <%= txtSelIDItemPenilaian.ClientID %>.value = '<%# Eval("Kode").ToString() %>'; ShowTambahItem(); return false;" title=" Tambahkan Item Penilaian " class="btn btn-flat waves-attach waves-effect" style="font-size: small; color: mediumvioletred; border-style: none; background: transparent; padding: 0px; text-transform: none;">
                                                                                                <i class="fa fa-plus-circle"></i>
                                                                                            </button>
                                                                                        </sup>
                                                                                        <sup>
                                                                                        ...
                                                                                        <sup style="<%# 
                                                                                            ...
                                                                                            : ""
                                                                                        %>">
                                                                                            <button onclick="<%= txtIDItemPenilaian.ClientID %>.value = '<%# Eval("Kode").ToString() %>'; <%= txtIDJenisInput.ClientID %>.value = '<%= AI_ERP.Application_Modules.EDUCATION.Penilaian.KB.wf_DesainRapor.JenisInput.ItemEkskul.ToString() %>'; <%= btnShowEditItemPenilaian.ClientID %>.click(); return false;" title=" Ubah " onclick="return false;" class="btn btn-flat btn-brand-accent waves-attach waves-effect pull-right" 
                                                                                                style="<%# (
                                                                                                                (AI_ERP.Application_Entities.Elearning.KB.JenisKomponenRapor)Convert.ToInt16(Eval("JenisKomponen")) == 
                                                                                                                 AI_ERP.Application_Entities.Elearning.KB.JenisKomponenRapor.Rekomendasi
                                                                                                                 ? "display: none;"
                                            ...
                                            <div class="fbtn-container" id="div_button_settings_rapor_design" runat="server">
		                                        <div class="fbtn-inner">
                                                    ...
                                                    <div class="fbtn-dropup" style="z-index: 999999;">
				                                        <asp:LinkButton Visible="false" OnClientClick="ShowProgress(true);" CssClass="fbtn fbtn-green waves-attach waves-circle waves-effect" runat="server" id="lnkAddKategoriPencapaianEkskul" style="display: none; background-color: black; color: white;" OnClick="lnkAddKategoriPencapaianEkskul_Click">
                                                        ...
                                                        <asp:LinkButton Visible="false" OnClientClick="ShowProgress(true);" CssClass="fbtn fbtn-green waves-attach waves-circle waves-effect" runat="server" ID="lnkAddSubKategoriPencapaianEkskul" style="display: none; background-color: black;" OnClick="lnkAddSubKategoriPencapaianEkskul_Click">
                                                        ...
                                                        <asp:LinkButton Visible="false" OnClientClick="ShowProgress(true);" CssClass="fbtn fbtn-green waves-attach waves-circle waves-effect" runat="server" ID="lnkAddPoinKategoriPencapaianEkskul" style="display: none; background-color: black;" OnClick="lnkAddPoinKategoriPencapaianEkskul_Click">
                                                        ...
                                                        <asp:LinkButton Visible="false" OnClientClick="ShowProgress(true);" CssClass="fbtn fbtn-green waves-attach waves-circle waves-effect" runat="server" ID="lnkAddRekomendasiEkskul" style="display: none; background-color: black;" OnClick="lnkAddRekomendasiEkskul_Click">
                                                ...
                                                <div class="col-xs-12">
                                                    <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                        ...
                                                        <asp:DropDownList runat="server" ID="cboJenisRapor" CssClass="form-control">
                                                            <asp:ListItem Value="" Text=""></asp:ListItem>
                                                            <asp:ListItem Value="Motorik Kasar" Text="Motorik Kasar"></asp:ListItem>
                                                            <asp:ListItem Value="Sosial Emosi" Text="Sosial Emosi"></asp:ListItem>
                                                            <asp:ListItem Value="Gabungan" Text="Gabungan"></asp:ListItem>
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row" style="margin-bottom: 5px; padding-bottom: 5px;">
                                                        <div class="col-xs-12" style="color: grey;">
                                                            ...
                                                            <button onclick="HideModal();                                                                              
                                                                             setTimeout(function(){ 
                                                                                if(<%= txtIDJenisInput.ClientID %>.value === '<%= AI_ERP.Application_Modules.EDUCATION.Penilaian.KB.wf_DesainRapor.JenisInput.ItemReguler.ToString() %>'){ 
                                                                                    <%= lnkAddKategoriPencapaian.ClientID %>.click(); 
                                                                                } else if(<%= txtIDJenisInput.ClientID %>.value === '<%= AI_ERP.Application_Modules.EDUCATION.Penilaian.KB.wf_DesainRapor.JenisInput.ItemEkskul.ToString() %>'){ 
