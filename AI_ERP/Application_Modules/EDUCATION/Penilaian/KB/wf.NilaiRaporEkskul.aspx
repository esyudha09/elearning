<%@ Page Title="" Language="C#" MasterPageFile="~/Application_Masters/Main.Master" AutoEventWireup="true" CodeBehind="wf.NilaiRaporEkskul.aspx.cs" Inherits="AI_ERP.Application_Modules.EDUCATION.Penilaian.KB.wf_NilaiRaporEkskul" %>
                                                    ...
                                                    <ItemTemplate>
                                                        <tr class="<%# (Container.DisplayIndex % 2 == 0 ? "standardrow" : "oddrow") %>">
                                                            ...
                                                            <td style="font-weight: bold; padding: 10px; vertical-align: middle; text-align: left;">
                                                                ...
                                                                <%# 
                                                                    AI_ERP.Application_Modules.EDUCATION.Penilaian.KB.wf_NilaiRaporEkskul.IsPosted(
                                                                ...
                                                                <%# 
                                                                    (
                                                                        !AI_ERP.Application_Modules.EDUCATION.Penilaian.KB.wf_NilaiRaporEkskul.IsUdahDiaturNilaiDefault(
                                                                            Eval("Kode").ToString(),
                                                                            Eval("KodeKelasDet").ToString(),
                                                                        ...
                                                                        : (
                                                                          ...
                                                                          "<label title=\" Buka \" onclick=\"ShowProgress(true); " + txtKodeMapel.ClientID + ".value = '" + Eval("KodeMapel").ToString() + "'; " + txtKelasDet.ClientID + ".value = '" + Eval("KodeKelasDet").ToString() + "'; " + txtID.ClientID + ".value = '" + Eval("Kode").ToString() + "'; " + btnShowDesain.ClientID + ".click();\" style=\"cursor: pointer; font-weight: normal; font-size: small; color: green; margin-top: 10px;\">" +
                                                                            ...
                                                                            "Buka" +
                                                                            "&nbsp;" +
                                                                            AI_ERP.Application_Modules.EDUCATION.Penilaian.KB.wf_NilaiRaporEkskul.GetHTMLNotifJumlahSiswa(
                                                                                Eval("KodeKelasDet").ToString(),
                                                                                Eval("Kode").ToString(),
                                                                                Eval("KodeMapel").ToString()   
                                                                            ) +
                                                                          ...
                                                                          "<span style=\"color: #dddddd;\">&nbsp;&nbsp;|&nbsp;&nbsp;</span>" +
                                                                          (
                                                                            AI_ERP.Application_Modules.EDUCATION.Penilaian.KB.wf_NilaiRaporEkskul.GetJumlahNoReadOnly(
                                                                                Eval("KodeMapel").ToString(),
                                                                                Eval("Kode").ToString(),
                                                                                Eval("KodeMapel").ToString()   
                                                                            ) == 0
                                                                        ...
                                                                        <td 
                                                                            <%# 
                                                                                ...
                                                                                (
                                                                                    ...
                                                                                    ? "colspan=\"" +  
                                                                                      AI_ERP.Application_Modules.EDUCATION.Penilaian.KB.wf_NilaiRaporEkskul.GetColspanKriteriaPenilaian(
                                                                                            txtID.Value, 1
                                                                                      ) +  
                                                                                      "\" "
                                                                                    : ""
                                                                                                ...
                                                                                                <%# 
                                                                                                    ...
                                                                                                    (
                                                                                                        ...
                                                                                                        ? (
                                                                                                                ...
                                                                                                                AI_ERP.Application_Modules.EDUCATION.Penilaian.KB.wf_NilaiRaporEkskul.IsReadonly(
                                                                                                                    ...
                                                                                                                    txtKodeMapel.Value
                                                                                                                        ...
                                                                                                                        AI_ERP.Application_Modules.EDUCATION.Penilaian.KB.wf_NilaiRaporEkskul.GetHTMLDeskripsiPenilaian(
                                                                                                                                txtTahunAjaran.Value,
                                                                                                                                txtSemester.Value,
                                                                                                                                txtKelasDet.Value,
                                                                                                                                txtIDSiswa.Value,
                                                                                ...
                                                                                <div "<%#                                                                                 
                                                                                    ...
                                                                                    <table style="width: 100%; margin: 0px;
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <%# 
                                                                                                AI_ERP.Application_Modules.EDUCATION.Penilaian.KB.wf_NilaiRaporEkskul.GetHTMLRdoKriteriaPenilaian(
                                                                                                        txtTahunAjaran.Value,
                                                                                                        txtSemester.Value,
                                                                                                        txtKelasDet.Value,
                                                                                                        txtIDSiswa.Value,
