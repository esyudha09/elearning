...
namespace AI_ERP.Application_Modules.EDUCATION.Penilaian.SMP
{
    ...
    {
        public const string SessionViewDataName = "PAGEDATADESAINRAPORSMP";
                ...
                if (m_sekolah.Nama != null)
                {
                    ...
                    foreach (Kelas m in lst_kelas)
                    {
                        if (m.IsAktif)
                        {
                            ...
                            {
                                Value = m.Kode.ToString().Trim().ToLower(),
                                Text = m.Nama
                            });
                        }
                    }
        ...
        private void BindListViewDesainRapor(string rel_desain_rapor, bool isbind = true)
        {
                ...
                if (m.TahunAjaran != null)
                {
                    ...
                    if (m_kelas != null)
                    {
                        if (m_kelas.Nama != null)
                        {
                            ...
                            BindListViewDesainRapor(txtID.Value, true);
        ...
        protected void ShowInputDataDesain()
        {
            txtIDItem.Value = "";
            InitInputItemRapor();
            txtKeyAction.Value = JenisAction.DoShowInputDesain.ToString();
        }
