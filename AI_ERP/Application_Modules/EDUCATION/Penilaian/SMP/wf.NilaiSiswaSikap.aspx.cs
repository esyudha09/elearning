...
namespace AI_ERP.Application_Modules.EDUCATION.Penilaian.SMP
{
    public partial class wf_NilaiSiswaSikap : System.Web.UI.Page
    {
        ...
        protected void LoadData()
        {
            ...
            List<DAO_Rapor_StrukturNilai.StrukturNilai> lst_sn_mapel = DAO_Rapor_StrukturNilai.GetAllByTABySMByKelasByMapelForSikap_Entity(
            ...
            foreach (Siswa m_siswa in lst_siswa)
            {
                ...
                Rapor_Desain m_rapor_desain = lst_rapor_desain.
                    FindAll(
                        m0 => m0.Rel_Kelas.Trim().ToUpper() == rel_kelas.Trim().ToUpper() &&
