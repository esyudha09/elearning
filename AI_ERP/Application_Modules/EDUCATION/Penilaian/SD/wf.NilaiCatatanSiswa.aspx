<%@ Page Title="" Language="C#" MasterPageFile="~/Application_Masters/Main.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="wf.NilaiCatatanSiswa.aspx.cs" Inherits="AI_ERP.Application_Modules.EDUCATION.Penilaian.SD.wf_NilaiCatatanSiswa" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:UpdatePanel runat="server" ID="upMain">
        <ContentTemplate>
            ...
            <asp:Button UseSubmitBehavior="false" runat="server" ID="btnShowIsiCatatan" OnClick="btnShowIsiCatatan_Click" Style="position: absolute; left: -1000px; top: -1000px;" />        
