...
namespace AI_ERP.Application_Modules.EDUCATION.Penilaian.SD
{
    ...
    {
        public const string SessionViewDataName = "PAGEDATADESAINRAPORLTSSD";
        ...
        public enum JenisAction
        {
            ...
            DoSearch,
            DoShowData,
            DoShowInputDesainLTS,
            DoShowConfirmHapus,
            DoShowConfirmHapusDesainLTS
        }
        ...
        protected void ShowInputDataDesain()
        {
            txtIDItem.Value = "";
            InitInputItemRapor();
            txtKeyAction.Value = JenisAction.DoShowInputDesainLTS.ToString();
        }
