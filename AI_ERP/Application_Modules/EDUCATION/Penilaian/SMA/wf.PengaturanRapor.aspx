<%@ Page Title="" Language="C#" MasterPageFile="~/Application_Masters/Main.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="wf.PengaturanRapor.aspx.cs" Inherits="AI_ERP.Application_Modules.EDUCATION.Penilaian.SMA.wf_PengaturanRapor" %>
                                        ...
                                        <div style="padding: 0px; margin: 0px;">
                                            ...
                                            <div style="width: 100%; background-color: white; padding-top: 15px;">
                                                ...
                                                <div class="row" style="margin-left: 15px; margin-right: 15px;">
                                                    <div class="col-xs-6">
                                                        <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                            <label class="label-input" for="<%= cboKurikulumRaporLevel10.ClientID %>" style="text-transform: none;">Kurikulum Rapor Kelas X</label>
                                                            <asp:RequiredFieldValidator ValidationGroup="vldInput" runat="server" ID="vldKurikulumRaporLevel7"
                                                                ControlToValidate="cboKurikulumRaporLevel10" Display="Dynamic" style="float: right; font-weight: bold;"
                                                                Text="<i class='fa fa-exclamation-triangle'></i>" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                                            <asp:DropDownList ValidationGroup="vldInput" CssClass="form-control" runat="server" ID="cboKurikulumRaporLevel10"></asp:DropDownList>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6">
                                                        <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                            <label class="label-input" for="<%= cboKurikulumRaporLevel11.ClientID %>" style="text-transform: none;">Kurikulum Rapor Kelas XI</label>
                                                            <asp:RequiredFieldValidator ValidationGroup="vldInput" runat="server" ID="vldKurikulumRaporLevel8"
                                                                ControlToValidate="cboKurikulumRaporLevel11" Display="Dynamic" style="float: right; font-weight: bold;"
                                                                Text="<i class='fa fa-exclamation-triangle'></i>" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                                            <asp:DropDownList ValidationGroup="vldInput" CssClass="form-control" runat="server" ID="cboKurikulumRaporLevel11"></asp:DropDownList>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row" style="margin-left: 15px; margin-right: 15px;">
                                                    <div class="col-xs-6">
                                                        <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                            <label class="label-input" for="<%= cboKurikulumRaporLevel12.ClientID %>" style="text-transform: none;">Kurikulum Rapor Kelas XII</label>
                                                            <asp:RequiredFieldValidator ValidationGroup="vldInput" runat="server" ID="vldKurikulumRaporLevel9"
                                                                ControlToValidate="cboKurikulumRaporLevel12" Display="Dynamic" style="float: right; font-weight: bold;"
                                                                Text="<i class='fa fa-exclamation-triangle'></i>" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                                            <asp:DropDownList ValidationGroup="vldInput" CssClass="form-control" runat="server" ID="cboKurikulumRaporLevel12"></asp:DropDownList>
                                                        </div>
                                                    </div>
                                                </div>
