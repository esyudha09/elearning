...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function SaveNilaiEkskul(tahun_ajaran, semester, rel_mapel, rel_siswa, nilai, lts_hd, sakit, izin, alpa) {
        ...
        function SaveSakitEkskul(tahun_ajaran, semester, rel_mapel, rel_siswa, nilai) {
            var s_url = "<%= ResolveUrl(AI_ERP.Application_Libs.Routing.URL.APIS.SMA.NILAI_SISWA.DO_SAVE.FILE + "/DoUpdateSakitEkskul") %>";
            s_url += "?t=" + tahun_ajaran +
                     "&sm=" + semester +
                     "&mp=" + rel_mapel +
                     "&s=" + rel_siswa +
        ...
        function SaveIzinEkskul(tahun_ajaran, semester, rel_mapel, rel_siswa, nilai) {
            var s_url = "<%= ResolveUrl(AI_ERP.Application_Libs.Routing.URL.APIS.SMA.NILAI_SISWA.DO_SAVE.FILE + "/DoUpdateIzinEkskul") %>";
            s_url += "?t=" + tahun_ajaran +
                     "&sm=" + semester +
                     "&mp=" + rel_mapel +
                     "&s=" + rel_siswa +
        ...
        function SaveAlpaEkskul(tahun_ajaran, semester, rel_mapel, rel_siswa, nilai) {
            var s_url = "<%= ResolveUrl(AI_ERP.Application_Libs.Routing.URL.APIS.SMA.NILAI_SISWA.DO_SAVE.FILE + "/DoUpdateAlpaEkskul") %>";
            s_url += "?t=" + tahun_ajaran +
                     "&sm=" + semester +
                     "&mp=" + rel_mapel +
                     "&s=" + rel_siswa +
