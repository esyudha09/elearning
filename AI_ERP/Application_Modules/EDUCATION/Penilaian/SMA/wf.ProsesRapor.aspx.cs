...
namespace AI_ERP.Application_Modules.EDUCATION.Penilaian.SMA
{
    ...
    {
        public const string SessionViewDataName = "PAGEPROSESDATARAPORSMA";
                    ...
                    foreach (Kelas m in lst_kelas)
                    {
                        if (m.IsAktif)
                        {
                            ...
                            foreach (var kelas_det in lst_kelas_det)
                            {
                                ...
                                if (kelas_det.IsKelasJurusan)
                                {
                                    jenis_kelas = "Kelas Jurusan";
                                }
                                else if (kelas_det.IsKelasSosialisasi)
                                {
                                    jenis_kelas = "Kelas Sosialisasi";
                                }
                                cboKelasDet.Items.Add(new ListItem
                                {
                                    Value = kelas_det.Kode.ToString().Trim().ToUpper(),
                                    Text = jenis_kelas +
