<%@ Page Title="" Language="C#" MasterPageFile="~/Application_Masters/Main.Master" AutoEventWireup="true" CodeBehind="wf.NilaiSiswaLTS.aspx.cs" Inherits="AI_ERP.Application_Modules.EDUCATION.Penilaian.SMA.wf_NilaiSiswaLTS" %>
            ...
            <div class="fbtn-container" id="div_button_settings" runat="server" style="z-index: 999999;">
                <div class="fbtn-inner">
                    ...
                    <div class="fbtn-dropup" style="z-index: 999999;">
                        <asp:LinkButton CssClass="fbtn fbtn-green waves-attach waves-circle waves-effect" runat="server" ID="lnkOKDeskripsiLTS" Style="display: none; background-color: #424242;">
            ...
            <div class="row" style="margin-left: 0px; margin-right: 0px;">
                <div class="col-xs-12">
                    ...
                    <div class="col-md-10 col-md-offset-1" style="padding: 0px;">
                        <div class="card" style="margin-top: 0px; box-shadow: none; border-style: solid; border-color: #C6C6C6; border-width: 1px; margin-bottom: 250px; width: 100%;">
				            <div class="card-main">
					            <div class="card-inner" style="margin: 0px; padding: 0px; ">
                                    <div class="demo" style="margin: 0 auto; display: table; margin-top: 25px; margin-bottom: 25px; width: 100%;">
                                        <div id="printarea" style="margin: 0 auto; display: table; margin-top: -15px; width: 95%;">
