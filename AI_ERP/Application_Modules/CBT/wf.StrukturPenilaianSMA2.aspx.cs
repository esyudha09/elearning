...
{
    public partial class wf_StrukturPenilaianSMA2 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            switch (mvMain.ActiveViewIndex)
            {
                case 0:
                    ...
                    break;
                case 1:
                    ShowStrukturNilaiKTSP(Libs.GetQueryString("sn"));
                    this.Master.ShowHeaderTools = false;
                    break;
                case 2:
                    ShowStrukturNilaiKURTILAS(Libs.GetQueryString("sn"));
                    this.Master.ShowHeaderTools = false;
                    break;
            }
        ...
        protected void btnShowStrukturNilai_Click()
        {
            ltrCaptionKTSPDet.Text = "";

            var m_sn = DAO_Rapor_StrukturNilai.GetByID_Entity(Libs.GetQueryString("sn"));
            if (m_sn != null)
            {
                if (m_sn.Kurikulum != null)
                {
                    ...
                    if (m_sn.Kurikulum == Libs.JenisKurikulum.SMA.KTSP)
                    {
                        ...
                        Rapor_StrukturNilai_KTSP m = DAO_Rapor_StrukturNilai_KTSP.GetByID_Entity(Libs.GetQueryString("sn"));
                        if (m != null)
                        {
                    ...
                    else if (m_sn.Kurikulum == Libs.JenisKurikulum.SMA.KURTILAS)
                    {
                        ...
                        Rapor_StrukturNilai_KURTILAS m = DAO_Rapor_StrukturNilai_KURTILAS.GetByID_Entity(Libs.GetQueryString("sn"));
                        if (m != null)
                        {
                            if (m.TahunAjaran != null)
                            {
                            ...
                            if (m_kp != null)
                            {
                                if (m_kp.Nama != null)
                                {
                                    ...
                                    html += "<td style=\"padding-left: 0px; color: black; background-color: white; font-weight: bold;\">" +
                                                Libs.GetHTMLSimpleText(m_kp.Nama) +
                                                (
                                                    !(IsMapelEkskulByStrukturNilaiKTSP(Libs.GetQueryString("sn")) && m_kd.JenisPerhitungan == ((int)Libs.JenisPerhitunganNilai.Bobot).ToString())
                                                    ? ""
                                                    : "&nbsp;&nbsp;" +
                                                      "&nbsp;&nbsp;" +
                                                      (
                                                        !IsMapelEkskulByStrukturNilaiKTSP(Libs.GetQueryString("sn"))
