                                                ...
                                                html += "<td style=\"background-color: white;\">" +
                                                                "<a class=\"btn btn-flat waves-attach waves-effect\" " +
                                                                    "href=\"" + ResolveUrl(AI_ERP.Application_Libs.Routing.URL.APPLIACTION_MODULES.CBT.RUMAH_SOAL_INPUT.ROUTE) +
                                                                            "?m=" + Libs.GetQueryString("m") + "&sn=" + txtID.Value + "&k=" + m_strukturnilai.Rel_Kelas +"&ta=" + m_strukturnilai.TahunAjaran +"&sm=" + m_strukturnilai.Semester + "&u=" + Libs.GetQueryString("u") + "&kp=" + m.Kode + "&kur='KURTILAS'" + "&nama=" + Libs.GetHTMLSimpleText(m_kp.Nama) +
                                                                            "\" " +
                                                                   ">" +
