                                                    ...
                                                    <ItemTemplate>
                                                        <tr class="<%# 
                                                            ...
                                                            <td style="text-align: right; vertical-align: middle;">
                                                                <label title=" Struktur Penilaian " class="btn btn-flat"
                                                              ...
                                                              <td style="text-align: right; vertical-align: middle;">
                                                                <label title=" Bank Soal "  class="btn btn-flat"
                                                                    id="bankSoal"
                                                                   onclick="GoToURL('<%= ResolveUrl(AI_ERP.Application_Libs.Routing.URL.APPLIACTION_MODULES.CBT.SOAL.ROUTE) %>?m=<%#  AI_ERP.Application_Libs.Libs.GetHTMLSimpleText(Eval("Rel_Mapel").ToString()) %>&k=<%#  AI_ERP.Application_Libs.Libs.GetHTMLSimpleText(Eval("Rel_Kelas").ToString()) %>&sn=<%#  AI_ERP.Application_Libs.Libs.GetHTMLSimpleText(Eval("Kode").ToString()) %>&u=<%#  AI_ERP.Application_Libs.Libs.GetQueryString("u") %>');"
                                                                   >
