...
namespace AI_ERP.Application_Modules.CBT
{
    public partial class wf_BankSoal : System.Web.UI.Page
    {
        ...
        protected void btnDoAdd_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect(ResolveUrl(Routing.URL.APPLIACTION_MODULES.CBT.SOAL_INPUT.ROUTE + "?m=" + mapel + "&k="+ kelas+ "&sn="+ sn+ "&u="+ unit));
        }
        ...
        protected void btnShowDetail_Click(object sender, EventArgs e)
        {
            ...
            var unit = Libs.GetQueryString("u");
            var sn = Libs.GetQueryString("sn");
            Response.Redirect(ResolveUrl(Routing.URL.APPLIACTION_MODULES.CBT.SOAL_INPUT.ROUTE + "?id=" + txtID.Value + "&m=" + mapel + "&k=" + kelas+ "&u=" + unit + "&sn=" + sn));
        }
