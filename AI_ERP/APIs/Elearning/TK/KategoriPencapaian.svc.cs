...
{
    public class KategoriPencapaian : IKategoriPencapaian
    {
        [WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json)]
        public string[] ShowAutocompleteKategoriPencapaian(string kata_kunci)
        {
            ...
            using (SqlConnection conn = new SqlConnection())
            {
                ...
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    cmd.CommandText = DAO_Rapor_KategoriPencapaian.SP_SELECT_ALL_FOR_SEARCH;
