...
{
    public class PoinKategoriPencapaian : IPoinKategoriPencapaian
    {
        [WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json)]
        public string[] ShowAutocompletePoinKategoriPencapaian(string kata_kunci)
        {
            ...
            using (SqlConnection conn = new SqlConnection())
            {
                ...
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    cmd.CommandText = DAO_Rapor_PoinKategoriPencapaian.SP_SELECT_ALL_FOR_SEARCH;
