...
{
    public class KriteriaPencapaian : IKriteriaPencapaian
    {
        [WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json)]
        public string[] ShowAutocompleteKriteriaPencapaian(string kata_kunci)
        {
            ...
            using (SqlConnection conn = new SqlConnection())
            {
                ...
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    cmd.CommandText = DAO_Rapor_Kriteria.SP_SELECT_ALL_FOR_SEARCH;
