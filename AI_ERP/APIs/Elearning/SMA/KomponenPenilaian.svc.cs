...
{
    public class KomponenPenilaian : IKomponenPenilaian
    {
        [WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json)]
        public string[] ShowAutocompleteKomponenPenilaian(string kata_kunci)
        {
            ...
            using (SqlConnection conn = new SqlConnection())
            {
                ...
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    cmd.CommandText = DAO_Rapor_KomponenPenilaian.SP_SELECT_ALL_FOR_SEARCH;
