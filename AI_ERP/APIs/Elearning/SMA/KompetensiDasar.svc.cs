...
{
    public class KompetensiDasar : IKompetensiDasar
    {
        [WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json)]
        public string[] ShowAutocompleteKompetensiDasar(string kata_kunci)
        {
            ...
            using (SqlConnection conn = new SqlConnection())
            {
                ...
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    cmd.CommandText = DAO_Rapor_KompetensiDasar.SP_SELECT_ALL_FOR_SEARCH;
