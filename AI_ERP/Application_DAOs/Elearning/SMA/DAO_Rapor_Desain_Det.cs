...
namespace AI_ERP.Application_DAOs.Elearning.SMA
{
    ...
    {
        public const string SP_SELECT_ALL = "SMA_Rapor_Desain_Det_SELECT_ALL";
        public const string SP_SELECT_BY_ID = "SMA_Rapor_Desain_Det_SELECT_BY_ID";
        public const string SP_SELECT_BY_HEADER = "SMA_Rapor_Desain_Det_SELECT_BY_HEADER";
        public const string SP_SELECT_BY_TA_BY_SM = "SMA_Rapor_Desain_Det_SELECT_BY_TA_BY_SM";
        public const string SP_SELECT_BY_TA_BY_SM_BY_JENIS_RAPOR = "SMA_Rapor_Desain_Det_SELECT_BY_TA_BY_SM_BY_JENIS_RAPOR";

        public const string SP_INSERT = "SMA_Rapor_Desain_Det_INSERT";

        public const string SP_UPDATE = "SMA_Rapor_Desain_Det_UPDATE";

        public const string SP_DELETE = "SMA_Rapor_Desain_Det_DELETE";
