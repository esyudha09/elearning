...
namespace AI_ERP.Application_DAOs.Elearning.SMA
{
    ...
    {
        public const string SP_SELECT_ALL = "SMA_Rapor_Arsip_SELECT_ALL";
        public const string SP_SELECT_ALL_FOR_SEARCH = "SMA_Rapor_Arsip_SELECT_ALL_FOR_SEARCH";
        public const string SP_SELECT_BY_ID = "SMA_Rapor_Arsip_SELECT_BY_ID";

        public const string SP_INSERT = "SMA_Rapor_Arsip_INSERT";

        public const string SP_UPDATE = "SMA_Rapor_Arsip_UPDATE";

        public const string SP_DELETE = "SMA_Rapor_Arsip_DELETE";
