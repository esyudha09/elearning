...
namespace AI_ERP.Application_DAOs.Elearning.SMA
{
    ...
    {
        public const string SP_SELECT_BY_TA_BY_SM = "SMA_Rapor_NilaiSikap_SELECT_BY_TA_BY_SM";
        public const string SP_SELECT_BY_TA_BY_SM_BY_MAPEL = "SMA_Rapor_NilaiSikap_SELECT_BY_TA_BY_SM_BY_MAPEL";
        public const string SP_SELECT_BY_TA_BY_SM_BY_MAPEL_BY_KELASDET = "SMA_Rapor_NilaiSikap_SELECT_BY_TA_BY_SM_BY_MAPEL_BY_KELASDET";

        public const string SP_SELECT_NILAI_BY_TA_BY_SM_BY_KELAS = "SMA_Rapor_NilaiSikap_SELECT_NILAI_BY_TA_BY_SM_BY_KELAS";
        public const string SP_SELECT_NILAI_WALAS_BY_TA_BY_SM_BY_KELAS = "SMA_Rapor_NilaiSikap_SELECT_NILAI_WALAS_BY_TA_BY_SM_BY_KELAS";

        public const string SP_SELECT_BY_ID = "SMA_Rapor_NilaiSikap_SELECT_BY_ID";

        public const string SP_INSERT = "SMA_Rapor_NilaiSikap_INSERT";

        public const string SP_UPDATE = "SMA_Rapor_NilaiSikap_UPDATE";

        public const string SP_DELETE_BY_TA_BY_SM_BY_MAPEL = "SMA_Rapor_NilaiSikap_DELETE_BY_TA_BY_SM_BY_MAPEL";
        public const string SP_DELETE_BY_TA_BY_SM_BY_MAPEL_BY_KELASDET = "SMA_Rapor_NilaiSikap_DELETE_BY_TA_BY_SM_BY_MAPEL_BY_KELASDET";
