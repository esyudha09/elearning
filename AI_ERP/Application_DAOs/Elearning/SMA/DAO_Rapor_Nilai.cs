...
namespace AI_ERP.Application_DAOs.Elearning.SMA
{
    ...
    {
        public const string SP_SELECT_ALL_FOR_SEARCH = "SMA_Rapor_Nilai_SELECT_ALL_FOR_SEARCH";
        public const string SP_SELECT_BY_TA_BY_SM_BY_KELASDET_BY_MAPEL = "SMA_Rapor_Nilai_SELECT_BY_TA_BY_SM_BY_KELASDET_BY_MAPEL";
        public const string SP_SELECT_BY_TA_BY_SM_BY_KELAS_BY_KURIKULUM = "SMA_Rapor_Nilai_SELECT_BY_TA_BY_SM_BY_KELAS_BY_KURIKULUM";
        public const string SP_SELECT_PENILAIAN = "SMA_Rapor_NilaiSiswa_SELECT_PENILAIAN";

        public const string SP_INSERT = "SMA_Rapor_Nilai_INSERT";

        public const string SP_UPDATE = "SMA_Rapor_Nilai_UPDATE";

        public const string SP_DELETE = "SMA_Rapor_Nilai_DELETE";
        ...
        public static List<Rapor_Nilai> GetAllByTABySMByKelasByKurikulum_Entity(
                string tahun_ajaran,
                string semester,
                string rel_kelas,
                string kurikulum
            )
        {
            ...
            try
            {
                ...
                comm.CommandTimeout = 1200;
                comm.CommandType = CommandType.StoredProcedure;
                comm.CommandText = SP_SELECT_BY_TA_BY_SM_BY_KELAS_BY_KURIKULUM;
                comm.Parameters.AddWithValue("@" + NamaField.TahunAjaran, tahun_ajaran);
                comm.Parameters.AddWithValue("@" + NamaField.Semester, semester);
                comm.Parameters.AddWithValue("@" + NamaField.Rel_Kelas, rel_kelas);
                comm.Parameters.AddWithValue("@" + NamaField.Kurikulum, kurikulum);
