...
namespace AI_ERP.Application_DAOs.Elearning.SMA
{
    ...
    {
        public const string SP_SELECT_ALL = "SMA_Rapor_Desain_SELECT_ALL";
        public const string SP_SELECT_ALL_FOR_SEARCH = "SMA_Rapor_Desain_SELECT_ALL_FOR_SEARCH";
        public const string SP_SELECT_ALL_BY_JENISRAPOR = "SMA_Rapor_Desain_SELECT_ALL_BY_JENISRAPOR";
        public const string SP_SELECT_ALL_FOR_SEARCH_BY_JENISRAPOR = "SMA_Rapor_Desain_SELECT_ALL_FOR_SEARCH_BY_JENISRAPOR";
        public const string SP_SELECT_BY_TAHUN_AJARAN_BY_SEMESTER_BY_KELAS = "SMA_Rapor_Desain_SELECT_BY_TAHUN_AJARAN_BY_SEMESTER_BY_KELAS";
        public const string SP_SELECT_BY_TAHUN_AJARAN_BY_SEMESTER = "SMA_Rapor_Desain_SELECT_BY_TAHUN_AJARAN_BY_SEMESTER";
        public const string SP_SELECT_BY_ID = "SMA_Rapor_Desain_SELECT_BY_ID";

        public const string SP_INSERT = "SMA_Rapor_Desain_INSERT";

        public const string SP_UPDATE = "SMA_Rapor_Desain_UPDATE";

        public const string SP_DELETE = "SMA_Rapor_Desain_DELETE";
