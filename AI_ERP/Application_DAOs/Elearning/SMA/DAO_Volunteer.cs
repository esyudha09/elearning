...
namespace AI_ERP.Application_DAOs.Elearning.SMA
{
    ...
    {
        public const string SP_SELECT_ALL = "SMA_Volunteer_SELECT_ALL";
        public const string SP_SELECT_BY_ID = "SMA_Volunteer_SELECT_BY_ID";
        public const string SP_SELECT_BY_TA_BY_SM_BY_KELAS = "SMA_Volunteer_SELECT_BY_TA_BY_SM_BY_KELAS";

        public const string SP_INSERT = "SMA_Volunteer_INSERT";

        public const string SP_UPDATE = "SMA_Volunteer_UPDATE";

        public const string SP_DELETE = "SMA_Volunteer_DELETE";
