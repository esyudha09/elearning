...
namespace AI_ERP.Application_DAOs.Elearning.SMA
{
    ...
    {
        public const string SP_SELECT_ALL = "SMA_CatatanSiswa_SELECT_ALL";
        public const string SP_SELECT_ALL_FOR_SEARCH = "SMA_CatatanSiswa_SELECT_ALL_FOR_SEARCH";
        public const string SP_SELECT_BY_TA_SM_KELASDET = "SMA_CatatanSiswa_SELECT_BY_TA_SM_KELASDET";
        public const string SP_SELECT_DISTINCT_BY_TA_KELASDET = "SMA_CatatanSiswa_SELECT_DISTINCT_BY_TA_KELASDET";
        public const string SP_SELECT_DISTINCT_BY_TA_KELASDET_BY_MAPEL = "SMA_CatatanSiswa_SELECT_DISTINCT_BY_TA_KELASDET_BY_MAPEL";
        public const string SP_SELECT_BY_ID = "SMA_CatatanSiswa_SELECT_BY_ID";

        public const string SP_INSERT = "SMA_CatatanSiswa_INSERT";

        public const string SP_UPDATE = "SMA_CatatanSiswa_UPDATE";

        public const string SP_DELETE = "SMA_CatatanSiswa_DELETE";
