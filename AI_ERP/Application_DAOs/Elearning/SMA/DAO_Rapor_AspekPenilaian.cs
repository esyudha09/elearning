...
namespace AI_ERP.Application_DAOs.Elearning.SMA
{
    ...
    {
        public const string SP_SELECT_ALL = "SMA_Rapor_AspekPenilaian_SELECT_ALL";
        public const string SP_SELECT_ALL_FOR_SEARCH = "SMA_Rapor_AspekPenilaian_SELECT_ALL_FOR_SEARCH";
        public const string SP_SELECT_BY_ID = "SMA_Rapor_AspekPenilaian_SELECT_BY_ID";

        public const string SP_INSERT = "SMA_Rapor_AspekPenilaian_INSERT";

        public const string SP_UPDATE = "SMA_Rapor_AspekPenilaian_UPDATE";

        public const string SP_DELETE = "SMA_Rapor_AspekPenilaian_DELETE";
        ...
        public static void Insert(Rapor_AspekPenilaian m, string user_id, bool use_guid_nol = false)
        {
            SqlConnection conn = Application_Libs.Libs.GetConnection_Rapor();
            SqlCommand comm = conn.CreateCommand();
            SqlTransaction transaction = null;
