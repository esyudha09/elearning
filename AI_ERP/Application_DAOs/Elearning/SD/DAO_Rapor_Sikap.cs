...
{
    public static class DAO_Rapor_Sikap
    {
        public const string SP_SELECT_ALL_FOR_SEARCH = "SD_Rapor_Sikap_SELECT_ALL_FOR_SEARCH";
        public const string SP_SELECT_BY_TA_BY_SM_BY_KELASDET_BY_MAPEL_BY_MAPEL_SIKAP = "SD_Rapor_Sikap_SELECT_BY_TA_BY_SM_BY_KELASDET_BY_MAPEL_BY_MAPEL_SIKAP";
        public const string SP_SELECT_NILAI_SIKAP = "SD_Rapor_Sikap_SELECT_NILAI_SIKAP";

        public const string SP_INSERT = "SD_Rapor_Sikap_INSERT";

        public const string SP_UPDATE = "SD_Rapor_Sikap_UPDATE";

        public const string SP_DELETE = "SD_Rapor_Sikap_DELETE";
        ...
        public static class NamaField
        {
            ...
            public const string Rel_MapelSikap = "Rel_MapelSikap";
            public const string Kurikulum = "Kurikulum";
        }

        private static Rapor_Sikap GetEntityFromDataRow(DataRow row)
        {
            return new Rapor_Sikap
            {
                ...
                Rel_MapelSikap = row[NamaField.Rel_MapelSikap].ToString(),
        ...
        public static void Insert(Rapor_Sikap m, string user_id)
        {
            SqlConnection conn = Application_Libs.Libs.GetConnection_Rapor();
            SqlCommand comm = conn.CreateCommand();
            SqlTransaction transaction = null;
            try
            {
                ...
                comm.Parameters.Add(new SqlParameter("@" + NamaField.Rel_MapelSikap, m.Rel_MapelSikap));
        ...
        public static void Update(Rapor_Sikap m, string user_id)
        {
            SqlConnection conn = Application_Libs.Libs.GetConnection_Rapor();
            SqlCommand comm = conn.CreateCommand();
            SqlTransaction transaction = null;
        ...
        public static List<Rapor_Sikap> GetAllByTABySMByKelasDetByMapel_Entity(
                string tahun_ajaran,
                string semester,
                string rel_kelasdet,
                string rel_mapel,
        ...
        {
            List<Rapor_Sikap> hasil = new List<Rapor_Sikap>();
            SqlConnection conn = Application_Libs.Libs.GetConnection_Rapor();
            SqlCommand comm = conn.CreateCommand();
            ...
            try
            {
                ...
                comm.Parameters.AddWithValue("@" + NamaField.Rel_MapelSikap, rel_mapel_sikap);
        ...
        public static decimal GetNilaiSikap_Entity(
                string tahun_ajaran,
                string semester,
                string rel_kelasdet,
                string rel_siswa,
            ...
            )
        {
            ...
            try
            {
                ...
                comm.Parameters.AddWithValue("@BobotSikapGuruMapel", bobot_guru_mapel);
                comm.Parameters.AddWithValue("@BobotSikapGuruKelas", bobot_guru_kelas);
