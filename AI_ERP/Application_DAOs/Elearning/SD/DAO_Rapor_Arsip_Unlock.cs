...
namespace AI_ERP.Application_DAOs.Elearning.SD
{
    ...
    {
        public const string SP_SELECT_ALL = "SD_Rapor_Arsip_Unlock_SELECT_ALL";
        public const string SP_SELECT_ALL_FOR_SEARCH = "SD_Rapor_Arsip_Unlock_SELECT_ALL_FOR_SEARCH";
        public const string SP_SELECT_BY_ID = "SD_Rapor_Arsip_Unlock_SELECT_BY_ID";
        public const string SP_SELECT_BY_HEADER = "SD_Rapor_Arsip_Unlock_SELECT_BY_HEADER";

        public const string SP_INSERT = "SD_Rapor_Arsip_Unlock_INSERT";

        public const string SP_UPDATE = "SD_Rapor_Arsip_Unlock_UPDATE";

        public const string SP_DELETE = "SD_Rapor_Arsip_Unlock_DELETE";
