...
namespace AI_ERP.Application_DAOs.Elearning.SD
{
    ...
    {
        public const string SP_SELECT_ALL = "SD_Volunteer_Det_SELECT_ALL";
        public const string SP_SELECT_BY_ID = "SD_Volunteer_Det_SELECT_BY_ID";
        public const string SP_SELECT_BY_HEADER = "SD_Volunteer_Det_SELECT_BY_HEADER";
        public const string SP_SELECT_BY_HEADER_BY_SISWA = "SD_Volunteer_Det_SELECT_BY_HEADER_BY_SISWA";
        public const string SP_SELECT_BY_TA_BY_SM_BY_KELAS_BY_SISWA = "SD_Volunteer_Det_SELECT_BY_TA_BY_SM_BY_KELAS_BY_SISWA";

        public const string SP_INSERT = "SD_Volunteer_Det_INSERT";

        public const string SP_UPDATE = "SD_Volunteer_Det_UPDATE";

        public const string SP_DELETE = "SD_Volunteer_Det_DELETE";
