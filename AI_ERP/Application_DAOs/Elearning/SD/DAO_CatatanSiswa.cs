...
namespace AI_ERP.Application_DAOs.Elearning.SD
{
    ...
    {
        public const string SP_SELECT_ALL = "SD_CatatanSiswa_SELECT_ALL";
        public const string SP_SELECT_ALL_FOR_SEARCH = "SD_CatatanSiswa_SELECT_ALL_FOR_SEARCH";
        public const string SP_SELECT_BY_TA_SM_KELASDET = "SD_CatatanSiswa_SELECT_BY_TA_SM_KELASDET";
        public const string SP_SELECT_DISTINCT_BY_TA_KELASDET = "SD_CatatanSiswa_SELECT_DISTINCT_BY_TA_KELASDET";
        public const string SP_SELECT_BY_ID = "SD_CatatanSiswa_SELECT_BY_ID";

        public const string SP_INSERT = "SD_CatatanSiswa_INSERT";

        public const string SP_UPDATE = "SD_CatatanSiswa_UPDATE";

        public const string SP_DELETE = "SD_CatatanSiswa_DELETE";
