...
namespace AI_ERP.Application_DAOs.Elearning.SD
{
    ...
    {
        public const string SP_SELECT_ALL_FOR_SEARCH = "SD_Rapor_Nilai_SELECT_ALL_FOR_SEARCH";
        public const string SP_SELECT_BY_TA_BY_SM = "SD_Rapor_Nilai_SELECT_BY_TA_BY_SM";
        public const string SP_SELECT_BY_TA_BY_SM_BY_KELASDET_BY_MAPEL = "SD_Rapor_Nilai_SELECT_BY_TA_BY_SM_BY_KELASDET_BY_MAPEL";
        public const string SP_SELECT_BY_TA_BY_SM_BY_KELASDET = "SD_Rapor_Nilai_SELECT_BY_TA_BY_SM_BY_KELASDET";
        public const string SP_SELECT_TOP1_BY_TA_BY_SM_BY_KELASDET_BY_MAPEL = "SD_Rapor_Nilai_SELECT_TOP1_BY_TA_BY_SM_BY_KELASDET_BY_MAPEL";
        public const string SP_SELECT_PENILAIAN = "SD_Rapor_NilaiSiswa_SELECT_PENILAIAN";
        
        public const string SP_INSERT = "SD_Rapor_Nilai_INSERT";

        public const string SP_UPDATE = "SD_Rapor_Nilai_UPDATE";

        public const string SP_DELETE = "SD_Rapor_Nilai_DELETE";
        ...
        public static void Insert(Rapor_Nilai m, string user_id)
        {
            SqlConnection conn = Application_Libs.Libs.GetConnection_Rapor();
            SqlCommand comm = conn.CreateCommand();
            SqlTransaction transaction = null;
        ...
        public static void Update(Rapor_Nilai m, string user_id)
        {
            SqlConnection conn = Application_Libs.Libs.GetConnection_Rapor();
            SqlCommand comm = conn.CreateCommand();
            SqlTransaction transaction = null;
        ...
        public static List<Rapor_Nilai> GetAllByTABySMByKelasDetByMapel_Entity(
                string tahun_ajaran,
                string semester,
                string rel_kelasdet,
                string rel_mapel
        ...
        public static Rapor_Nilai GetTop1ByTABySMByKelasDetByMapel_Entity(
                string tahun_ajaran,
                string semester,
                string rel_kelasdet,
                string rel_mapel
            )
        {
            ...
            try
            {
                ...
                comm.CommandTimeout = 1200;
                comm.CommandType = CommandType.StoredProcedure;
                comm.CommandText = SP_SELECT_TOP1_BY_TA_BY_SM_BY_KELASDET_BY_MAPEL;
                comm.Parameters.AddWithValue("@" + NamaField.TahunAjaran, tahun_ajaran);
                comm.Parameters.AddWithValue("@" + NamaField.Semester, semester);
                comm.Parameters.AddWithValue("@" + NamaField.Rel_KelasDet, rel_kelasdet);
                comm.Parameters.AddWithValue("@" + NamaField.Rel_Mapel, rel_mapel);
        ...
        public static List<Rapor_Nilai> GetPenilaianByTABySM_Entity(
                string tahun_ajaran,
                string semester
            )
        {
            ...
            try
            {
                ...
                comm.CommandTimeout = 1200;
                comm.CommandType = CommandType.StoredProcedure;
                comm.CommandText = SP_SELECT_PENILAIAN;
                comm.Parameters.AddWithValue("@" + NamaField.TahunAjaran, tahun_ajaran);
                comm.Parameters.AddWithValue("@" + NamaField.Semester, semester);
        ...
        public static List<Rapor_Nilai> GetAllByTABySM_Entity(
                string tahun_ajaran,
                string semester
            )
        {
