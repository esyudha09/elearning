...
{
    public static class DAO_Rapor_StrukturNilai_KPKelompok
    {
        public const string SP_SELECT_ALL = "SD_Rapor_StrukturNilai_KPKelompok_SELECT_ALL";
        public const string SP_SELECT_ALL_BY_HEADER = "SD_Rapor_StrukturNilai_KPKelompok_SELECT_ALL_BY_HEADER";
        public const string SP_SELECT_BY_ID = "SD_Rapor_StrukturNilai_KPKelompok_SELECT_BY_ID";

        public const string SP_INSERT = "SD_Rapor_StrukturNilai_KPKelompok_INSERT";

        public const string SP_UPDATE = "SD_Rapor_StrukturNilai_KPKelompok_UPDATE";

        public const string SP_DELETE = "SD_Rapor_StrukturNilai_KPKelompok_DELETE";
        public const string SP_DELETE_BY_HEADER = "SD_Rapor_StrukturNilai_KPKelompok_DELETE_BY_HEADER";
        ...
        private static Rapor_StrukturNilai_KPKelompok GetEntityFromDataRow(DataRow row)
        {
            return new Rapor_StrukturNilai_KPKelompok
            {
        ...
        public static List<Rapor_StrukturNilai_KPKelompok> GetAll_Entity()
        {
            List<Rapor_StrukturNilai_KPKelompok> hasil = new List<Rapor_StrukturNilai_KPKelompok>();
        ...
        public static List<Rapor_StrukturNilai_KPKelompok> GetAllByHeader_Entity(string rel_rapor_strukturnilai)
        {
            List<Rapor_StrukturNilai_KPKelompok> hasil = new List<Rapor_StrukturNilai_KPKelompok>();
            SqlConnection conn = Application_Libs.Libs.GetConnection_Rapor();
            SqlCommand comm = conn.CreateCommand();
        ...
        public static Rapor_StrukturNilai_KPKelompok GetByID_Entity(string kode)
        {
            Rapor_StrukturNilai_KPKelompok hasil = new Rapor_StrukturNilai_KPKelompok();
            SqlConnection conn = Application_Libs.Libs.GetConnection_Rapor();
            SqlCommand comm = conn.CreateCommand();
            SqlDataAdapter sqlDA;
        ...
        public static void Insert(Rapor_StrukturNilai_KPKelompok m)
        {
            SqlConnection conn = Application_Libs.Libs.GetConnection_Rapor();
            SqlCommand comm = conn.CreateCommand();
            SqlTransaction transaction = null;
        ...
        public static void Update(Rapor_StrukturNilai_KPKelompok m)
        {
            SqlConnection conn = Application_Libs.Libs.GetConnection_Rapor();
            SqlCommand comm = conn.CreateCommand();
            SqlTransaction transaction = null;
