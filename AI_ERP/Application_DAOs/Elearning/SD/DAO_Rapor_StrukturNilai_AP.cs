...
namespace AI_ERP.Application_DAOs.Elearning.SD
{
    ...
    {
        public const string SP_SELECT_ALL = "SD_Rapor_StrukturNilai_AP_SELECT_ALL";
        public const string SP_SELECT_ALL_FOR_SEARCH = "SD_Rapor_StrukturNilai_AP_SELECT_ALL_FOR_SEARCH";
        public const string SP_SELECT_ALL_BY_HEADER = "SD_Rapor_StrukturNilai_AP_SELECT_ALL_BY_HEADER";
        public const string SP_SELECT_ALL_BY_HEADER_BY_JENIS_ASPEK_PENILAIAN = "SD_Rapor_StrukturNilai_AP_SELECT_ALL_BY_HEADER_BY_JENIS_ASPEK_PENILAIAN";
        public const string SP_SELECT_BY_ID = "SD_Rapor_StrukturNilai_AP_SELECT_BY_ID";

        public const string SP_INSERT = "SD_Rapor_StrukturNilai_AP_INSERT";

        public const string SP_UPDATE = "SD_Rapor_StrukturNilai_AP_UPDATE";

        public const string SP_DELETE = "SD_Rapor_StrukturNilai_AP_DELETE";
        ...
        public static class NamaField
        {
            ...
            public const string IsAdaPAT_UKK = "IsAdaPAT_UKK";
            public const string Bobot_PAT_UKK = "Bobot_PAT_UKK";
            public const string Bobot_Non_PAT_UKK = "Bobot_Non_PAT_UKK";
        }
        ...
        private static Rapor_StrukturNilai_AP GetEntityFromDataRow(DataRow row)
        {
            return new Rapor_StrukturNilai_AP
            {
                ...
                IsAdaPAT_UKK = Convert.ToBoolean((row[NamaField.IsAdaPAT_UKK] == DBNull.Value ? false : row[NamaField.IsAdaPAT_UKK])),
                Bobot_PAT_UKK = Convert.ToDecimal((row[NamaField.Bobot_PAT_UKK] == DBNull.Value ? 0 : row[NamaField.Bobot_PAT_UKK])),
                Bobot_Non_PAT_UKK = Convert.ToDecimal((row[NamaField.Bobot_Non_PAT_UKK] == DBNull.Value ? 0 : row[NamaField.Bobot_Non_PAT_UKK])),
        ...
        public static void Insert(Rapor_StrukturNilai_AP m, string user_id)
        {
            ...
            try
            {
                ...
                comm.Parameters.Add(new SqlParameter("@" + NamaField.IsAdaPAT_UKK, m.IsAdaPAT_UKK));
                comm.Parameters.Add(new SqlParameter("@" + NamaField.Bobot_PAT_UKK, m.Bobot_PAT_UKK));
                comm.Parameters.Add(new SqlParameter("@" + NamaField.Bobot_Non_PAT_UKK, m.Bobot_Non_PAT_UKK));
                comm.Parameters.Add(new SqlParameter("@user_id", user_id));
                comm.ExecuteNonQuery();
