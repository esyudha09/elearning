...
{
    public static class DAO_Rapor_SikapSiswa_Det
    {
        public const string SP_SELECT_BY_HEADER = "SD_Rapor_SikapSiswa_Det_SELECT_BY_HEADER";
        public const string SP_SELECT_BY_TA_BY_SM_BY_KelasDet_BY_MAPEL_BY_AP_BY_KD_BY_KP_BY_SISWA = 
                            "SD_Rapor_SikapSiswa_Det_SELECT_BY_TA_BY_SM_BY_KelasDet_BY_MAPEL_BY_AP_BY_KD_BY_KP_BY_SISWA";

        public const string SP_INSERT = "SD_Rapor_SikapSiswa_Det_INSERT";

        public const string SP_UPDATE = "SD_Rapor_SikapSiswa_Det_UPDATE";

        public const string SP_DELETE = "SD_Rapor_SikapSiswa_Det_DELETE";

        public static class NamaField
        {
            public const string Kode = "Kode";
            public const string Rel_Rapor_SikapSiswa = "Rel_Rapor_SikapSiswa";
        ...
        private static Rapor_SikapSiswa_Det GetEntityFromDataRow(DataRow row)
        {
            return new Rapor_SikapSiswa_Det
            {
                Kode = new Guid(row[NamaField.Kode].ToString()),
                Rel_Rapor_SikapSiswa = new Guid(row[NamaField.Rel_Rapor_SikapSiswa].ToString()),
        ...
        public static void Insert(Rapor_SikapSiswa_Det m, string user_id)
        {
            SqlConnection conn = Application_Libs.Libs.GetConnection_Rapor();
            SqlCommand comm = conn.CreateCommand();
            SqlTransaction transaction = null;
            try
            {
                ...
                comm.Parameters.Add(new SqlParameter("@" + NamaField.Kode, kode));
                comm.Parameters.Add(new SqlParameter("@" + NamaField.Rel_Rapor_SikapSiswa, m.Rel_Rapor_SikapSiswa));
        ...
        public static void Update(Rapor_SikapSiswa_Det m, string user_id)
        {
            SqlConnection conn = Application_Libs.Libs.GetConnection_Rapor();
            SqlCommand comm = conn.CreateCommand();
            SqlTransaction transaction = null;
        ...
        public static List<Rapor_SikapSiswa_Det> GetAllByHeader_Entity(
                string rel_rapor_nilai
            )
        {
            List<Rapor_SikapSiswa_Det> hasil = new List<Rapor_SikapSiswa_Det>();
            SqlConnection conn = Application_Libs.Libs.GetConnection_Rapor();
            SqlCommand comm = conn.CreateCommand();
            ...
            try
            {
                ...
                comm.Parameters.AddWithValue("@Rel_Rapor_Sikap", rel_rapor_nilai);
        ...
        public static List<Rapor_SikapSiswa_Det> GetAllByTABySMByKelasDetByMapelByAPByKDByKPBySiswa_Entity(
                string tahun_ajaran,
                string semester,
                string rel_kelasdet,
                string rel_mapel,
