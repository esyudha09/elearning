...
{
    public static class DAO_Rapor_Volunteer
    {
        public const string SP_SELECT_ALL_FOR_SEARCH = "SD_Rapor_Volunteer_SELECT_ALL_FOR_SEARCH";
        public const string SP_SELECT_BY_TA_BY_SM_BY_KELASDET = "SD_Rapor_Ekskul_SELECT_BY_TA_BY_SM_BY_KELASDET";

        public const string SP_INSERT = "SD_Rapor_Volunteer_INSERT";

        public const string SP_UPDATE = "SD_Rapor_Volunteer_UPDATE";

        public const string SP_DELETE = "SD_Rapor_Volunteer_DELETE";
        ...
        private static Rapor_Volunteer GetEntityFromDataRow(DataRow row)
        {
            return new Rapor_Volunteer
            {
        ...
        public static void Insert(Rapor_Volunteer m, string user_id)
        {
            SqlConnection conn = Application_Libs.Libs.GetConnection_Rapor();
            SqlCommand comm = conn.CreateCommand();
            SqlTransaction transaction = null;
        ...
        public static void Update(Rapor_Volunteer m, string user_id)
        {
            SqlConnection conn = Application_Libs.Libs.GetConnection_Rapor();
            SqlCommand comm = conn.CreateCommand();
            SqlTransaction transaction = null;
        ...
        public static List<Rapor_Volunteer> GetAllByTABySMByKelasByMapel_Entity(
                string tahun_ajaran,
                string semester,
                string rel_kelasdet
            )
        {
            List<Rapor_Volunteer> hasil = new List<Rapor_Volunteer>();
            SqlConnection conn = Application_Libs.Libs.GetConnection_Rapor();
            SqlCommand comm = conn.CreateCommand();
