...
namespace AI_ERP.Application_DAOs.Elearning.SD
{
    ...
    {
        public const string SP_SELECT_BY_HEADER = "SD_Rapor_EkskulSiswa_Det_SELECT_BY_HEADER";
        public const string SP_SELECT_BY_HEADER_BY_SISWA = "SD_Rapor_EkskulSiswa_Det_SELECT_BY_HEADER_BY_SISWA";
        public const string SP_SELECT_BY_TA_BY_SM_BY_SISWA = "SD_Rapor_EkskulSiswa_Det_SELECT_BY_TA_BY_SM_BY_SISWA";
        public const string SP_SELECT_BY_TA_BY_SM_BY_Kelas_BY_MAPEL_BY_AP_BY_KD_BY_KP_BY_SISWA =
                            "SD_Rapor_EkskulSiswa_Det_SELECT_BY_TA_BY_SM_BY_Kelas_BY_MAPEL_BY_AP_BY_KD_BY_KP_BY_SISWA";

        public const string SP_INSERT = "SD_Rapor_EkskulSiswa_Det_INSERT";

        public const string SP_UPDATE = "SD_Rapor_EkskulSiswa_Det_UPDATE";

        public const string SP_DELETE = "SD_Rapor_EkskulSiswa_Det_DELETE";
        ...
        public static List<Rapor_EkskulSiswa_Det> GetAllByHeaderBySiswa_Entity(
                string rel_rapor_nilai, string rel_siswa
            )
        {
        ...
        public static List<Rapor_EkskulSiswa_Det> GetAllByTABySMBySiswa_Entity(
                string tahun_ajaran, string semester, string rel_siswa
            )
        {
            List<Rapor_EkskulSiswa_Det> hasil = new List<Rapor_EkskulSiswa_Det>();
            SqlConnection conn = Application_Libs.Libs.GetConnection_Rapor();
            ...
            try
            {
                ...
                comm.CommandTimeout = 1200;
                comm.CommandType = CommandType.StoredProcedure;
                comm.CommandText = SP_SELECT_BY_TA_BY_SM_BY_SISWA;
            ...
            )
        {
            ...
            try
            {
                ...
                comm.Parameters.AddWithValue("@TahunAjaran", tahun_ajaran);
                comm.Parameters.AddWithValue("@Semester", semester);
                comm.Parameters.AddWithValue("@Rel_Kelas1", rel_kelas1);
                comm.Parameters.AddWithValue("@Rel_Kelas2", rel_kelas2);
                comm.Parameters.AddWithValue("@Rel_Kelas3", rel_kelas3);
                comm.Parameters.AddWithValue("@Rel_Kelas4", rel_kelas4);
                comm.Parameters.AddWithValue("@Rel_Kelas5", rel_kelas5);
                comm.Parameters.AddWithValue("@Rel_Kelas6", rel_kelas6);
