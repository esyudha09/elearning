...
namespace AI_ERP.Application_DAOs.Elearning.SD
{
    ...
    {
        public const string SP_SELECT_ALL = "SD_Rapor_StrukturNilai_KURTILAS_KP_SELECT_ALL";
        public const string SP_SELECT_ALL_FOR_SEARCH = "SD_Rapor_StrukturNilai_KURTILAS_KP_SELECT_ALL_FOR_SEARCH";
        public const string SP_SELECT_ALL_BY_HEADER = "SD_Rapor_StrukturNilai_KURTILAS_KP_SELECT_ALL_BY_HEADER";
        public const string SP_SELECT_BY_ID = "SD_Rapor_StrukturNilai_KURTILAS_KP_SELECT_BY_ID";
        public const string SP_SELECT_BY_TA_BY_SM = "SD_Rapor_StrukturNilai_KURTILAS_KP_SELECT_BY_TA_BY_SM";

        public const string SP_INSERT = "SD_Rapor_StrukturNilai_KURTILAS_KP_INSERT";

        public const string SP_UPDATE = "SD_Rapor_StrukturNilai_KURTILAS_KP_UPDATE";

        public const string SP_DELETE = "SD_Rapor_StrukturNilai_KURTILAS_KP_DELETE";
        ...
        private static Rapor_StrukturNilai_KURTILAS_KP GetEntityFromDataRow(DataRow row)
        {
            return new Rapor_StrukturNilai_KURTILAS_KP
            {
                ...
                Rel_Rapor_StrukturNilai_KURTILAS_KD = new Guid(row[NamaField.Rel_Rapor_StrukturNilai_KURTILAS_KD].ToString()),
        ...
        public static List<Rapor_StrukturNilai_KURTILAS_KP> GetAllByHeader_Entity(string rel_rapor_StrukturNilai_KURTILAS_ktsp_kd)
        {
            List<Rapor_StrukturNilai_KURTILAS_KP> hasil = new List<Rapor_StrukturNilai_KURTILAS_KP>();
            SqlConnection conn = Application_Libs.Libs.GetConnection_Rapor();
            SqlCommand comm = conn.CreateCommand();
            ...
            try
            {
                ...
                comm.Parameters.AddWithValue("@" + NamaField.Rel_Rapor_StrukturNilai_KURTILAS_KD, rel_rapor_StrukturNilai_KURTILAS_ktsp_kd);
