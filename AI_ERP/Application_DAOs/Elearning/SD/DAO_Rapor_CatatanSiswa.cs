...
namespace AI_ERP.Application_DAOs.Elearning.SD
{
    ...
    {
        public const string SP_SELECT_ALL_FOR_SEARCH = "SD_Rapor_CatatanSiswa_SELECT_ALL_FOR_SEARCH";
        public const string SP_SELECT_BY_TA_BY_SM_BY_KELASDET_BY_SISWA =
                            "SD_Rapor_CatatanSiswa_SELECT_BY_TA_BY_SM_BY_KELASDET_BY_SISWA";
        
        public const string SP_INSERT = "SD_Rapor_CatatanSiswa_INSERT";

        public const string SP_UPDATE = "SD_Rapor_CatatanSiswa_UPDATE";

        public const string SP_DELETE = "SD_Rapor_CatatanSiswa_DELETE";
