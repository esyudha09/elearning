...
namespace AI_ERP.Application_DAOs.Elearning.TK
{
    ...
    {
        public const string SP_SELECT_ALL = "TK_Rapor_Arsip_SELECT_ALL";
        public const string SP_SELECT_ALL_FOR_SEARCH = "TK_Rapor_Arsip_SELECT_ALL_FOR_SEARCH";
        public const string SP_SELECT_BY_ID = "TK_Rapor_Arsip_SELECT_BY_ID";

        public const string SP_INSERT = "TK_Rapor_Arsip_INSERT";

        public const string SP_UPDATE = "TK_Rapor_Arsip_UPDATE";
        public const string SP_UPDATE_EMAIL_RAPOR = "TK_Rapor_Arsip_UPDATE_EMAIL_RAPOR";

        public const string SP_DELETE = "TK_Rapor_Arsip_DELETE";
