...
namespace AI_ERP.Application_DAOs.Elearning.TK
{
    ...
    {
        public const string SP_SELECT_ALL = "TK_Rapor_NilaiStandar_SELECT_ALL";
        public const string SP_SELECT_BY_RAPOR_DESIGN_BY_KELAS_DET = "TK_Rapor_NilaiStandar_SELECT_BY_RAPOR_DESIGN_BY_KELAS_DET";
        public const string SP_SELECT_BY_RAPOR_DESIGN_BY_KELAS_DET_BY_MAPEL = "TK_Rapor_NilaiStandar_SELECT_BY_RAPOR_DESIGN_BY_KELAS_DET_BY_MAPEL";
        public const string SP_SELECT_BY_ID = "TK_Rapor_NilaiStandar_SELECT_BY_ID";

        public const string SP_INSERT = "TK_Rapor_NilaiStandar_INSERT";

        public const string SP_UPDATE = "TK_Rapor_NilaiStandar_UPDATE";

        public const string SP_DELETE = "TK_Rapor_NilaiStandar_DELETE";
