...
namespace AI_ERP.Application_DAOs.Elearning.TK
{
    ...
    {
        public const string SP_SELECT_ALL = "TK_Rapor_DesignDetEkskul_SELECT_ALL";
        public const string SP_SELECT_BY_ID = "TK_Rapor_DesignDetEkskul_SELECT_BY_ID";
        public const string SP_SELECT_BY_HEADER = "TK_Rapor_DesignDetEkskul_SELECT_BY_HEADER";
        public const string SP_SELECT_BY_HEADER_BY_SISWA = "TK_Rapor_DesignDetEkskul_SELECT_BY_HEADER_BY_SISWA";
        public const string SP_SELECT_BY_HEADER_BY_SISWA_FOR_DESIGN = "TK_Rapor_DesignDetEkskul_SELECT_BY_HEADER_BY_SISWA_FOR_DESIGN";
        public const string SP_SELECT_BY_TAHUNAJARAN_BY_SEMESTER_BY_KELAS_BY_MAPEL = "TK_Rapor_DesignDetEkskul_SELECT_BY_TAHUNAJARAN_BY_SEMESTER_BY_KELAS_BY_MAPEL";
        public const string SP_SELECT_BY_RAPOR_DESIGN_BY_MAPEL = "TK_Rapor_DesignDetEkskul_SELECT_BY_RAPOR_DESIGN_BY_MAPEL";

        public const string SP_INSERT = "TK_Rapor_DesignDetEkskul_INSERT";
        public const string SP_INSERT_LENGKAP = "TK_Rapor_DesignDetEkskul_INSERT_LENGKAP";

        public const string SP_UPDATE = "TK_Rapor_DesignDetEkskul_UPDATE";
        public const string SP_UPDATE_URUT = "TK_Rapor_DesignDetEkskul_UPDATE_URUT";

        public const string SP_DELETE = "TK_Rapor_DesignDetEkskul_DELETE";
        public const string SP_DELETE_BY_HEADER = "TK_Rapor_DesignDetEkskul_DELETE_BY_HEADER";
        public const string SP_DELETE_PER_KELAS = "TK_Rapor_DesignDetEkskul_DELETE_PER_KELAS";
        ...
        public static void DeletePerKelas(string rel_rapor_design, string rel_komponen_rapor, string rel_kelas_det)
        {
            SqlConnection conn = Application_Libs.Libs.GetConnection_Rapor();
            SqlCommand comm = conn.CreateCommand();
            SqlTransaction transaction = null;
            try
            {
                ...
                comm.Transaction = transaction;
                comm.CommandType = CommandType.StoredProcedure;
                comm.CommandText = SP_DELETE_PER_KELAS;

                comm.Parameters.Add(new SqlParameter("@" + NamaField.Rel_Rapor_Design, rel_rapor_design));
                comm.Parameters.Add(new SqlParameter("@" + NamaField.Rel_KomponenRapor, rel_komponen_rapor));
        ...
        public static void InsertLengkap(Rapor_DesignDetEkskul m, string user_id)
        {
            SqlConnection conn = Application_Libs.Libs.GetConnection_Rapor();
            SqlCommand comm = conn.CreateCommand();
            SqlTransaction transaction = null;
