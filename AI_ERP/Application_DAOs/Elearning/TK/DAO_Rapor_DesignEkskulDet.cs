...
namespace AI_ERP.Application_DAOs.Elearning.TK
{
    ...
    {
        public const string SP_SELECT_ALL = "TK_Rapor_DesignEkskulDet_SELECT_ALL";
        public const string SP_SELECT_BY_ID = "TK_Rapor_DesignEkskulDet_SELECT_BY_ID";
        public const string SP_SELECT_BY_HEADER = "TK_Rapor_DesignEkskulDet_SELECT_BY_HEADER";

        public const string SP_INSERT = "TK_Rapor_DesignEkskulDet_INSERT";
        public const string SP_INSERT_LENGKAP = "TK_Rapor_DesignEkskulDet_INSERT_LENGKAP";

        public const string SP_UPDATE = "TK_Rapor_DesignEkskulDet_UPDATE";
        public const string SP_UPDATE_URUT = "TK_Rapor_DesignEkskulDet_UPDATE_URUT";

        public const string SP_DELETE = "TK_Rapor_DesignEkskulDet_DELETE";
        public const string SP_DELETE_BY_HEADER = "TK_Rapor_DesignEkskulDet_DELETE_BY_HEADER";
