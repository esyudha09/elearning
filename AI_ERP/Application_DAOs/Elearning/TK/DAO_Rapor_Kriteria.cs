...
namespace AI_ERP.Application_DAOs.Elearning.TK
{
    ...
    {
        public const string SP_SELECT_ALL = "TK_Rapor_Kriteria_SELECT_ALL";
        public const string SP_SELECT_ALL_FOR_SEARCH = "TK_Rapor_Kriteria_SELECT_ALL_FOR_SEARCH";
        public const string SP_SELECT_BY_ID = "TK_Rapor_Kriteria_SELECT_BY_ID";

        public const string SP_INSERT = "TK_Rapor_Kriteria_INSERT";

        public const string SP_UPDATE = "TK_Rapor_Kriteria_UPDATE";

        public const string SP_DELETE = "TK_Rapor_Kriteria_DELETE";
