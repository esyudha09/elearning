...
namespace AI_ERP.Application_DAOs.Elearning.TK
{
    ...
    {
        public const string SP_SELECT_ALL = "TK_Rapor_DesignEkskul_SELECT_ALL";
        public const string SP_SELECT_ALL_FOR_SEARCH = "TK_Rapor_DesignEkskul_SELECT_ALL_FOR_SEARCH";
        public const string SP_SELECT_BY_ID = "TK_Rapor_DesignEkskul_SELECT_BY_ID";
        public const string SP_SELECT_BY_TAHUNAJARAN_BY_SEMESTER = "TK_Rapor_DesignEkskul_SELECT_BY_TAHUNAJARAN_BY_SEMESTER";
        public const string SP_SELECT_BY_TAHUNAJARAN_BY_SEMESTER_FOR_SEARCH = "TK_Rapor_DesignEkskul_SELECT_BY_TAHUNAJARAN_BY_SEMESTER_FOR_SEARCH";

        public const string SP_INSERT = "TK_Rapor_DesignEkskul_INSERT";

        public const string SP_UPDATE = "TK_Rapor_DesignEkskul_UPDATE";
        
        public const string SP_DELETE = "TK_Rapor_DesignEkskul_DELETE";
