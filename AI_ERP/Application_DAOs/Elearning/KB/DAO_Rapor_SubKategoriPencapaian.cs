...
{
    public static class DAO_Rapor_SubKategoriPencapaian
    {
        public const string SP_SELECT_ALL = "KB_Rapor_SubKategoriPencapaian_SELECT_ALL";
        public const string SP_SELECT_ALL_FOR_SEARCH = "KB_Rapor_SubKategoriPencapaian_SELECT_ALL_FOR_SEARCH";
        public const string SP_SELECT_BY_ID = "KB_Rapor_SubKategoriPencapaian_SELECT_BY_ID";

        public const string SP_INSERT = "KB_Rapor_SubKategoriPencapaian_INSERT";

        public const string SP_UPDATE = "KB_Rapor_SubKategoriPencapaian_UPDATE";

        public const string SP_DELETE = "KB_Rapor_SubKategoriPencapaian_DELETE";
