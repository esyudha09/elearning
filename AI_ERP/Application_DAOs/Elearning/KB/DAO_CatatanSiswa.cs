...
namespace AI_ERP.Application_DAOs.Elearning.KB
{
    ...
    {
        public const string SP_SELECT_ALL = "KB_CatatanSiswa_SELECT_ALL";
        public const string SP_SELECT_ALL_FOR_SEARCH = "KB_CatatanSiswa_SELECT_ALL_FOR_SEARCH";
        public const string SP_SELECT_BY_TA_SM_KELASDET = "KB_CatatanSiswa_SELECT_BY_TA_SM_KELASDET";
        public const string SP_SELECT_DISTINCT_BY_TA_KELASDET = "KB_CatatanSiswa_SELECT_DISTINCT_BY_TA_KELASDET";
        public const string SP_SELECT_BY_ID = "KB_CatatanSiswa_SELECT_BY_ID";

        public const string SP_INSERT = "KB_CatatanSiswa_INSERT";

        public const string SP_UPDATE = "KB_CatatanSiswa_UPDATE";

        public const string SP_DELETE = "KB_CatatanSiswa_DELETE";
