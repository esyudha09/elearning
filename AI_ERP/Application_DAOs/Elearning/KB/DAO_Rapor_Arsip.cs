...
namespace AI_ERP.Application_DAOs.Elearning.KB
{
    ...
    {
        public const string SP_SELECT_ALL = "KB_Rapor_Arsip_SELECT_ALL";
        public const string SP_SELECT_ALL_FOR_SEARCH = "KB_Rapor_Arsip_SELECT_ALL_FOR_SEARCH";
        public const string SP_SELECT_BY_ID = "KB_Rapor_Arsip_SELECT_BY_ID";

        public const string SP_INSERT = "KB_Rapor_Arsip_INSERT";

        public const string SP_UPDATE = "KB_Rapor_Arsip_UPDATE";
        public const string SP_UPDATE_EMAIL_RAPOR = "KB_Rapor_Arsip_UPDATE_EMAIL_RAPOR";

        public const string SP_DELETE = "KB_Rapor_Arsip_DELETE";
        ...
        private static Rapor_Arsip GetEntityFromDataRow(DataRow row)
        {
            return new Rapor_Arsip
            {
                ...
                TanggalRapor = Convert.ToDateTime(row[NamaField.TanggalRapor]),
