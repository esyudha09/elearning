...
namespace AI_ERP.Application_DAOs.Elearning.KB
{
    ...
    {
        public const string SP_SELECT_ALL = "KB_Rapor_NilaiSiswa_Det_SELECT_ALL";
        public const string SP_SELECT_BY_HEADER = "KB_Rapor_NilaiSiswa_Det_SELECT_BY_HEADER";
        public const string SP_SELECT_BY_ID = "KB_Rapor_NilaiSiswa_Det_SELECT_BY_ID";
        public const string SP_SELECT_POIN_PENILAIAN = "KB_Rapor_NilaiSiswa_Det_SELECT_POIN_PENILAIAN";
        public const string SP_SELECT_POIN_PENILAIAN_BY_SISWA_BY_RAPOR_DESIGN = "KB_Rapor_NilaiSiswa_Det_SELECT_POIN_PENILAIAN_BY_SISWA_BY_RAPOR_DESIGN";

        public const string SP_CREATE_NILAI_STANDAR = "KB_Rapor_NilaiSiswa_Det_CREATE_NILAI_STANDAR";

        public const string SP_INSERT = "KB_Rapor_NilaiSiswa_Det_INSERT";

        public const string SP_UPDATE = "KB_Rapor_NilaiSiswa_Det_UPDATE";

        public const string SP_DELETE = "KB_Rapor_NilaiSiswa_Det_DELETE";
        ...
        public static List<Rapor_NilaiSiswa_Det> GetByHeader_Entity(string rel_rapornilaisiswa)
        {
            List<Rapor_NilaiSiswa_Det> hasil = new List<Rapor_NilaiSiswa_Det>();
            SqlConnection conn = Application_Libs.Libs.GetConnection_Rapor();
            SqlCommand comm = conn.CreateCommand();
        ...
        public static List<Rapor_NilaiSiswa_Det> GetPoinPenilaian_Entity(string rel_siswa, string rel_rapor_design_det)
        {
            List<Rapor_NilaiSiswa_Det> hasil = new List<Rapor_NilaiSiswa_Det>();
            SqlConnection conn = Application_Libs.Libs.GetConnection_Rapor();
            SqlCommand comm = conn.CreateCommand();
            ...
            try
            {
                ...
                comm.CommandTimeout = 1200;
                comm.CommandType = CommandType.StoredProcedure;
                comm.CommandText = SP_SELECT_POIN_PENILAIAN_BY_SISWA_BY_RAPOR_DESIGN;
