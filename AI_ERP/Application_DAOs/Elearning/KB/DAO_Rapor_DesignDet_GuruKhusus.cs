...
namespace AI_ERP.Application_DAOs.Elearning.KB
{
    ...
    {
        public const string SP_SELECT_ALL = "KB_Rapor_DesignDet_GuruKhusus_SELECT_ALL";
        public const string SP_SELECT_BY_ID = "KB_Rapor_DesignDet_GuruKhusus_SELECT_BY_ID";
        public const string SP_SELECT_BY_HEADER = "KB_Rapor_DesignDet_GuruKhusus_SELECT_BY_HEADER";

        public const string SP_INSERT = "KB_Rapor_DesignDet_GuruKhusus_INSERT";

        public const string SP_DELETE = "KB_Rapor_DesignDet_GuruKhusus_DELETE";
        public const string SP_DELETE_BY_HEADER = "KB_Rapor_DesignDet_GuruKhusus_DELETE_BY_HEADER";
