...
namespace AI_ERP.Application_DAOs.Elearning.KB
{
    ...
    {
        public const string SP_SELECT_ALL = "KB_Rapor_Arsip_Unlock_SELECT_ALL";
        public const string SP_SELECT_ALL_FOR_SEARCH = "KB_Rapor_Arsip_Unlock_SELECT_ALL_FOR_SEARCH";
        public const string SP_SELECT_BY_ID = "KB_Rapor_Arsip_Unlock_SELECT_BY_ID";
        public const string SP_SELECT_BY_HEADER = "KB_Rapor_Arsip_Unlock_SELECT_BY_HEADER";

        public const string SP_INSERT = "KB_Rapor_Arsip_Unlock_INSERT";

        public const string SP_UPDATE = "KB_Rapor_Arsip_Unlock_UPDATE";

        public const string SP_DELETE = "KB_Rapor_Arsip_Unlock_DELETE";
