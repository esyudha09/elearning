...
namespace AI_ERP.Application_DAOs.Elearning.SMP
{
    ...
    {
        public const string SP_SELECT_BY_TA_BY_SM_BY_KELAS_BY_MAPEL = "SMP_Rapor_Ekskul_SELECT_BY_TA_BY_SM_BY_KELAS_BY_MAPEL";

        public const string SP_INSERT = "SMP_Rapor_Ekskul_INSERT";

        public const string SP_UPDATE = "SMP_Rapor_Ekskul_UPDATE";

        public const string SP_DELETE = "SMP_Rapor_Ekskul_DELETE";
