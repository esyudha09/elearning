...
namespace AI_ERP.Application_DAOs.Elearning.SMP
{
    ...
    {
        public const string SP_SELECT_BY_TA_BY_SM_BY_KelasDet = "SMP_Rapor_NilaiSikapSiswa_SELECT_BY_TA_BY_SM_BY_KelasDet";
        public const string SP_SELECT_BY_TA_BY_SM_BY_MAPEL_BY_KELASDET_BY_SISWA = "SMP_Rapor_NilaiSikapSiswa_SELECT_BY_TA_BY_SM_BY_MAPEL_BY_KELASDET_BY_SISWA";

        public const string SP_SELECT_SIKAP_SPIRITUAL_BY_TA_BY_SM_BY_MAPEL = "SMP_Rapor_NilaiSikapSiswa_SELECT_SIKAP_SPIRITUAL_BY_TA_BY_SM_BY_MAPEL";
        public const string SP_SELECT_SIKAP_SPIRITUAL_BY_TA_BY_SM_BY_MAPEL_BY_SISWA = "SMP_Rapor_NilaiSikapSiswa_SELECT_SIKAP_SPIRITUAL_BY_TA_BY_SM_BY_MAPEL_BY_SISWA";

        public const string SP_SELECT_SIKAP_SOSIAL_BY_TA_BY_SM_BY_MAPEL = "SMP_Rapor_NilaiSikapSiswa_SELECT_SIKAP_SOSIAL_BY_TA_BY_SM_BY_MAPEL";
        public const string SP_SELECT_SIKAP_SOSIAL_BY_TA_BY_SM_BY_MAPEL_BY_SISWA = "SMP_Rapor_NilaiSikapSiswa_SELECT_SIKAP_SOSIAL_BY_TA_BY_SM_BY_MAPEL_BY_SISWA";

        public const string SP_SELECT_BY_ID = "SMP_Rapor_NilaiSikapSiswa_SELECT_BY_ID";
        public const string SP_SELECT_BY_HEADER_BY_SISWA = "SMP_Rapor_NilaiSikapSiswa_SELECT_BY_HEADER_BY_SISWA";

        public const string SP_INSERT = "SMP_Rapor_NilaiSikapSiswa_INSERT";

        public const string SP_UPDATE = "SMP_Rapor_NilaiSikapSiswa_UPDATE";
        public const string SP_UPDATE_NILAI_AKHIR = "SMP_Rapor_NilaiSikapSiswa_UPDATE_NILAI_AKHIR";

        public const string SP_SAVE_BY_TA_BY_SM_BY_MAPEL_BY_SISWA = "SMP_Rapor_NilaiSikapSiswa_SAVE_BY_TA_BY_SM_BY_MAPEL_BY_SISWA";
        public const string SP_SAVE_BY_TA_BY_SM_BY_MAPEL_BY_KELASDET_BY_SISWA = "SMP_Rapor_NilaiSikapSiswa_SAVE_BY_TA_BY_SM_BY_MAPEL_BY_KELASDET_BY_SISWA";

        public const string SP_DELETE = "SMP_Rapor_NilaiSikapSiswa_DELETE";
