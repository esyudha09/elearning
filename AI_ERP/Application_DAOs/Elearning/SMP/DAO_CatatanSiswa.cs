...
namespace AI_ERP.Application_DAOs.Elearning.SMP
{
    ...
    {
        public const string SP_SELECT_ALL = "SMP_CatatanSiswa_SELECT_ALL";
        public const string SP_SELECT_ALL_FOR_SEARCH = "SMP_CatatanSiswa_SELECT_ALL_FOR_SEARCH";
        public const string SP_SELECT_BY_TA_SM_KELASDET = "SMP_CatatanSiswa_SELECT_BY_TA_SM_KELASDET";
        public const string SP_SELECT_DISTINCT_BY_TA_KELASDET = "SMP_CatatanSiswa_SELECT_DISTINCT_BY_TA_KELASDET";
        public const string SP_SELECT_BY_ID = "SMP_CatatanSiswa_SELECT_BY_ID";

        public const string SP_INSERT = "SMP_CatatanSiswa_INSERT";

        public const string SP_UPDATE = "SMP_CatatanSiswa_UPDATE";

        public const string SP_DELETE = "SMP_CatatanSiswa_DELETE";
