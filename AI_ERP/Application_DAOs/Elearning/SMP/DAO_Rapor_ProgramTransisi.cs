...
namespace AI_ERP.Application_DAOs.Elearning.SMP
{
    ...
    {
        public const string SP_SELECT_BY_TA_BY_SM_BY_KELASDET = "SMP_Rapor_ProgramTransisi_SELECT_BY_TA_BY_SM_BY_KELASDET";
        public const string SP_SELECT_BY_TA_BY_SM_BY_KELASDET_BY_SISWA = "SMP_Rapor_ProgramTransisi_SELECT_BY_TA_BY_SM_BY_KELASDET_BY_SISWA";

        public const string SP_INSERT = "SMP_Rapor_ProgramTransisi_INSERT";

        public const string SP_DELETE = "SMP_Rapor_ProgramTransisi_DELETE_BY_TA_BY_SM_BY_KELASDET_BY_SISWA";
