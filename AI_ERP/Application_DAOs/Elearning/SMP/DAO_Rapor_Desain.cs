...
namespace AI_ERP.Application_DAOs.Elearning.SMP
{
    ...
    {
        public const string SP_SELECT_ALL = "SMP_Rapor_Desain_SELECT_ALL";
        public const string SP_SELECT_ALL_FOR_SEARCH = "SMP_Rapor_Desain_SELECT_ALL_FOR_SEARCH";
        public const string SP_SELECT_ALL_BY_JENISRAPOR = "SMP_Rapor_Desain_SELECT_ALL_BY_JENISRAPOR";
        public const string SP_SELECT_ALL_FOR_SEARCH_BY_JENISRAPOR = "SMP_Rapor_Desain_SELECT_ALL_FOR_SEARCH_BY_JENISRAPOR";
        public const string SP_SELECT_BY_TAHUN_AJARAN_BY_SEMESTER_BY_KELAS = "SMP_Rapor_Desain_SELECT_BY_TAHUN_AJARAN_BY_SEMESTER_BY_KELAS";
        public const string SP_SELECT_BY_TAHUN_AJARAN_BY_SEMESTER = "SMP_Rapor_Desain_SELECT_BY_TAHUN_AJARAN_BY_SEMESTER";
        public const string SP_SELECT_BY_ID = "SMP_Rapor_Desain_SELECT_BY_ID";

        public const string SP_INSERT = "SMP_Rapor_Desain_INSERT";

        public const string SP_UPDATE = "SMP_Rapor_Desain_UPDATE";

        public const string SP_DELETE = "SMP_Rapor_Desain_DELETE";
