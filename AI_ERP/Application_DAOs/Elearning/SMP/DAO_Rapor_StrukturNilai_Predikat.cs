...
{
    public static class DAO_Rapor_StrukturNilai_Predikat
    {
        public const string SP_SELECT_ALL = "SMP_Rapor_StrukturNilai_Predikat_SELECT_ALL";
        public const string SP_SELECT_ALL_FOR_SEARCH = "SMP_Rapor_StrukturNilai_Predikat_SELECT_ALL_FOR_SEARCH";
        public const string SP_SELECT_ALL_BY_HEADER = "SMP_Rapor_StrukturNilai_Predikat_SELECT_ALL_BY_HEADER";
        public const string SP_SELECT_ALL_BY_TA_BY_SM = "SMP_Rapor_StrukturNilai_Predikat_SELECT_ALL_BY_TA_BY_SM";
        public const string SP_SELECT_BY_ID = "SMP_Rapor_StrukturNilai_Predikat_SELECT_BY_ID";

        public const string SP_INSERT = "SMP_Rapor_StrukturNilai_Predikat_INSERT";

        public const string SP_UPDATE = "SMP_Rapor_StrukturNilai_Predikat_UPDATE";

        public const string SP_DELETE = "SMP_Rapor_StrukturNilai_Predikat_DELETE";
        public const string SP_DELETE_BY_HEADER = "SMP_Rapor_StrukturNilai_Predikat_DELETE_BY_HEADER";
        ...
        private static Rapor_StrukturNilai_Predikat GetEntityFromDataRow(DataRow row)
        {
            return new Rapor_StrukturNilai_Predikat
            {
        ...
        public static List<Rapor_StrukturNilai_Predikat> GetAll_Entity()
        {
            List<Rapor_StrukturNilai_Predikat> hasil = new List<Rapor_StrukturNilai_Predikat>();
        ...
        public static List<Rapor_StrukturNilai_Predikat> GetAllByHeader_Entity(string rel_rapor_strukturnilai)
        {
            List<Rapor_StrukturNilai_Predikat> hasil = new List<Rapor_StrukturNilai_Predikat>();
            SqlConnection conn = Application_Libs.Libs.GetConnection_Rapor();
            SqlCommand comm = conn.CreateCommand();
        ...
        public static List<Rapor_StrukturNilai_Predikat> GetAllByTABySM_Entity(string tahun_ajaran, string semester)
        {
            List<Rapor_StrukturNilai_Predikat> hasil = new List<Rapor_StrukturNilai_Predikat>();
            SqlConnection conn = Application_Libs.Libs.GetConnection_Rapor();
            SqlCommand comm = conn.CreateCommand();
        ...
        {
            List<Rapor_StrukturNilai_Predikat> lst_predikat = GetAllByHeader_Entity(rel_rapor_strukturnilai);
            foreach (Rapor_StrukturNilai_Predikat item_predikat in lst_predikat)
            {
        ...
        public static Rapor_StrukturNilai_Predikat GetByID_Entity(string kode)
        {
            Rapor_StrukturNilai_Predikat hasil = new Rapor_StrukturNilai_Predikat();
            SqlConnection conn = Application_Libs.Libs.GetConnection_Rapor();
            SqlCommand comm = conn.CreateCommand();
            SqlDataAdapter sqlDA;
        ...
        public static void Insert(Rapor_StrukturNilai_Predikat m, string user_id)
        {
            SqlConnection conn = Application_Libs.Libs.GetConnection_Rapor();
            SqlCommand comm = conn.CreateCommand();
            SqlTransaction transaction = null;
        ...
        public static void Update(Rapor_StrukturNilai_Predikat m, string user_id)
        {
            SqlConnection conn = Application_Libs.Libs.GetConnection_Rapor();
            SqlCommand comm = conn.CreateCommand();
            SqlTransaction transaction = null;
