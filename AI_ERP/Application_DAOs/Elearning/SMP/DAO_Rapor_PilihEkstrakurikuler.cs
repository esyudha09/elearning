...
namespace AI_ERP.Application_DAOs.Elearning.SMP
{
    ...
    {
        public const string SP_SELECT_ALL = "SMP_Rapor_PilihEkstrakurikuler_SELECT_ALL";
        public const string SP_SELECT_BY_TA_BY_SM_BY_KELASDET = "SMP_Rapor_PilihEkstrakurikuler_SELECT_BY_TA_BY_SM_BY_KELASDET";
        public const string SP_SELECT_BY_TA_BY_SM_BY_KELASDET_BY_SISWA = "SMP_Rapor_PilihEkstrakurikuler_SELECT_BY_TA_BY_SM_BY_KELASDET_BY_SISWA";
        public const string SP_SELECT_BY_TA_BY_SM_BY_MAPEL_BY_KELAS = "SMP_Rapor_PilihEkstrakurikuler_SELECT_BY_TA_BY_SM_BY_MAPEL_BY_KELAS";
        public const string SP_SELECT_BY_ID = "SMP_Rapor_PilihEkstrakurikuler_SELECT_BY_ID";

        public const string SP_INSERT = "SMP_Rapor_PilihEkstrakurikuler_INSERT";

        public const string SP_UPDATE = "SMP_Rapor_PilihEkstrakurikuler_UPDATE";

        public const string SP_DELETE = "SMP_Rapor_PilihEkstrakurikuler_DELETE";
