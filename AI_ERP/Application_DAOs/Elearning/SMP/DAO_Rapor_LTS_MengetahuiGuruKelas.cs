...
namespace AI_ERP.Application_DAOs.Elearning.SMP
{
    ...
    {
        public const string SP_SELECT_BY_TA_BY_SM_BY_KELASDET = "SMP_Rapor_LTS_MengetahuiGuruKelas_SELECT_BY_TA_BY_SM_KELASDET";

        public const string SP_INSERT = "SMP_Rapor_LTS_MengetahuiGuruKelas_INSERT";

        public const string SP_UPDATE = "SMP_Rapor_LTS_MengetahuiGuruKelas_UPDATE";
