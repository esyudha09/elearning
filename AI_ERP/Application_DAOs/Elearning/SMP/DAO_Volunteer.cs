...
namespace AI_ERP.Application_DAOs.Elearning.SMP
{
    ...
    {
        public const string SP_SELECT_ALL = "SMP_Volunteer_SELECT_ALL";
        public const string SP_SELECT_BY_ID = "SMP_Volunteer_SELECT_BY_ID";
        public const string SP_SELECT_BY_TA_BY_SM_BY_KELAS = "SMP_Volunteer_SELECT_BY_TA_BY_SM_BY_KELAS";

        public const string SP_INSERT = "SMP_Volunteer_INSERT";

        public const string SP_UPDATE = "SMP_Volunteer_UPDATE";

        public const string SP_DELETE = "SMP_Volunteer_DELETE";
