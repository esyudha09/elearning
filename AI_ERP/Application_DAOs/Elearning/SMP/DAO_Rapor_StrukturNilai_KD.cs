...
namespace AI_ERP.Application_DAOs.Elearning.SMP
{
    ...
    {
        public const string SP_SELECT_ALL = "SMP_Rapor_StrukturNilai_KD_SELECT_ALL";
        public const string SP_SELECT_ALL_FOR_SEARCH = "SMP_Rapor_StrukturNilai_KD_SELECT_ALL_FOR_SEARCH";
        public const string SP_SELECT_ALL_BY_HEADER = "SMP_Rapor_StrukturNilai_KD_SELECT_ALL_BY_HEADER";
        public const string SP_SELECT_BY_ID = "SMP_Rapor_StrukturNilai_KD_SELECT_BY_ID";

        public const string SP_INSERT = "SMP_Rapor_StrukturNilai_KD_INSERT";
        public const string SP_INSERT_LENGKAP = "SMP_Rapor_StrukturNilai_KD_INSERT_LENGKAP";

        public const string SP_UPDATE = "SMP_Rapor_StrukturNilai_KD_UPDATE";

        public const string SP_DELETE = "SMP_Rapor_StrukturNilai_KD_DELETE";
        ...
        public static void InsertLengkap(Rapor_StrukturNilai_KD m, string user_id)
        {
            SqlConnection conn = Application_Libs.Libs.GetConnection_Rapor();
            SqlCommand comm = conn.CreateCommand();
            SqlTransaction transaction = null;
