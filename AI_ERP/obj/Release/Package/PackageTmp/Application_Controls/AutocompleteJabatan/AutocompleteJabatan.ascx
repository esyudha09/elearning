<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AutocompleteJabatan.ascx.cs" Inherits="AI_ERP.Application_Controls.AutocompleteJabatan.AutocompleteJabatan" %>
    ...
    function <%=txtNama.ClientID%>_SHOW_AUTOCOMPLETE(){
        $('[id*=<%=txtNama.ClientID%>]').typeahead({
            ...
            source: function (request, response) {
                $.ajax({
                    url: '<%=ResolveUrl("~/APIs/Master/Jabatan.svc/ShowAutocomplete?kata_kunci=") %>' + request,
                    dataType: "json",
                    type: "GET",
