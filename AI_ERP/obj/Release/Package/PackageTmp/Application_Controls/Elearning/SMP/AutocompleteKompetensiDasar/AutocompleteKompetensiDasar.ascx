<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AutocompleteKompetensiDasar.ascx.cs" Inherits="AI_ERP.Application_Controls.Elearning.SMP.AutocompleteKompetensiDasar.AutocompleteKompetensiDasar" %>
    ...
    function <%=txtNama.ClientID%>_SHOW_AUTOCOMPLETE(){
        $('[id*=<%=txtNama.ClientID%>]').typeahead({
            ...
            source: function (request, response) {
                $.ajax({
                    url: '<%=ResolveUrl("~/APIs/Elearning/SMP/KompetensiDasar.svc/ShowAutocompleteKompetensiDasar?kata_kunci=") %>' + request,
                    dataType: "json",
                    type: "GET",
