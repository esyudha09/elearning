<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AutocompleteRuangKelas.ascx.cs" Inherits="AI_ERP.Application_Controls.AutocompleteRuangKelas.AutocompleteRuangKelas" %>
    ...
    function <%=txtNama.ClientID%>_SHOW_AUTOCOMPLETE(){
        $('[id*=<%=txtNama.ClientID%>]').typeahead({
            ...
            source: function (request, response) {
                $.ajax({
                    url: '<%=ResolveUrl("~/APIs/Master/RUangKelas.svc/ShowAutocomplete?kata_kunci=") %>' + request,
                    dataType: "json",
                    type: "GET",
