...
function AddJadwalWawancara(s_dari_tanggal, s_sampai_tanggal, dari_jam, sampai_jam, kuota, waktu_sesi_menit) {
	if (tbody_wawancara() !== undefined && tbody_wawancara() !== null) {
		//var arr_tr_jadwal = document.getElementsByName("tr_jadwal[]");
		//if (arr_tr_jadwal.length === 0) {
		//	tbody_wawancara().innerHTML = "";
		//}
														...
														">" +
															"<label " +
																"onclick=\"ShowEditJadwal('" + tr_kode + "', '" +
																							   tanggal.ddmmyyyy('/') + "', '" +
																							   jam_wawancara_mulai + "', '" +
																							   jam_wawancara_selesai + "', GetKuota('" + tr_kode +
																					  "'));\" " +
																"class=\"pull-right\" " +
																"title=\" Edit \" " +
...
function ShowEditJadwal(id_tr, tanggal, dari_jam, sampai_jam, kuota) {
