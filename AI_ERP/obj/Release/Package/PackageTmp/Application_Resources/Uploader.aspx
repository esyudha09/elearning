<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Uploader.aspx.cs" Inherits="AI_ERP.Application_Resources.Uploader" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
    <head runat="server">
        ...
        <script type="text/javascript">
            function ResizeFrame() {
                if (window.parent.fraUploaderMateriPembelajaran != null && window.parent.fraUploaderMateriPembelajaran != undefined) {
                    if (window.parent.fraUploaderMateriPembelajaran.contentWindow.document.body != null && window.parent.fraUploaderMateriPembelajaran.contentWindow.document.body != undefined) {
                        window.parent.fraUploaderMateriPembelajaran.style.height = (window.parent.fraUploaderMateriPembelajaran.contentWindow.document.body.scrollHeight - 18) + 'px';
                    }
                }
                if (window.parent.fraUploaderPendidikanNonFormal != null && window.parent.fraUploaderPendidikanNonFormal != undefined) {
                    if (window.parent.fraUploaderPendidikanNonFormal.contentWindow.document.body != null && window.parent.fraUploaderPendidikanNonFormal.contentWindow.document.body != undefined) {
                        window.parent.fraUploaderPendidikanNonFormal.style.height = (window.parent.fraUploaderPendidikanNonFormal.contentWindow.document.body.scrollHeight - 18) + 'px';
                    }
                }
                ...
                if (window.parent.fraUploaderRiwayatKesehatan != null && window.parent.fraUploaderRiwayatKesehatan != undefined) {
                    if (window.parent.fraUploaderRiwayatKesehatan.contentWindow.document.body != null && window.parent.fraUploaderRiwayatKesehatan.contentWindow.document.body != undefined) {
                        window.parent.fraUploaderRiwayatKesehatan.style.height = (window.parent.fraUploaderRiwayatKesehatan.contentWindow.document.body.scrollHeight - 18) + 'px';
                    }
                }
                if (window.parent.fraUploaderRiwayatMCU != null && window.parent.fraUploaderRiwayatMCU != undefined) {
                    if (window.parent.fraUploaderRiwayatMCU.contentWindow.document.body != null && window.parent.fraUploaderRiwayatMCU.contentWindow.document.body != undefined) {
                        window.parent.fraUploaderRiwayatMCU.style.height = (window.parent.fraUploaderRiwayatMCU.contentWindow.document.body.scrollHeight - 18) + 'px';
                    }
                }
                if (window.parent.fraUploaderFileRapor != null && window.parent.fraUploaderFileRapor != undefined) {
                    if (window.parent.fraUploaderFileRapor.contentWindow.document.body != null && window.parent.fraUploaderFileRapor.contentWindow.document.body != undefined) {
                        window.parent.fraUploaderFileRapor.style.height = (window.parent.fraUploaderFileRapor.contentWindow.document.body.scrollHeight - 18) + 'px';
                    }
                }
                
                if (typeof window.parent.ShowProgress === 'function') window.parent.ShowProgress(false);
            }
            function ResizeFrameDel() {
                if (window.parent.fraUploaderMateriPembelajaran != null && window.parent.fraUploaderMateriPembelajaran != undefined) {
                    if (window.parent.fraUploaderMateriPembelajaran.contentWindow.document.body != null && window.parent.fraUploaderMateriPembelajaran.contentWindow.document.body != undefined) {
                        window.parent.fraUploaderMateriPembelajaran.style.height = (window.parent.fraUploaderMateriPembelajaran.contentWindow.document.body.scrollHeight - 69) + 'px';
                    }
                }
                if (window.parent.fraUploaderPendidikanNonFormal != null && window.parent.fraUploaderPendidikanNonFormal != undefined) {
                    if (window.parent.fraUploaderPendidikanNonFormal.contentWindow.document.body != null && window.parent.fraUploaderPendidikanNonFormal.contentWindow.document.body != undefined) {
                        window.parent.fraUploaderPendidikanNonFormal.style.height = (window.parent.fraUploaderPendidikanNonFormal.contentWindow.document.body.scrollHeight - 69) + 'px';
                    }
                }
                if (window.parent.fraUploaderFilePendukung != null && window.parent.fraUploaderFilePendukung != undefined) {
                    if (window.parent.fraUploaderFilePendukung.contentWindow.document.body != null && window.parent.fraUploaderFilePendukung.contentWindow.document.body != undefined) {
                ...
                if (window.parent.fraUploaderRiwayatKesehatan != null && window.parent.fraUploaderRiwayatKesehatan != undefined) {
                    if (window.parent.fraUploaderRiwayatKesehatan.contentWindow.document.body != null && window.parent.fraUploaderRiwayatKesehatan.contentWindow.document.body != undefined) {
                        window.parent.fraUploaderRiwayatKesehatan.style.height = (window.parent.fraUploaderRiwayatKesehatan.contentWindow.document.body.scrollHeight - 69) + 'px';
                    }
                }
                if (window.parent.fraUploaderRiwayatMCU != null && window.parent.fraUploaderRiwayatMCU != undefined) {
                    if (window.parent.fraUploaderRiwayatMCU.contentWindow.document.body != null && window.parent.fraUploaderRiwayatMCU.contentWindow.document.body != undefined) {
                        window.parent.fraUploaderRiwayatMCU.style.height = (window.parent.fraUploaderRiwayatMCU.contentWindow.document.body.scrollHeight - 69) + 'px';
                    }
                }
                if (window.parent.fraUploaderFileRapor != null && window.parent.fraUploaderFileRapor != undefined) {
                    if (window.parent.fraUploaderFileRapor.contentWindow.document.body != null && window.parent.fraUploaderFileRapor.contentWindow.document.body != undefined) {
                        window.parent.fraUploaderFileRapor.style.height = (window.parent.fraUploaderFileRapor.contentWindow.document.body.scrollHeight - 69) + 'px';
                    }
                }                
                if (typeof window.parent.ShowProgress === 'function') window.parent.ShowProgress(false);
            }
    ...
    <body style="background-color: #ddf2ff; background-color: white; padding: 0px; padding-left: 0px; padding-top: 0px; margin: 0px; font-family: 'Raleway', Arial, sans-serif">
        <div>
            <form id="fileupload" 
                action="<%= ResolveUrl("~/Application_Resources/UploadHandler_2_0.aspx?jenis=" + AI_ERP.Application_Libs.Libs.GetQueryString("jenis") + "&id=" + AI_ERP.Application_Libs.Libs.GetQueryString("id") + "&id2=" + AI_ERP.Application_Libs.Libs.GetQueryString("id2") + "&tr=" + AI_ERP.Application_Libs.Libs.GetQueryString("tr")) %>" 
