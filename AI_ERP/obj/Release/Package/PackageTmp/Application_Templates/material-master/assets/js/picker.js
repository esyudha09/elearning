...
// material customisation
	(function ($) {
		...
		Datepicker.DEFAULTS = {
			...
			selectYears: false,
			today: 'Hari ini',
			weekdaysFull: ['Min', 'Sen', 'Sel', 'Rab', 'Kam', 'Jum', 'Sab'],
