            ...
            switch (option) {
                ...
                default:
                    if (this.val()) {
                        ...
                        if ($('option:first-child', this).html() != null && $('option:first-child', this).html() != undefined){
                            parent.addClass('control-highlight');
                        }
                        else {
