<%@ Page Title="" Language="C#" MasterPageFile="~/Application_Masters/Main.Master" AutoEventWireup="true" CodeBehind="wf.LTS.aspx.cs" Inherits="AI_ERP.Application_Modules.EDUCATION.Penilaian.SD.wf_LTS" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        //report proses LTS
		function ReportProsesLTS() {
			var url = "<%= ResolveUrl(AI_ERP.Application_Libs.Routing.URL.APPLIACTION_MODULES.EDUCATION.Penilaian.SD.RAPOR_LTS.ROUTE) %>";
		    var tahun_ajaran = document.getElementById("<%= cboTahunPelajaran.ClientID %>").value;
		    var semester = document.getElementById("<%= cboSemester.ClientID %>").value;
            var kelas_det = document.getElementById("<%= cboKelas.ClientID %>").value;
			...
			if (navigator.appName == 'Microsoft Internet Explorer') {
			    window.frames['fra_proses'].document.location.href = url;
			} else {
			    window.frames['fra_proses'].location.href = url;
			}
		}

        function ShowProsesLTS(show) {
            pb_proses_lts.style.display = (show ? "" : "none");
            div_button_proses_lts.style.display = (show ? "none" : "");
            if (!show) {
                if (navigator.appName == 'Microsoft Internet Explorer') {
                    window.frames['fra_proses'].document.execCommand('Stop');
                } else {
                    window.frames['fra_proses'].stop();
                }
            }
        }

        function StopProsesLTS()
        {
            if (navigator.appName == 'Microsoft Internet Explorer') {
                window.frames['fra_proses'].document.execCommand('Stop');
            } else {
        ...
        validateProsesLTS = function(){
            var isValid = Page_ClientValidate("vldInput");
            return isValid;
        }
    </script>
</asp:Content>
                                    ...
                                    <table style="width: 100%;">
                                        <tr>
                                            <td style="background-color: #295BC8; padding: 10px; font-weight: normal; vertical-align: middle; color: white; padding-left: 20px; font-size: 15px;">
                                                <img src="<%= ResolveUrl("~/Application_CLibs/images/svg/doc.svg") %>" 
							                                ...
							                                <table class="table" id="itemPlaceholderContainer" runat="server" style="width: 100%; margin: 0px;">
								                                <thead>
								                                    <tr style="background-color: #3367d6;">
                                                                        ...
                                                                        <th style="background-color: #3367d6; text-align: left; padding-left: 10px; vertical-align: middle;">
                                                                            <asp:LinkButton ID="H_KelasDet" runat="server" CommandName="Sort" CommandArgument="Kelas" style="color: white; font-weight: bold;">
                                                                                Kelas
                                                                            </asp:LinkButton>
		        ...
		        <div class="modal-dialog modal-xs">
			        <div class="modal-content" style="border: none; border-top-left-radius: 6px; border-top-right-radius: 6px;">
                                                ...
                                                <div class="col-xs-12">
                                                    <div class="form-group" style="margin-top: 0px; margin-bottom: 0px;">
													    <div class="checkbox switch">
														    <label for="<%= chkIsLock.ClientID %>">
															    <input runat="server" class="access-hide" id="chkIsLock" type="checkbox"><span class="switch-toggle"></span>
															    <span style="font-weight: bold; font-size: small; color: grey;">
																    Kunci Data
															    </span>
                                                                <br />
                                                                <span style="font-weight: normal; font-size: small; ">
                                                                    Setelah diproses, data nilai LTS dikunci & tidak dapat di-edit atau dihapus
                                                                </span>
														    </label>
													    </div>
												    </div>
				        ...
				        <div class="modal-footer">
                            ...
                            <div class="row" id="pb_proses_lts" style="display: none; margin-left: -24px; margin-right: -24px; background-color: #B50000; color: white;">
                            ...
                            <div class="row" id="div_button_proses_lts">
							    <div class="col-xs-12">

                                    <p class="text-right">
                                        <asp:LinkButton OnClientClick="if(validateProsesLTS()) { ShowProsesLTS(true); ReportProsesLTS(); return false; }" ValidationGroup="vldInput" CssClass="btn btn-flat btn-brand-accent waves-attach waves-effect" runat="server" ID="lnkOKInput" OnClick="lnkOKInput_Click" Text="   OK   "></asp:LinkButton>
                                        &nbsp;&nbsp;
