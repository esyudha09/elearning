<%@ Page Title="" Language="C#" MasterPageFile="~/Application_Masters/Main.Master" AutoEventWireup="true" CodeBehind="wf.DesainRapor.aspx.cs" Inherits="AI_ERP.Application_Modules.EDUCATION.Penilaian.SMP.wf_DesainRapor" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        function HideModal(){
            ...
            $('#ui_modal_input_item_desain').modal('hide');    
            $('#ui_modal_hapus_item_desain').modal('hide');    
        ...
        function EndRequest() {
            ...
            switch (jenis_act) {
                ...
                case "<%= JenisAction.DoShowConfirmHapus %>":
                    ...
                    break;
                case "<%= JenisAction.DoShowInputDesain %>":
                    HideModal();
                    $('#ui_modal_input_item_desain').modal({ backdrop: 'static', keyboard: false, show: true });                    
                    break;
        ...
        function InitModalFocus(){
            ...
            $('#ui_modal_input_item_desain').on('shown.bs.modal', function () {
                <%= cboMapel.ClientID %>.focus();
            });
        }

        function ShowConfirmHapusMengajar(){
            ParseSelectItem();
            $('#ui_modal_hapus_item_desain').modal({ backdrop: 'static', keyboard: false, show: true });
        }
        ...
        function ShowNamaMapelRapor(){
            var txt_nama = document.getElementById("<%= txtNamaMapelRapor.ClientID %>");
            ...
            if(txt_nama !== null && txt_nama !== undefined){
                if(cbo_mapel !== null && cbo_mapel !== undefined){
                    txt_nama.value = cbo_mapel.options[cbo_mapel.selectedIndex].text;
                }
            }
        }
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel runat="server" ID="upMain">
        <ContentTemplate>
            ...
            <asp:Button UseSubmitBehavior="false" runat="server" ID="btnShowDataDesain" OnClick="btnShowDataDesain_Click" style="position: absolute; left: -1000px; top: -1000px;" />
            <asp:Button UseSubmitBehavior="false" runat="server" ID="btnShowInputDataDesain" OnClick="btnShowInputDataDesain_Click" style="position: absolute; left: -1000px; top: -1000px;" />
            ...
            <asp:Button UseSubmitBehavior="false" runat="server" ID="btnShowEditDataDesain" OnClick="btnShowEditDataDesain_Click" style="position: absolute; left: -1000px; top: -1000px;" />
				            ...
				            <div class="card-main">
					            <div class="card-inner" style="margin: 0px; padding: 0px; margin-right: -0.5px; ">
                                    <table style="width: 100%;">
                                        <tr>
                                            <td style="background-color: #295BC8; padding: 10px; font-weight: normal; vertical-align: middle; color: white; padding-left: 20px; font-size: 15px;">
                                                <img src="<%= ResolveUrl("~/Application_CLibs/images/svg/036-certificate.svg") %>" 
						            ...
						            <asp:MultiView runat="server" ID="mvMain" ActiveViewIndex="0">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr class="<%# (Container.DisplayIndex % 2 == 0 ? "standardrow" : "oddrow") %>">
                                                            ...
                                                            <td style="text-align: right;">
                                                                ...
                                                                <label id="lbl_<%# Eval("Kode").ToString().Replace("-", "_") %>" onclick="this.style.display = 'none'; img_<%# Eval("Kode").ToString().Replace("-", "_") %>.style.display = ''; setTimeout(function() { <%= txtID.ClientID %>.value = '<%# Eval("Kode").ToString() %>';<%= btnShowDataDesain.ClientID %>.click(); }, 1000);" class="badge" style="cursor: pointer; font-weight: normal; font-size: x-small;">
                                                                    &nbsp;
                                        ...
                                        <asp:View ID="vListNilaiRapor" runat="server">
                                            ...
                                            <div style="padding: 0px; margin: 0px;">
                                                ...
                                                <asp:ListView ID="lvListDesainRaporDet" DataSourceID="sql_ds_desain_rapor_det" runat="server" OnPagePropertiesChanging="lvListDesainRaporDet_PagePropertiesChanging">
                                                    <LayoutTemplate>
                                                        <div class="table-responsive" style="margin: 0px; box-shadow: none;">
							                                <table class="table" id="itemPlaceholderContainer" runat="server" style="width: 100%; margin: 0px;">
								                                <thead>
								                                    <tr style="background-color: #3c70e1;">
                                                                        ...
                                                                        <th style="background-color: #3c70e1; text-align: center; padding-left: 10px; vertical-align: middle;">
                                                                            Nomor
									                                    </th>
                                                                        <th style="background-color: #3c70e1; text-align: center; padding-left: 10px; vertical-align: middle;">
                                                                            Poin
                                                    ...
                                                    <ItemTemplate>
                                                        <tr class="<%# (Container.DisplayIndex % 2 == 0 ? "standardrow" : "oddrow") %>">
                                                                ...
                                                                <div class="checkbox checkbox-adv" style="margin: 0 auto;">
													                <label for="chk_desain_<%# Eval("Kode").ToString().Replace("-", "_") %>">
														                <input value="<%# Eval("Kode").ToString() %>" 
                                                                               class="access-hide" 
                                                                               id="chk_desain_<%# Eval("Kode").ToString().Replace("-", "_") %>" 
                                                                               name="chk_desain[]" 
                                                                               type="checkbox">
                                                            ...
                                                            <td style="font-weight: normal; padding: 10px; vertical-align: top; text-align: center;">
                                                                <span style="color: grey; font-weight: bold; text-transform: none; text-decoration: none;">
                                                                    <%# 
                                                                        Eval("Nomor").ToString()
                                                                    %>
                                                            ...
                                                            <td style="font-weight: normal; padding: 10px; vertical-align: middle; text-align: left;">
                                                                <span style="color: grey; font-weight: bold; text-transform: none; text-decoration: none;">
                                                                    <%# 
                                                                        AI_ERP.Application_Libs.Libs.GetHTMLSimpleText(Eval("NamaMapelRapor").ToString())
                                                                    %>
                                                                </span>
                                                                <br />
                                                                <span style="color: grey; font-weight: normal; text-transform: none; text-decoration: none; font-size: small;">
                                                                    <%# 
                                                                        Eval("Mapel").ToString()
                                                                    %>
                                                                </span>
                                                                <span style="color: grey; font-weight: normal; text-transform: none; text-decoration: none; font-size: small; font-weight: bold;">
                                                                    <%# 
                                                                        (
                                                                            Eval("Alias").ToString().Trim() != ""
                                                                            ? "<br />"
                                                                            : ""
                                                                        ) +
                                                                        Eval("Alias").ToString()
                                                                ...
                                                                <button onclick="<%= txtIDItem.ClientID %>.value = '<%# Eval("Kode").ToString() %>';<%= btnShowEditDataDesain.ClientID %>.click(); return false;" title=" Ubah " onclick="return false;" class="btn btn-flat btn-brand-accent waves-attach waves-effect pull-right" 
                                                            ...
                                                            <td style="font-weight: normal; padding: 10px; vertical-align: middle; text-align: center;">
                                                                <span style="color: grey; font-weight: normal; text-transform: none; text-decoration: none;">
                                                                    <%# 
                                                                        AI_ERP.Application_Libs.Libs.GetHTMLSimpleText(Eval("Urutan").ToString())
                                                                    %>
                                                                </span>
                                                            </td>
                                                        </tr>
                                            ...
                                            <asp:SqlDataSource ID="sql_ds_desain_rapor_det" runat="server"></asp:SqlDataSource>
                                            ...
                                            <div class="fbtn-container" id="div_button_settings_formasi_guru" runat="server">
		                                        <div class="fbtn-inner">
			                                        <a onclick="setTimeout(
                                                            function(){
                                                                <%= btnShowInputDataDesain.ClientID %>.click();
                                                            }, 500
            ...
            <div aria-hidden="true" class="modal fade" id="ui_modal_input_item_desain" role="dialog" tabindex="-1" style="display: none; padding-right: 9px; z-index: 2000;">
		        <div class="modal-dialog modal-xs">
			        <div class="modal-content" style="border: none; border-top-left-radius: 6px; border-top-right-radius: 6px;">
                                            ...
                                            <div class="row" style="margin-left: 30px; margin-right: 30px;">
                                                <div class="col-xs-12" style="padding-left:  0px; padding-right: 0px;">
                                                    <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                        ...
                                                        <asp:DropDownList ValidationGroup="vldItemRapor" CssClass="form-control" runat="server" ID="cboMapel"></asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row" style="margin-left: 30px; margin-right: 30px;">
                                                <div class="col-xs-12" style="padding-left:  0px; padding-right: 0px;">
                                                    <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                        <label class="label-input" for="<%= txtNamaMapelRapor.ClientID %>" style="text-transform: none;">Nama Mata Pelajaran Rapor</label>
                                                        <asp:RequiredFieldValidator ValidationGroup="vldItemRapor" runat="server" ID="vldNamaMapelRapor"
                                                            ControlToValidate="txtNamaMapelRapor" Display="Dynamic" style="float: right; font-weight: bold;"
                                                            Text="<i class='fa fa-exclamation-triangle'></i>" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                                        <asp:TextBox ValidationGroup="vldItemRapor" runat="server" ID="txtNamaMapelRapor" CssClass="form-control"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row" style="margin-left: 30px; margin-right: 30px;">
                                                <div class="col-xs-12" style="padding-left:  0px; padding-right: 0px;">
                                                    <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                        ...
                                                        <asp:TextBox ValidationGroup="vldItemRapor" runat="server" ID="txtAlias" CssClass="form-control"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row" style="margin-left: 30px; margin-right: 30px;">
                                                <div class="col-xs-6" style="padding-left:  0px; padding-right: 0px;">
                                                    <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                        <label class="label-input" for="<%= txtNomor.ClientID %>" style="text-transform: none;">Nomor</label>
                                                        <asp:TextBox ValidationGroup="vldItemRapor" runat="server" ID="txtNomor" CssClass="form-control"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row" style="margin-left: 30px; margin-right: 30px;">
                                                <div class="col-xs-6" style="padding-left:  0px; padding-right: 0px;">
                                                    <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                        <label class="label-input" for="<%= txtPoin.ClientID %>" style="text-transform: none;">Poin</label>
                                                        <asp:TextBox ValidationGroup="vldItemRapor" runat="server" ID="txtPoin" CssClass="form-control"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row" style="margin-left: 30px; margin-right: 30px;">
                                                <div class="col-xs-6" style="padding-left:  0px; padding-right: 0px;">
                                                    <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                        <label class="label-input" for="<%= txtUrutan.ClientID %>" style="text-transform: none;">Urutan</label>
                                                        <asp:RequiredFieldValidator ValidationGroup="vldItemRapor" runat="server" ID="vldUrutan"
                                                            ControlToValidate="txtUrutan" Display="Dynamic" style="float: right; font-weight: bold;"
                                                            Text="<i class='fa fa-exclamation-triangle'></i>" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                                        <asp:TextBox ValidationGroup="vldItemRapor" runat="server" ID="txtUrutan" CssClass="form-control"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
										</div>  
				        ...
				        <div class="modal-footer">
					        <p class="text-right">
                                <asp:LinkButton ValidationGroup="vldItemRapor" CssClass="btn btn-flat btn-brand-accent waves-attach waves-effect" runat="server" ID="lnkOKItemDesain" OnClick="lnkOKItemDesain_Click" Text="   OK   "></asp:LinkButton>
                                &nbsp;&nbsp;
            ...
            <div aria-hidden="true" class="modal fade" id="ui_modal_hapus_item_desain" role="dialog" tabindex="-1" style="display: none; padding-right: 9px; z-index: 2000;">
		        <div class="modal-dialog modal-xs">
			        <div class="modal-content" style="border: none; border-top-left-radius: 6px; border-top-right-radius: 6px;">
				        <div class="modal-inner" 
                            style="margin-left: 0px; margin-right: 0px; margin-bottom: 0px; margin-top: 0px; 
				        ...
				        <div class="modal-footer">
					        <p class="text-right">
                                <asp:LinkButton CssClass="btn btn-flat btn-brand-accent waves-attach waves-effect" runat="server" ID="lnkOKHapusItemDesain" OnClick="lnkOKHapusItemDesain_Click" Text="  OK  "></asp:LinkButton>
                                <a class="btn btn-flat btn-brand-accent waves-attach waves-effect" data-dismiss="modal">Batal</a>      
                                <br /><br />                              
					        </p>
				        </div>
