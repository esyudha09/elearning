<%@ Page Title="" Language="C#" MasterPageFile="~/Application_Masters/Main.Master" AutoEventWireup="true" CodeBehind="wf.NilaiSiswaLTS.aspx.cs" Inherits="AI_ERP.Application_Modules.EDUCATION.Penilaian.SD.wf_NilaiSiswaLTS" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="upMain" runat="server">
            ...
            <div class="fbtn-container" id="div_button_settings" runat="server" style="z-index: 999999;">
                <div class="fbtn-inner">
                    ...
                    <div class="fbtn-dropup" style="z-index: 999999;">
                        <asp:LinkButton CssClass="fbtn fbtn-green waves-attach waves-circle waves-effect" runat="server" ID="lnkOKCetakBahasaKD" Style="background-color: #424242;">
                        ...
                        <asp:LinkButton Visible="false" OnClientClick="ShowProgress(true);" CssClass="fbtn fbtn-green waves-attach waves-circle waves-effect" runat="server" ID="lnkPengaturanLTS" OnClick="lnkPengaturanLTS_Click" Style="background-color: #424242;">
                        ...
                        <div class="card" style="margin-top: 0px; box-shadow: none; border-style: solid; border-color: #C6C6C6; border-width: 1px;">
				            <div class="card-main">
					            <div class="card-inner" style="margin: 0px; padding: 0px; ">
                                    <div style="margin: 0 auto; display: table; margin-top: 25px; margin-bottom: 25px; width: 100%; padding-left: 15px; padding-right: 15px;">
                                        <div id="printarea" style="margin: 0 auto; display: table; width: 100%;">
		        ...
		        <div class="modal-dialog modal-xs">
			        <div class="modal-content" style="border: none; border-top-left-radius: 6px; border-top-right-radius: 6px;">
				        ...
				        <div class="modal-footer">
                            ...
                            <p class="text-right">
                                <asp:LinkButton OnClientClick="$('#ui_modal_pengaturan').modal('hide'); ShowProgress(true);" ValidationGroup="vldInputPengaturan" CssClass="btn btn-flat btn-brand-accent waves-attach waves-effect" runat="server" ID="lnkOKPengaturan" OnClick="lnkOKPengaturan_Click" Text="   OK   "></asp:LinkButton>
                                &nbsp;&nbsp;
        ...
        <Triggers>
            ...
            <asp:PostBackTrigger ControlID="lnkOKCetakSatuKelas" />            
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
