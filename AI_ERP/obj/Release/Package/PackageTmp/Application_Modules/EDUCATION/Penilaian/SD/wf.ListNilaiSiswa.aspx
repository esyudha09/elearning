<%@ Page Title="" Language="C#" MasterPageFile="~/Application_Masters/Main.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="wf.ListNilaiSiswa.aspx.cs" Inherits="AI_ERP.Application_Modules.EDUCATION.Penilaian.SD.wf_ListNilaiSiswa" %>
											                                ...
											                                <ul class="dropdown-menu-list-table">
												                                <li style="background-color: white; padding: 10px;">
													                                <label 
                                                                                        onclick="
                                                                                            ...
                                                                                            window.open( 
                                                                                            '<%# 
                                                                                                ResolveUrl(AI_ERP.Application_Libs.Routing.URL.APPLIACTION_MODULES.EDUCATION.Penilaian.SD.NILAI_SISWA.ROUTE) +
                                                                                        ...
                                                                                        id="btnDetail" style="color: #114D79; cursor: pointer; padding-left: 5px; padding-right: 5px; font-weight: bold;">
                                                                                            <i class="fa fa-th" title=" Lihat Nilai Siswa "></i>&nbsp;&nbsp;&nbsp;Lihat Nilai Siswa&nbsp;&nbsp;&nbsp;
													                                </label>
												                                </li>
                                                                                ...
                                                                                <li style="background-color: white; padding: 10px;">
													                                <label 
                                                                                        onclick="
                                                                                            <%= btnBindDataList.ClientID %>.click();
                                                                                            <%= txtJenisLihatCetak.ClientID %>.value = '<%# AI_ERP.Application_Modules.EDUCATION.Penilaian.SD.wf_ListNilaiSiswa.JenisLihatCetak.LTS %>'; 
                                                                                ...
                                                                                <li style="<%# Eval("TahunAjaran").ToString() == "2020/2021" ? "display: none;" : "" %>background-color: white; padding: 10px;">
													                                <label 
                                                                                        onclick="
                                                                                            ...
                                                                                            window.open('<%# 
                                                                                                            ResolveUrl(
                                                                                                                AI_ERP.Application_Modules.EDUCATION.Penilaian.SD.wf_ListNilaiSiswa.s_url_ok + "?" +
                                                                                                                "t=" + AI_ERP.Application_Libs.RandomLibs.GetRndTahunAjaran(Eval("TahunAjaran").ToString()) +
                                                                                            ...
                                                                                            "
                                                                                        style="color: #114D79; cursor: pointer; padding-left: 5px; padding-right: 5px; font-weight: bold;">
                                                                                            <i class="fa fa-th-list" title=" Lihat Deskripsi LTS "></i>&nbsp;&nbsp;&nbsp;Lihat Deskripsi LTS&nbsp;&nbsp;&nbsp;
													                                </label>
												                                </li>
                                                                                ...
                                                                                <li style="background-color: white; padding: 10px;">
													                                <label 
                                                                                        onclick="
                                                                                            ...
                                                                                            window.open( 
                                                                                            '<%# 
                                                                                                ResolveUrl(AI_ERP.Application_Libs.Routing.URL.APPLIACTION_MODULES.EDUCATION.Penilaian.SD.LIHAT_LEDGER.ROUTE) +
                                                                                                            "?t=" + AI_ERP.Application_Libs.RandomLibs.GetRndTahunAjaran(Eval("TahunAjaran").ToString()) +
                                                                                                            "&kd=" + Eval("Rel_KelasDet").ToString()	
                                                                                            %>' + '&s=' + <%# txtSemester.ClientID %>.value, '_blank')
                                                                                        " 
                                                                                        id="btnDetail" style="color: #2a8164; cursor: pointer; padding-left: 5px; padding-right: 5px; font-weight: bold;">
                                                                                            <i class="fa fa-table" title=" Lihat Ledger Nilai "></i>&nbsp;&nbsp;&nbsp;Lihat Ledger Nilai&nbsp;&nbsp;&nbsp;
													                                </label>
												                                </li>
                                                                                <li style="background-color: white; padding: 10px;">
													                                <label 
                                                                                        ...
                                                                                        " 
                                                                                        id="btnDetail" style="color: #2a8164; cursor: pointer; padding-left: 5px; padding-right: 5px; font-weight: bold;">
                                                                                            <i class="fa fa-table" title=" Lihat Ledger Sikap "></i>&nbsp;&nbsp;&nbsp;Lihat Ledger Sikap&nbsp;&nbsp;&nbsp;
													                                </label>
												                                </li>
                                                                                <li style="<%# (Eval("Semester").ToString() == "2" ? "" : " display: none; ") %>background-color: white; padding: 10px;">
													                                <label 
                                                                                        ...
                                                                                        " 
                                                                                        id="btnDetail" style="color: #2a8164; cursor: pointer; padding-left: 5px; padding-right: 5px; font-weight: bold;">
                                                                                            <i class="fa fa-table" title=" Lihat Ledger Nilai Rata-Rata "></i>&nbsp;&nbsp;&nbsp;Lihat Ledger Nilai Rata-Rata&nbsp;&nbsp;&nbsp;
													                                </label>
												                                </li>
                                                                                ...
                                                                                <li style="<%# (Eval("Semester").ToString() == "2" ? "" : " display: none; ") %>background-color: white; padding: 10px;">
													                                <label 
                                                                                        ...
                                                                                        id="btnDetail" style="color: palevioletred; cursor: pointer; padding-left: 5px; padding-right: 5px; font-weight: bold;">
                                                                                ...
                                                                                <li style="background-color: white; padding: 10px;">
													                                <label 
                                                                                        onclick="
                                                                                            <%= btnBindDataList.ClientID %>.click();
                                                                                            <%= txtJenisLihatCetak.ClientID %>.value = '<%# AI_ERP.Application_Modules.EDUCATION.Penilaian.SD.wf_ListNilaiSiswa.JenisLihatCetak.RAPOR %>'; 
                                                                                            <%= txtTahunAjaran.ClientID %>.value = '<%# Eval("TahunAjaran").ToString() %>'; 
                                                                                            <%= txtSemester.ClientID %>.value = '<%# Eval("Semester").ToString() %>'; 
                                                                                            <%= txtKelas.ClientID %>.value = '<%# Eval("Kelas").ToString() %>';
                                                                                            <%= txtKelasDet.ClientID %>.value = '<%# Eval("Rel_KelasDet").ToString() %>';
                                                                                            <%= btnShowCetakRapor.ClientID %>.click();" 
                                                                                        " 
                                                                                        id="btnDetail" style="color: #67367c; cursor: pointer; padding-left: 5px; padding-right: 5px; font-weight: bold;">
                                                                                            <i class="fa fa-file-pdf-o"></i>&nbsp;&nbsp;&nbsp;Lihat Nilai Rapor&nbsp;&nbsp;&nbsp;
													                                </label>
												                                </li>
                                                                                <li style="background-color: white; padding: 10px;<%# AI_ERP.Application_Libs.Libs.GetStringToInteger(Eval("TahunAjaran").ToString().Substring(0, 4)) >= 2020 ? " display: none; " : "" %>">
                                                                                    <label 
                                                                                        onclick="
                                                                                            <%= btnBindDataList.ClientID %>.click();
                                                                                            <%= txtJenisLihatCetak.ClientID %>.value = '<%# AI_ERP.Application_Modules.EDUCATION.Penilaian.SD.wf_ListNilaiSiswa.JenisLihatCetak.RAPOR_URAIAN %>'; 
                                                                                            <%= txtTahunAjaran.ClientID %>.value = '<%# Eval("TahunAjaran").ToString() %>'; 
                                                                                            <%= txtSemester.ClientID %>.value = '<%# Eval("Semester").ToString() %>'; 
                                                                                            <%= txtKelas.ClientID %>.value = '<%# Eval("Kelas").ToString() %>';
                                                                                            <%= txtKelasDet.ClientID %>.value = '<%# Eval("Rel_KelasDet").ToString() %>';
                                                                                        ...
                                                                                        " 
                                                                                        id="btnDetail" style="color: #67367c; cursor: pointer; padding-left: 5px; padding-right: 5px; font-weight: bold;">
                                                                                            <i class="fa fa-file-pdf-o"></i>&nbsp;&nbsp;&nbsp;Lihat Uraian Rapor&nbsp;&nbsp;&nbsp;
													                                </label>
												                                </li>
											                                </ul>
										                                </li>
						                    ...
						                    <div class="fbtn-container">
							                    <div class="fbtn-inner">
								                    <a id="btnDoSavePengaturanPSB" 
                                                        onmouseup="setTimeout(function() { $('#<%= mdlConfirmEmailLTS.ClientID %>').modal('show'); }, 300);" 
												...
												<div class="modal-dialog modal-xs">
													<div class="modal-content">
														...
														<div class="modal-footer">
															<p class="text-right">
																<asp:LinkButton CssClass="btn btn-flat btn-brand-accent waves-attach waves-effect"  runat="server" ID="btnOKKirimEmailLTS" OnClick="btnOKKirimEmailLTS_Click">
            ...
            <div aria-hidden="true" class="modal fade" id="ui_modal_email_lts" role="dialog" tabindex="-1" style="display: none; padding-right: 9px; z-index: 2000;">
		        ...
		        <div class="modal-dialog modal-xs">
			        <div class="modal-content" style="border: none; border-top-left-radius: 6px; border-top-right-radius: 6px;">
				        ...
				        <div class="modal-footer">
					        <p class="text-right">
                                <asp:LinkButton OnClick="lnkOKKirimEmailLTS_Click" ValidationGroup="vldInput" CssClass="btn btn-flat btn-brand-accent waves-attach waves-effect" runat="server" ID="lnkOKKirimEmailLTS" Text="   OK   "></asp:LinkButton>
                                &nbsp;&nbsp;
                                <a class="btn btn-flat btn-brand-accent waves-attach waves-effect" data-dismiss="modal">Batal</a>                                    
                                <br /><br />
					        </p>
