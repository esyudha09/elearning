<%@ Page Title="" Language="C#" MasterPageFile="~/Application_Masters/Main.Master" AutoEventWireup="true" CodeBehind="wf.FormasiSiswaEkskul.aspx.cs" Inherits="AI_ERP.Application_Modules.EDUCATION.Penilaian.SMP.wf_FormasiSiswaEkskul" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        function HideModal(){
            ...
            $('#ui_modal_input_guru_pembimbing').modal('hide');                
            $('#ui_modal_hapus_item_formasi').modal('hide');    
            $('#ui_modal_hapus_item_guru_pembimbing').modal('hide');                
        ...
        function EndRequest() {
            ...
            switch (jenis_act) {
                ...
                case "<%= JenisAction.DoShowInputFormasiEkskul %>":
                    ...
                    break;
                case "<%= JenisAction.DoShowInputFormasiGuruPembimbing %>":
                    $('#ui_modal_input_guru_pembimbing').modal({ backdrop: 'static', keyboard: false, show: true });                    
                    break;
                ...
                case "<%= JenisAction.ShowDataFormasiGuruPembimbing %>":                    
                    window.scrollTo(0,0); 
                    break;
                default:
                    HideModal();
            ...
            <%= txtSiswa.NamaClientID %>_SHOW_AUTOCOMPLETE();            
            <%= txtGuruPembimbing.NamaClientID %>_SHOW_AUTOCOMPLETE();
        ...
        function InitModalFocus(){
            ...
            $('#ui_modal_input_siswa_mapel').on('shown.bs.modal', function () {
                ...
                <%= txtSiswa.NamaClientID %>.focus();
            });

            $('#ui_modal_input_guru_pembimbing').on('shown.bs.modal', function () {
                <%= txtGuruPembimbing.NamaClientID %>.focus();
            });            
        }
        ...
        function SelectOrUnSelectAllGuruPembimbing(){
            var arr_formasi = document.getElementsByName("chk_formasi_guru[]");
            if(arr_formasi.length > 0){
                var ada_cek = false;
                for (var i = 0; i < arr_formasi.length; i++) {
                    if(arr_formasi[i].checked){
        ...
        function ParseSelectItemGuruPembimbing(){
            var txt_sel_item = document.getElementById("<%= txtSelItem.ClientID %>");
            if(txt_sel_item != null && txt_sel_item != undefined){
                txt_sel_item.value = "";
                var arr_formasi = document.getElementsByName("chk_formasi_guru[]");
        ...
        function ShowConfirmHapusGuruPembimbing(){
            ParseSelectItemGuruPembimbing();
            $('#ui_modal_hapus_item_guru_pembimbing').modal({ backdrop: 'static', keyboard: false, show: true });
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel runat="server" ID="upMain">
        <ContentTemplate>
            ...
            <asp:Button UseSubmitBehavior="false" runat="server" ID="btnShowDataFormasiGuruPembina" OnClick="btnShowDataFormasiGuruPembina_Click" style="position: absolute; left: -1000px; top: -1000px;" />            
            ...
            <asp:Button UseSubmitBehavior="false" runat="server" ID="btnShowInputGuruPembimbing" OnClick="btnShowInputGuruPembimbing_Click" style="position: absolute; left: -1000px; top: -1000px;" />
            ...
            <asp:Button UseSubmitBehavior="false" runat="server" ID="btnShowEditGuruPembimbing" OnClick="btnShowEditGuruPembimbing_Click" style="position: absolute; left: -1000px; top: -1000px;" />            
				            ...
				            <div class="card-main">
					            <div class="card-inner" style="margin: 0px; padding: 0px; margin-right: -0.5px; ">
						            ...
						            <asp:MultiView runat="server" ID="mvMain" ActiveViewIndex="0">
                                                ...
                                                <asp:ListView ID="lvData" DataSourceID="sql_ds" runat="server" OnSorting="lvData_Sorting" OnPagePropertiesChanging="lvData_PagePropertiesChanging">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr class="<%# 
                                                            ...
                                                            <td style="font-weight: bold; padding: 10px; vertical-align: middle; text-align: left; cursor: pointer; padding-top: 1px; padding-bottom: 1px;" onclick="DoScrollPos(); <%= txtID.ClientID %>.value = '<%# Eval("Kode").ToString() %>';">
                                                                ...
                                                                <br />
                                                                <label title=" Formasi Guru/Pembina " id="lbl_<%# Eval("Kode").ToString().Replace("-", "_") %>" onclick="DoScrollPos(); setTimeout(function() { <%= txtID.ClientID %>.value = '<%# Eval("Kode").ToString() %>';<%= btnShowDataFormasiGuruPembina.ClientID %>.click(); }, 100);" 
                                                                       style="cursor: pointer; font-weight: normal; font-size: small; color: darkblue; text-align: center;">
                                                                    <i class="fa fa-user"></i> Guru/Pembina
                                                                </label>
                                                                <span style="color: #d9d9d9;">&nbsp;|&nbsp;</span>
                                                                <label title=" Formasi Siswa " id="lbl_<%# Eval("Kode").ToString().Replace("-", "_") %>" onclick="DoScrollPos(); setTimeout(function() { <%= txtID.ClientID %>.value = '<%# Eval("Kode").ToString() %>';<%= btnShowDataFormasi.ClientID %>.click(); }, 100);" 
                                                                       style="cursor: pointer; font-weight: normal; font-size: small; color: darkblue; text-align: center;">
                                                                    <i class="fa fa-users"></i> Formasi Siswa
                                                                </label>
                                                                <span style="color: #d9d9d9;">&nbsp;|&nbsp;</span>
                                                                <label title=" Nilai " id="lbl_<%# Eval("Kode").ToString().Replace("-", "_") %>_2" 
                                                                    onclick="
                                                                            <%# 
                                                                                "window.open(" +
                                                                                    "'" +
                                                                                        this.Page.ResolveUrl(
                                                                                            AI_ERP.Application_Libs.Routing.URL.APPLIACTION_MODULES.EDUCATION.Penilaian.SMP.NILAI_SISWA.ROUTE +
                                                                                            "?" + 
                                                                                            ...
                                                                                            (
                                                                                                AI_ERP.Application_Modules.EDUCATION.Penilaian.SMP.wf_FormasiSiswaEkskul.GetKelasEkskul(Eval("Rel_Rapor_StrukturNilai").ToString()).Trim() != ""
                                                                                                ? "&k=" + AI_ERP.Application_Modules.EDUCATION.Penilaian.SMP.wf_FormasiSiswaEkskul.GetKelasEkskul(Eval("Rel_Rapor_StrukturNilai").ToString())
                                                                                                : ""
                                                                                            ) +
                                                                                            (
                                                                                                AI_ERP.Application_Modules.EDUCATION.Penilaian.SMP.wf_FormasiSiswaEkskul.GetGuruEkskul(Eval("Kode").ToString()).Trim() != ""
                                                                                                ? "&gr=" + AI_ERP.Application_Modules.EDUCATION.Penilaian.SMP.wf_FormasiSiswaEkskul.GetGuruEkskul(Eval("Kode").ToString())
                                                                                                : ""
                                                                                            )
                                                                                        ) +
                                                                                    "', " +
                                                                            ...
                                                                            "  
                                                                    style="cursor: pointer; font-weight: normal; font-size: small; color: darkblue; text-align: center;">
                                                                    <i class="fa fa-table"></i> Nilai
                                                                </label>
                                                            </td>
                                                            <td style="font-weight: bold; padding: 10px; vertical-align: middle; text-align: left;">
                                                                <span style="color: grey; font-weight: bold; text-transform: none; text-decoration: none;">
                                                                    <%# 
                                                                        AI_ERP.Application_DAOs.Elearning.SMP.DAO_Rapor_StrukturNilai.GetNamaKelasEkskul(Eval("Rel_Rapor_StrukturNilai").ToString())
                                                                    %>
                                                                </span>
                                                            </td>
                                                        </tr>
                                        ...
                                        <asp:View ID="vListGuruPembina" runat="server">

                                            <div style="padding: 0px; margin: 0px;">
                                                <table class="table" id="Table1" runat="server" style="width: 100%; margin: 0px;">
                                                    <tr style="background-color: #3367d6;">
                                                        <td style="text-align: left; font-weight: bold; color: white; background-color: #3367d6; vertical-align: middle;">
                                                            <asp:Literal runat="server" ID="ltrCaptionFormasiGuru"></asp:Literal>
									                    </td>
                                                    </tr>
                                                </table>
                                                <asp:ListView ID="lvListGuruPembina" DataSourceID="sql_ds_guru" runat="server" OnSorting="lvListGuruPembina_Sorting" OnPagePropertiesChanging="lvListGuruPembina_PagePropertiesChanging">
                                                    <LayoutTemplate>
                                                        <div class="table-responsive" style="margin: 0px; box-shadow: none;">
							                                <table class="table" id="itemPlaceholderContainer" runat="server" style="width: 100%; margin: 0px;">
								                                <thead>
								                                    <tr style="background-color: #3c70e1;">
                                                                        ...
                                                                        <th style="text-align: left; background-color: #3c70e1; width: 50px; vertical-align: middle;">
                                                                            <label onclick="SelectOrUnSelectAllGuruPembimbing();" style="cursor: pointer;">
                                                                                <i class="fa fa-clone"></i>
                                                                            </label>
                                                                        </th>
                                                                        <th style="background-color: #3c70e1; text-align: left; padding-left: 10px; vertical-align: middle;">
                                                        ...
                                                        <tr class="<%# 
                                                            ...
                                                            <td style="font-weight: bold; padding: 10px; vertical-align: middle; text-align: left; padding-top: 1px; padding-bottom: 1px;">
                                                                <span title=" NIS Sekolah " style="color: #bfbfbf; font-weight: normal; text-transform: none; text-decoration: none;">
                                                                    <%# 
                                                                        (
                                                                           AI_ERP.Application_Libs.Libs.GetHTMLSimpleText(Eval("Rel_Guru").ToString()).Trim() == ""
                                                                           ? "N/A"
                                                            ...
                                                            <td style="font-weight: bold; padding: 10px; vertical-align: middle; text-align: left;">
                                                                <span style="color: grey; font-weight: bold; text-transform: none; text-decoration: none;">
                                                                    <%# 
                                                                        AI_ERP.Application_Libs.Libs.GetPerbaikiEjaanNama(
                                                                            AI_ERP.Application_Libs.Libs.GetHTMLSimpleText(Eval("GuruPembimbing").ToString())
                                                                        )
                                                                    %>
                                                                </span>
                                                                <button onclick="<%= txtIDItem.ClientID %>.value = '<%# Eval("Kode").ToString() %>';<%= btnShowEditGuruPembimbing.ClientID %>.click(); return false;" title=" Ubah " onclick="return false;" class="btn btn-flat btn-brand-accent waves-attach waves-effect pull-right" 
                                                                    style="padding: 0px; padding-left: 5px; padding-right: 5px;">
                                                                    <span style="color: slategrey;">
                                                                        <i class="fa fa-pencil"></i>
                                                                    </span>
                                            ...
                                            <asp:SqlDataSource ID="sql_ds_guru" runat="server"></asp:SqlDataSource>
                                            ...
                                            <div class="content-header ui-content-header" 
						                        style="background-color: #00198d;
								                        ...
								                        padding: 8px; margin: 0px; height: 35px;">
						                        <div style="padding-left: 0px;">
							                        <asp:LinkButton ToolTip=" Kembali " runat="server" ID="btnShowDataListFromGuruPembina" CssClass="btn-trans waves-attach waves-circle waves-effect" OnClick="btnShowDataList_Click" style="font-weight: bold; color: ghostwhite;">
                                                        &nbsp;&nbsp;
                                                        <i class="fa fa-arrow-left"></i>
                                                        &nbsp;&nbsp;
                                                    </asp:LinkButton>
                                            ...
                                            <div class="content-header ui-content-header" 
						                        style="background-color: #8A0083;
								                        ...
								                        padding: 8px; margin: 0px; height: 35px;">
						                        <div style="padding-left: 0px;">
							                        <asp:LinkButton OnClientClick="ShowConfirmHapusGuruPembimbing(); return false;" ToolTip=" Hapus " runat="server" ID="LnkHapusGuruPembina" CssClass="btn-trans waves-attach waves-circle waves-effect" style="color: ghostwhite;">
                                                        <span style="color: ghostwhite;">
                                                            &nbsp;&nbsp;
                                                            <i class="fa fa-times"></i>
                                                            &nbsp;
                                            ...
                                            <div class="fbtn-container" id="div1" runat="server">
		                                        <div class="fbtn-inner">
			                                        <a onclick="setTimeout(
                                                            function(){
                                                                <%= btnShowInputGuruPembimbing.ClientID %>.click();
                                                            }, 500
                                                        ); return false;" class="fbtn fbtn-lg fbtn-brand-accent waves-attach waves-circle waves-light" data-toggle="dropdown" style="background-color: #a91212;" title=" Tambah Data ">
                                                        <span class="fbtn-ori icon" style="padding-left: 2px;"><span class="fa fa-plus"></span></span>
                                                        <span class="fbtn-sub icon" style="padding-left: 2px;"><span class="fa fa-plus"></span></span>
                                            ...
                                            <div class="row" style="margin-left: 30px; margin-right: 30px;">
                                                <div class="col-xs-12" style="padding-left:  0px; padding-right: 0px;">
                                                    <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                        <label class="label-input" for="<%= txtSiswa.NamaClientID %>" style="text-transform: none;">Nama Siswa</label>
                                                        <asp:RequiredFieldValidator ValidationGroup="vldInputFormasi" runat="server" ID="vldSiswa"
                                                            ControlToValidate="txtSiswa$txtNama" Display="Dynamic" style="float: right; font-weight: bold;"
            ...
            <div aria-hidden="true" class="modal fade" id="ui_modal_input_guru_pembimbing" role="dialog" tabindex="-1" style="display: none; padding-right: 9px; z-index: 2000;">
		        <div class="modal-dialog modal-xs">
			        <div class="modal-content" style="border: none; border-top-left-radius: 6px; border-top-right-radius: 6px;">
				        <div class="modal-inner" 
                            style="margin-left: 0px; margin-right: 0px; margin-bottom: 0px; margin-top: 0px; 
                            ...
                            <div class="media margin-bottom-no margin-top-no" style="padding-left: 20px; padding-right: 20px; color: black; padding-bottom: 20px;">
							    ...
							    <div class="media-inner">
								    <span style="font-weight: bold;">
                                        Isi Data Formasi Guru/Pembimbing
								    </span>
							    </div>
						    </div>
                            <div style="width: 100%;">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div style="width: 100%; background-color: white; padding-top: 15px;">
                                            <div class="row" style="margin-left: 30px; margin-right: 30px;">
                                                <div class="col-xs-12" style="padding-left:  0px; padding-right: 0px;">
                                                    <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                        <label class="label-input" for="<%= txtGuruPembimbing.NamaClientID %>" style="text-transform: none;">Nama Guru</label>
                                                        <asp:RequiredFieldValidator ValidationGroup="vldInputFormasiGuru" runat="server" ID="vldNamaGuruPembimbing"
                                                            ControlToValidate="txtGuruPembimbing$txtNama" Display="Dynamic" style="float: right; font-weight: bold;"
                                                            Text="<i class='fa fa-exclamation-triangle'></i>" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                                        <ucl:AutocompletePegawai runat="server" ID="txtGuruPembimbing" />
                                                    </div>
                                                </div>
                                            </div>
										</div>  
				        ...
				        <div class="modal-footer">
					        <p class="text-right">
                                <asp:LinkButton ValidationGroup="vldInputFormasiGuru" CssClass="btn btn-flat btn-brand-accent waves-attach waves-effect" runat="server" ID="lnkOKFormasiGuruPembimbing" OnClick="lnkOKFormasiGuruPembimbing_Click" Text="   OK   "></asp:LinkButton>
                                &nbsp;&nbsp;
                                <a class="btn btn-flat btn-brand-accent waves-attach waves-effect" data-dismiss="modal">Batal</a>                                    
                                <br /><br />
					        </p>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div style="width: 100%; background-color: white; padding-top: 15px;">
                                            <div class="row" style="margin-left: 30px; margin-right: 30px; display: none;">
                                                <div class="col-xs-12" style="padding-left:  0px; padding-right: 0px;">
                                                    <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                        ...
                                                        <asp:RequiredFieldValidator ValidationGroup="vldInput" runat="server" ID="vldTahunPelajaran" Enabled="false"
                                            ...
                                            <div class="row" style="margin-left: 30px; margin-right: 30px; display: none;">
                                                <div class="col-xs-12" style="padding-left:  0px; padding-right: 0px;">
                                                    <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                        ...
                                                        <asp:RequiredFieldValidator ValidationGroup="vldInput" runat="server" ID="vldSemester" Enabled="false"
                                            ...
                                            <div class="row" style="margin-left: 30px; margin-right: 30px;">
                                                <div class="col-xs-12" style="padding-left:  0px; padding-right: 0px;">
                                                    <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                        <label class="label-input" for="<%= cboMapelStrukturNilai.ClientID %>" style="text-transform: none;">Mata Pelajaran dalam Struktur Nilai</label>
                                                        <asp:RequiredFieldValidator ValidationGroup="vldInput" runat="server" ID="vldMapelStrukturNilai"
                                                            ControlToValidate="cboMapelStrukturNilai" Display="Dynamic" style="float: right; font-weight: bold;"
                                                            Text="<i class='fa fa-exclamation-triangle'></i>" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                                        <asp:DropDownList runat="server" ID="cboMapelStrukturNilai" CssClass="form-control"></asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row" style="margin-left: 30px; margin-right: 30px; display: none;">
                                                <div class="col-xs-12" style="padding-left:  0px; padding-right: 0px;">
                                                    <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                        ...
                                                        <asp:RequiredFieldValidator ValidationGroup="vldInput" runat="server" ID="vldMapel" Enabled="false"
                                            ...
                                            <div class="row" style="margin-left: 30px; margin-right: 30px; display: none;">
                                                <div class="col-xs-12" style="padding-left:  0px; padding-right: 0px;">
                                                    <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                        ...
                                                        <asp:RequiredFieldValidator ValidationGroup="vldInput" runat="server" ID="vldGuru" Enabled="false"
            ...
            <div aria-hidden="true" class="modal fade" id="ui_modal_hapus_item_guru_pembimbing" role="dialog" tabindex="-1" style="display: none; padding-right: 9px; z-index: 2000;">
		        <div class="modal-dialog modal-xs">
			        <div class="modal-content" style="border: none; border-top-left-radius: 6px; border-top-right-radius: 6px;">
				        <div class="modal-inner" 
                            style="margin-left: 0px; margin-right: 0px; margin-bottom: 0px; margin-top: 0px; 
				        ...
				        <div class="modal-footer">
					        <p class="text-right">
                                <asp:LinkButton CssClass="btn btn-flat btn-brand-accent waves-attach waves-effect" runat="server" ID="lnkOKHapusItemGuruPembimbing" OnClick="lnkOKHapusItemGuruPembimbing_Click" Text="  OK  "></asp:LinkButton>
                                <a class="btn btn-flat btn-brand-accent waves-attach waves-effect" data-dismiss="modal">Batal</a>      
                                <br /><br />                              
					        </p>
				        </div>
