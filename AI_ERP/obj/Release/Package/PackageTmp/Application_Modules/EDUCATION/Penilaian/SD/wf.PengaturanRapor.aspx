<%@ Page Title="" Language="C#" MasterPageFile="~/Application_Masters/Main.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="wf.PengaturanRapor.aspx.cs" Inherits="AI_ERP.Application_Modules.EDUCATION.Penilaian.SD.wf_PengaturanRapor" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function InitPicker() {
            ...
            $('#<%= txtTanggalBukaLinkLTS.ClientID %>').pickdate({ cancel: '', closeOnCancel: false, closeOnSelect: true, container: '', firstDay: 1, format: 'dd mmmm yyyy', formatSubmit: 'dd mmmm yyyy', ok: 'Tutup', selectMonths: true, selectYears: 40, today: '' });
        }
    </script>
</asp:Content>
					            ...
					            <div class="card-inner" style="margin: 0px; padding: 0px; margin-right: -0.5px; ">
						            ...
						            <asp:MultiView runat="server" ID="mvMain" ActiveViewIndex="0">
                                        ...
                                        <asp:View runat="server" ID="vList">
                                            ...
                                            <div class="fbtn-container" id="div_button_list" runat="server">
                                                ...
                                                <div class="row" style="margin-left: 0px; margin-right: 0px;">
                                                    <div class="col-xs-8">
                                                        <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                            <label class="label-input" for="<%= txtTanggalBukaLinkLTS.ClientID %>" style="text-transform: none;">Tanggal Buka Link LTS</label>
                                                            <asp:TextBox CssClass="form-control" runat="server" ID="txtTanggalBukaLinkLTS"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-4">
                                                        <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                            <label class="label-input" for="<%= cboJamBukaLinkLTS.ClientID %>" style="text-transform: none;">Jam Buka Link LTS</label>
                                                            <asp:DropDownList CssClass="form-control" runat="server" ID="cboJamBukaLinkLTS"></asp:DropDownList>
                                                        </div>
                                                    </div>
                                                </div>  
														...
														<div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
															...
															<div class="row" style="padding: 0px; margin: 0px; background-color: #f1f3c1; border-style: solid; border-width: 1px; border-color: #E2E2E2;">
																<div class="col-xs-12" style="padding: 10px;">
																	...
																	<span style="font-weight: bold;">@link_teks"</span> - Link Lihat Nilai LTS,
                                        ...
                                        <div style="padding: 0px; margin: 0px;">
                                            ...
                                            <div style="width: 100%; background-color: white; padding-top: 15px;">
                                                ...
                                                <div class="row" style="margin-left: 15px; margin-right: 15px;">
                                                    <div class="col-xs-6">
                                                        <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                            <label class="label-input" for="<%= cboKurikulumRaporLevel1.ClientID %>" style="text-transform: none;">Kurikulum Rapor Kelas I</label>
                                                            <asp:RequiredFieldValidator ValidationGroup="vldInput" runat="server" ID="vldKurikulumRaporLevel1"
                                                                ControlToValidate="cboKurikulumRaporLevel1" Display="Dynamic" style="float: right; font-weight: bold;"
                                                                Text="<i class='fa fa-exclamation-triangle'></i>" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                                            <asp:DropDownList ValidationGroup="vldInput" CssClass="form-control" runat="server" ID="cboKurikulumRaporLevel1"></asp:DropDownList>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6">
                                                        <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                            <label class="label-input" for="<%= cboKurikulumRaporLevel4.ClientID %>" style="text-transform: none;">Kurikulum Rapor Kelas IV</label>
                                                            <asp:RequiredFieldValidator ValidationGroup="vldInput" runat="server" ID="vldKurikulumRaporLevel4"
                                                                ControlToValidate="cboKurikulumRaporLevel4" Display="Dynamic" style="float: right; font-weight: bold;"
                                                                Text="<i class='fa fa-exclamation-triangle'></i>" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                                            <asp:DropDownList ValidationGroup="vldInput" CssClass="form-control" runat="server" ID="cboKurikulumRaporLevel4"></asp:DropDownList>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row" style="margin-left: 15px; margin-right: 15px;">
                                                    <div class="col-xs-6">
                                                        <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                            <label class="label-input" for="<%= cboKurikulumRaporLevel2.ClientID %>" style="text-transform: none;">Kurikulum Rapor Kelas II</label>
                                                            <asp:RequiredFieldValidator ValidationGroup="vldInput" runat="server" ID="vldKurikulumRaporLevel2"
                                                                ControlToValidate="cboKurikulumRaporLevel2" Display="Dynamic" style="float: right; font-weight: bold;"
                                                                Text="<i class='fa fa-exclamation-triangle'></i>" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                                            <asp:DropDownList ValidationGroup="vldInput" CssClass="form-control" runat="server" ID="cboKurikulumRaporLevel2"></asp:DropDownList>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6">
                                                        <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                            <label class="label-input" for="<%= cboKurikulumRaporLevel5.ClientID %>" style="text-transform: none;">Kurikulum Rapor Kelas V</label>
                                                            <asp:RequiredFieldValidator ValidationGroup="vldInput" runat="server" ID="vldKurikulumRaporLevel5"
                                                                ControlToValidate="cboKurikulumRaporLevel5" Display="Dynamic" style="float: right; font-weight: bold;"
                                                                Text="<i class='fa fa-exclamation-triangle'></i>" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                                            <asp:DropDownList ValidationGroup="vldInput" CssClass="form-control" runat="server" ID="cboKurikulumRaporLevel5"></asp:DropDownList>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row" style="margin-left: 15px; margin-right: 15px;">
                                                    <div class="col-xs-6">
                                                        <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                            <label class="label-input" for="<%= cboKurikulumRaporLevel3.ClientID %>" style="text-transform: none;">Kurikulum Rapor Kelas III</label>
                                                            <asp:RequiredFieldValidator ValidationGroup="vldInput" runat="server" ID="vldKurikulumRaporLevel3"
                                                                ControlToValidate="cboKurikulumRaporLevel3" Display="Dynamic" style="float: right; font-weight: bold;"
                                                                Text="<i class='fa fa-exclamation-triangle'></i>" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                                            <asp:DropDownList ValidationGroup="vldInput" CssClass="form-control" runat="server" ID="cboKurikulumRaporLevel3"></asp:DropDownList>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6">
                                                        <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                            <label class="label-input" for="<%= cboKurikulumRaporLevel6.ClientID %>" style="text-transform: none;">Kurikulum Rapor Kelas VI</label>
                                                            <asp:RequiredFieldValidator ValidationGroup="vldInput" runat="server" ID="vldKurikulumRaporLevel6"
                                                                ControlToValidate="cboKurikulumRaporLevel6" Display="Dynamic" style="float: right; font-weight: bold;"
                                                                Text="<i class='fa fa-exclamation-triangle'></i>" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                                            <asp:DropDownList ValidationGroup="vldInput" CssClass="form-control" runat="server" ID="cboKurikulumRaporLevel6"></asp:DropDownList>
                                                        </div>
                                                    </div>
                                                </div>
