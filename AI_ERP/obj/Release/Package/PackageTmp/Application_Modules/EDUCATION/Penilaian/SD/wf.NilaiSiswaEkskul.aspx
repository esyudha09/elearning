<%@ Page Title="" Language="C#" MasterPageFile="~/Application_Masters/Main.Master" AutoEventWireup="true" CodeBehind="wf.NilaiSiswaEkskul.aspx.cs" Inherits="AI_ERP.Application_Modules.EDUCATION.Penilaian.SD.wf_NilaiSiswaEkskul" %>
            ...
            <div class="fbtn-container" id="div_button_settings" runat="server" style="z-index: 999999;">
                <div class="fbtn-inner">
                    ...
                    <div class="fbtn-dropup" style="z-index: 999999;">
                        ...
                        <asp:LinkButton Visible="false" CssClass="fbtn fbtn-green waves-attach waves-circle waves-effect" runat="server" ID="lnkPilihKelas" OnClick="lnkPilihKelas_Click1" Style="background-color: #424242;">
                                            ...
                                            <div class="card-main">
                                                <nav class="tab-nav margin-top-no margin-bottom-no">
                                                    <ul class="nav nav-justified" style="background-color: #f1f1f1; <asp:Literal runat="server" ID="ltrHeaderTab"></asp:Literal>border-top-style: solid; border-top-width: 0px; border-top-color: #bfbfbf;">
                                                        <li runat="server" id="li_nilai_akademik">
                                                ...
                                                <div class="card-inner" style="margin-left: 0px; margin-right: 0px; margin-top: 0px;">
                                                    <div class="tab-content">
                                                        <div class="tab-pane fade" id="ui_tab_akademik">
                                                            <asp:Literal runat="server" ID="ltrListNilaiAkademik"></asp:Literal>
                                                        </div>
                                                        <div class="tab-pane fade active in" id="ui_tab_ekskul">
