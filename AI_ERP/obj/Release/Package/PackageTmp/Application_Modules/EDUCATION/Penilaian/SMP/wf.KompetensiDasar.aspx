<%@ Page Title="" Language="C#" MasterPageFile="~/Application_Masters/Main.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="wf.KompetensiDasar.aspx.cs" Inherits="AI_ERP.Application_Modules.EDUCATION.Penilaian.SMP.wf_KompetensiDasar" %>
                                            ...
                                            <div class="row" style="margin-left: 15px; margin-right: 15px;">
                                                <div class="col-xs-12">
                                                    <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                        ...
                                                        <asp:TextBox CssClass="form-control" runat="server" ID="txtAlias"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row" style="margin-left: 15px; margin-right: 15px;">
            ...
            tinymce.init({
                ...
                setup: function (ed) {
                    ...
                    ed.on('keydown',function(e) {
                        if (e.keyCode == 13) {
                            document.getElementById('<%= txtAlias.ClientID %>').focus();
                            e.preventDefault();
                        }
                    });
