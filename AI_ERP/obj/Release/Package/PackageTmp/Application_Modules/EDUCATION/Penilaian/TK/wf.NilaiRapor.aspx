<%@ Page Title="" Language="C#" MasterPageFile="~/Application_Masters/Main.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="wf.NilaiRapor.aspx.cs" Inherits="AI_ERP.Application_Modules.EDUCATION.Penilaian.TK.wf_NilaiRapor" %>
    ...
    <script type="text/javascript">
        ...
        function SavePertumbuhanFisik(){
               ...
               )
            {
                ...
                var s_url = '<%= ResolveUrl(AI_ERP.Application_Libs.Routing.URL.APIS.TK.NILAI_SISWA.DO_SAVE.FILE + "/DoPF") %>' +
                            '?' +
                            't=' + tahun_ajaran + '&' +
                            'sm=' + semester + '&' +
                            's=' + siswa + '&' +
        ...
        function ProcessPengaturan() {
            ...
            if(s_kriteria.trim() !== ""){
                ...
                url += "&kd=" + "<%= AI_ERP.Application_Modules.EDUCATION.Penilaian.TK.wf_NilaiRapor.QS.GetKelas() %>";
        ...
        function ShowPengaturan(show) {
            ...
            var div_info_periode = document.getElementById("<%= div_periode_title.ClientID %>");
        ...
        function SetKenaikanKelas() {
            ...
            var arr_keterangan = document.getElementsByName("txt_keterangan_kenaikan_kelas[]");
                                                    ...
                                                    <ItemTemplate>
                                                        <tr class="<%# (Container.DisplayIndex % 2 == 0 ? "standardrow" : "oddrow") %>">
                                                            ...
                                                            <td style="font-weight: bold; padding: 10px; vertical-align: middle; text-align: left;">
                                                                ...
                                                                <%# 
                                                                    AI_ERP.Application_Modules.EDUCATION.Penilaian.TK.wf_NilaiRapor.IsPosted(
                                                                        Eval("TahunAjaran").ToString(),
                                                                        Eval("Semester").ToString(),
                                                                        AI_ERP.Application_Modules.EDUCATION.Penilaian.TK.wf_NilaiRapor.QS.GetKelas()
                                                                    ...
                                                                    <%# 
                                                                        (
                                                                            ...
                                                                            ? Eval("NamaKelasDet").ToString() +
                                                                              ...
                                                                              "</span>"
                                                                            : AI_ERP.Application_Modules.EDUCATION.Penilaian.TK.wf_NilaiRapor.GetNamaKelas()
                                                                        )
                                                                    %>
                                                                </span>
                                                                &nbsp;
                                                                ...
                                                                <%# 
                                                                    (
                                                                        !AI_ERP.Application_Modules.EDUCATION.Penilaian.TK.wf_NilaiRapor.IsUdahDiaturNilaiDefault(
                                                                            Eval("Kode").ToString(),
                                                                            (
                                                                                AI_ERP.Application_Libs.Libs.URL_IDENTIFIER.IsAdaIDUrlIdAdminUnit()
                                                                        ...
                                                                        ? (
                                                                          ...
                                                                          "</label>" +
                                                                          (
                                                                            Eval("Semester").ToString() == "2" && Eval("TipeRapor").ToString() != AI_ERP.Application_Libs.TipeRapor.LTS
                                                                            ? "<span style=\"color: #dddddd;\">&nbsp;&nbsp;|&nbsp;&nbsp;</span>" +
                                                                              "<label title=\" Kenaikan Kelas \" style=\"font-weight: normal; font-size: small; color: #bfbfbf; margin-top: 10px;\">" +
                                                                                "&nbsp;" +
                                                                          ...
                                                                          "</label>" +
                                                                          "<span style=\"color: #dddddd;\">&nbsp;&nbsp;|&nbsp;&nbsp;</span>" +
                                                                          "<label title=\" Matriks \" style=\"font-weight: normal; font-size: small; color: #bfbfbf; margin-top: 10px;\">" +
                                                                            "&nbsp;" +
                                                                        ...
                                                                        : (
                                                                          ...
                                                                          "<label title=\" Buka \" onclick=\"ShowProgress(true); " + (AI_ERP.Application_Libs.Libs.URL_IDENTIFIER.IsAdaIDUrlIdAdminUnit()  ? txtKelasDet.ClientID + ".value = '" + Eval("KodeKelasDet").ToString() + "'; " : "") + txtTipeRapor.ClientID + ".value='" + Eval("TipeRapor").ToString() + "'; " + txtID.ClientID + ".value = '" + Eval("Kode").ToString() + "';" + btnShowDesain.ClientID + ".click();\" style=\"cursor: pointer; font-weight: normal; font-size: small; color: green; margin-top: 10px;\">" +
                                                                            "&nbsp;" +
                                                                            "<i class=\"fa fa-folder-open\"></i>" +
                                                                            "&nbsp;" +
                                                                            "Buka" +
                                                                            "&nbsp;" +
                                                                            AI_ERP.Application_Modules.EDUCATION.Penilaian.TK.wf_NilaiRapor.GetHTMLNotifJumlahSiswa(
                                                                                (
                                                                                    AI_ERP.Application_Libs.Libs.URL_IDENTIFIER.IsAdaIDUrlIdAdminUnit()
                                                                                    ? Eval("KodeKelasDet").ToString()
                                                                                    : AI_ERP.Application_Modules.EDUCATION.Penilaian.TK.wf_NilaiRapor.QS.GetKelas()
                                                                                ...
                                                                                Eval("Kode").ToString(),
                                                                                Eval("TipeRapor").ToString()
                                                                            ) +
                                                                          "</label>" +
                                                                          (
                                                                            AI_ERP.Application_Modules.EDUCATION.Penilaian.TK.wf_NilaiRapor.GetJumlahNoReadOnly(
                                                                                (
                                                                                    AI_ERP.Application_Libs.Libs.URL_IDENTIFIER.IsAdaIDUrlIdAdminUnit()
                                                                                    ? Eval("KodeKelasDet").ToString()
                                                                                    : AI_ERP.Application_Modules.EDUCATION.Penilaian.TK.wf_NilaiRapor.QS.GetKelas()
                                                                            ...
                                                                            ? (
                                                                                Eval("Semester").ToString() == "2" && Eval("TipeRapor").ToString() != AI_ERP.Application_Libs.TipeRapor.LTS
                                                                                ? "<span style=\"color: #dddddd;\">&nbsp;&nbsp;|&nbsp;&nbsp;</span>" +
                                                                                  "<label title=\" Kenaikan Kelas \" onclick=\"ShowProgress(true); " + (AI_ERP.Application_Libs.Libs.URL_IDENTIFIER.IsAdaIDUrlIdAdminUnit()  ? txtKelasDet.ClientID + ".value = '" + Eval("KodeKelasDet").ToString() + "'; " : "") + txtID.ClientID + ".value = '" + Eval("Kode").ToString() + "';" + btnShowListKenaikanKelas.ClientID + ".click();\"  style=\"cursor: pointer; font-weight: normal; font-size: small; color: green; margin-top: 10px;\">" +
                                                                                    "&nbsp;" +
                                                                                    "<i class=\"fa fa-check-square\"></i>" +
                                                                                    "&nbsp;" +
                                                                                    "Kenaikan Kelas" +
                                                                              ...
                                                                              (
                                                                                AI_ERP.Application_Libs.Libs.URL_IDENTIFIER.IsAdaIDUrlIdAdminUnit()
                                                                                ? "<span style=\"color: #dddddd;\">&nbsp;&nbsp;|&nbsp;&nbsp;</span>" +
                                                                                  "<label title=\" Download Matriks \" onclick=\"window.open('" + ResolveUrl("~/Application_Resources/DownloadAsFile.aspx?jd=" + AI_ERP.Application_Libs.Downloads.JenisDownload.MATRIX_RAPOR_TK + "&ds=' + '" + Eval("Kode").ToString() + "' + '&t=' + '" + Eval("TahunAjaran").ToString().Replace("/","-") + "' + " + "'&s=' + '" + Eval("Semester").ToString() + "' + "  + "'&u=' + '" + AI_ERP.Application_Modules.EDUCATION.Penilaian.TK.wf_NilaiRapor.GetUnit() + "' + '&kd=' + '" + Eval("KodeKelasDet").ToString()) + "', '_blank');\" style=\"cursor: pointer; font-weight: normal; font-size: small; color: green; margin-top: 10px;\"> " +
                                                                                    "&nbsp;" +
                                                                                    "<i class=\"fa fa-table\"></i>" +
                                                                                    "&nbsp;" +
                                                                                    "Matriks" +
                                                    ...
                                                    <div class="col-lg-12" style="padding: 0px;">
                                                        ...
                                                        <div class="table-responsive" style="margin-top: 0px; margin-bottom: 0px; box-shadow: 0 -1px 0 rgba(0, 0, 0, 0), 0 0 3px rgba(0, 0, 0, 0.18), 0 1px 3px rgba(0, 0, 0, 0.0);">
                                                                        ...
                                                                        <td 
                                                                            <%# 
                                                                                ...
                                                                                (
                                                                                    ...
                                                                                    ? "colspan=\"" +  
                                                                                      AI_ERP.Application_Modules.EDUCATION.Penilaian.TK.wf_NilaiRapor.GetColspanKriteriaPenilaian(
                                                                                            txtID.Value, 1
                                                                                      ) +  
                                                                                      "\" "
                                                                                    : ""
                                                                                                    ...
                                                                                                    (
                                                                                                        ...
                                                                                                        ?
                                                                                                            (
                                                                                                                ...
                                                                                                                AI_ERP.Application_Modules.EDUCATION.Penilaian.TK.wf_NilaiRapor.IsReadonly(
                                                                                                                    ...
                                                                                                                    txtTipeRapor.Value
                                                                                                                        ...
                                                                                                                        AI_ERP.Application_Modules.EDUCATION.Penilaian.TK.wf_NilaiRapor.GetHTMLDeskripsiPenilaian(
                                                                                                                                txtTahunAjaran.Value,
                                                                                                                                txtSemester.Value,
                                                                                                                                txtKelasDet.Value,
                                                                                                                                txtIDSiswa.Value,
                                                                                ...
                                                                                <div "<%#                                                                                 
                                                                                    ...
                                                                                    <table style="width: 100%; margin: 0px;
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <%# 
                                                                                                AI_ERP.Application_Modules.EDUCATION.Penilaian.TK.wf_NilaiRapor.GetHTMLRdoKriteriaPenilaian(
                                                                                                        txtTahunAjaran.Value,
                                                                                                        txtSemester.Value,
                                                                                                        txtKelasDet.Value,
                                                                                                        txtIDSiswa.Value,
                                                            ...
                                                            <div class="content-header ui-content-header" 
                                                                ...
                                                                <div style="padding-left: 15px;">
				                                                    <asp:DataPager ID="dpDesain" runat="server" PageSize="30" PagedControlID="lvDesain">
                                                                        <Fields>
                                                                            <asp:NextPreviousPagerField ButtonType="Link" ButtonCssClass="btn-trans" ShowFirstPageButton="True" FirstPageText='&nbsp;<i class="fa fa-backward"></i>&nbsp;' ShowPreviousPageButton="True" PreviousPageText='&nbsp;<i class="fa fa-arrow-left"></i>&nbsp;' ShowNextPageButton="false" />
                                                                            <asp:TemplatePagerField>
                                                                                <PagerTemplate>
