<%@ Page Title="" Language="C#" MasterPageFile="~/Application_Masters/Main.Master" AutoEventWireup="true" CodeBehind="wf.DesainRaporLTS.aspx.cs" Inherits="AI_ERP.Application_Modules.EDUCATION.Penilaian.SD.wf_DesainRaporLTS" %>
        ...
        function EndRequest() {
            ...
            switch (jenis_act) {
                ...
                case "<%= JenisAction.DoShowConfirmHapus %>":
                    ...
                    break;
                case "<%= JenisAction.DoShowInputDesainLTS %>":
                    HideModal();
