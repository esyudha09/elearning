<%@ Page Title="" Language="C#" MasterPageFile="~/Application_Masters/Main.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="wf.Guru.DataSiswaCatatanEdit.aspx.cs" Inherits="AI_ERP.Application_Modules.EDUCATION.Elearning.wf_Guru_DataSiswaCatatanEdit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function EndRequest() {
            ...
            switch (jenis_act) {
                case "<%= JenisAction.Add %>":
                    ...
                    break;
                case "<%= JenisAction.Search %>":
                    ReInitTinyMCE();   
                    $('#ui_modal_cari_data').modal({ backdrop: 'static', keyboard: false, show: true });
                    break;
        ...
        function InitModalFocus(){
            ...
            $('#ui_modal_cari_data').on('shown.bs.modal', function () {
                <%= txtCari.ClientID %>.focus();
            });
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel runat="server" ID="upMain">
        <ContentTemplate>
                                        ...
                                        <asp:View runat="server" ID="vList">
                                                        ...
                                                        <tr class="<%# (Container.DisplayIndex % 2 == 0 ? "standardrow" : "oddrow") %>">
										                                ...
										                                <li class="dropdown">
											                                ...
											                                <ul class="dropdown-menu-list-table">
												                                <li style="background-color: white; padding: 10px;">
													                                <label 
                                                                                        onclick="<%= txtID.ClientID %>.value = '<%# Eval("Kode").ToString() %>'; <%= txtIDGuru.ClientID %>.value = '<%# Eval("Rel_Guru").ToString() %>'; <%= btnShowDetail.ClientID %>.click(); " 
												                                ...
												                                <li style="background-color: white; padding: 10px;">
													                                <label
                                                                                        onclick="<%= txtID.ClientID %>.value = '<%# Eval("Kode").ToString() %>'; <%= txtIDGuru.ClientID %>.value = '<%# Eval("Rel_Guru").ToString() %>'; <%= btnShowConfirmDelete.ClientID %>.click(); " 
                                                            ...
                                                            <td style="font-weight: bold; padding: 10px; vertical-align: middle; text-align: left;">
                                                                <span style="font-weight: bold;">
                                                                    <%# 
                                                                        Eval("Siswa").ToString().Trim().ToUpper()
                                                                    %>
                                                                </span>
                                                                <br />
                                                                <span style="color: grey; font-weight: normal; text-transform: none; text-decoration: none;">
                                                                    <%# 
                                                                        ...
                                                                        "<span>" +
                                                                        "<div style=\"margin-top: 5px; padding-left: 10px; padding-right: 10px; background-color: #F1F9F7; font-weight: normal; width: 100%; border-style: solid; border-color: #c0dfd7; border-width: 1px; border-radius: 5px;\">" +
                                                                            Eval("Catatan").ToString() +
                                                                        "<div>"
                                                                    %>
                                                                </span>
                                                            </td>
                                            ...
                                            <div class="content-header ui-content-header" 
                                                style="background-color: white;
                                                       ...
                                                       padding: 8px; margin: 0px; display: none;">
                	
                                                <div style="padding-left: 15px;">
				                                    <asp:DropDownList 
                                                        ToolTip=" Kelas " 
                                                        runat="server" 
                                                        ID="cboKelasTahunAjaranSemester" 
                                                        AutoPostBack="true" 
                                                        OnSelectedIndexChanged="cboKelasTahunAjaranSemester_SelectedIndexChanged"
                                                        style="font-weight: bold; color: black; outline: none; padding: 5px; border-style: solid; border-width: 1px; border-color: #c0dfd7; background-color: #F1F9F7; width: 230px; border-radius: 4px;"></asp:DropDownList>
                                                </div>
		                                    </div>    
                                            ...
                                            <div class="fbtn-container" id="div_button_settings" runat="server">
		                                        <div class="fbtn-inner">
                                                    ...
                                                    <div class="fbtn-dropup" style="z-index: 999999;">
                                                        <asp:HyperLink runat="server" ToolTip=" Data Siswa " ID="lnkDataSiswa" CssClass="fbtn fbtn-green waves-attach waves-circle waves-effect" Style="background-color: #005b72;">
                                                            <span class="fbtn-text fbtn-text-left">Data Siswa</span>
                                                            <i class="fa fa-id-card-o" style="color: white;"></i>
                                                        </asp:HyperLink>
                                                        <asp:LinkButton OnClick="btnCari_Click" CssClass="fbtn fbtn-brand-accent waves-attach waves-circle waves-light" runat="server" id="btnCari" title=" Cari Data " style="background-color: #114D79; color: white;">
                                                            <span class="fbtn-text fbtn-text-left">Cari Data</span>
                                                            <i class="fa fa-search"></i>
                                                        </asp:LinkButton>
				                                        <asp:LinkButton OnClick="btnRefresh_Click" CssClass="fbtn fbtn-brand-accent waves-attach waves-circle waves-light" runat="server" id="btnRefresh" title=" Refresh Data " style="background-color: #601B70; color: white;">
            ...
            <div aria-hidden="true" class="modal fade" id="ui_modal_cari_data" role="dialog" tabindex="-1" style="display: none; padding-right: 9px; z-index: 2000;">
		        <div class="modal-dialog modal-xs">
			        <div class="modal-content" style="border: none; border-top-left-radius: 6px; border-top-right-radius: 6px;">
				        <div class="modal-inner" 
                            style="margin-left: 0px; margin-right: 0px; margin-bottom: 0px; margin-top: 0px; 
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div style="width: 100%; background-color: white; padding-top: 15px;">
                                            <div class="row" style="margin-left: 15px; margin-right: 15px;">
                                                <div class="col-xs-12">
                                                    <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                        <label class="label-input" for="<%= txtCari.ClientID %>" style="text-transform: none;">Cari Data</label>
                                                        <asp:RequiredFieldValidator ValidationGroup="vldInput" runat="server" ID="vldCariData"
                                                            ControlToValidate="txtCari" Display="Dynamic" Style="float: right; font-weight: bold;"
                                                            Text="<i class='fa fa-exclamation-triangle'></i>" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                                        <asp:TextBox ValidationGroup="vldCariData" runat="server" ID="txtCari" CssClass="form-control"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
										</div>  
				        ...
				        <div class="modal-footer">
					        <p class="text-right">
                                <asp:LinkButton ValidationGroup="vldCariData" CssClass="btn btn-flat btn-brand-accent waves-attach waves-effect" runat="server" ID="lnkOKCari" OnClick="lnkOKCari_Click" Text="  OK  "></asp:LinkButton>
                                <a class="btn btn-flat btn-brand-accent waves-attach waves-effect" data-dismiss="modal">Batal</a>      
                                <br /><br />                              
					        </p>
				        </div>
