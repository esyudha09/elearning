<%@ Page Title="" Language="C#" MasterPageFile="~/Application_Masters/Main.Master" AutoEventWireup="true" CodeBehind="wf.Ortu.UangSekolah.aspx.cs" Inherits="AI_ERP.Application_Modules.EDUCATION.Elearning.wf_Ortu_UangSekolah" %>
                            ...
                            <table style="width: 100%;">
                                <tr>
                                    <td style="background-color: white; padding: 10px; font-weight: normal; vertical-align: middle; color: grey; padding-left: 20px; font-size: large;">
                                        <img src="<%= ResolveUrl("~/Application_CLibs/images/svg/022-money.svg") %>" 
                            ...
                            <div class="col-md-12" style="padding-top: 15px; color: black;">
                                ...
                                <div style="padding: 10px; padding-left: 20px; background-color: #D4E5C3; border-left-style: solid;  border-left-width: 3px; border-left-color: green;">
                                    ...
                                    <span style="font-size: xx-large; font-weight: bold;">
                                        Rp.
                                        &nbsp;
                                        <asp:Label runat="server" ID="lblJumlahTagihan"></asp:Label>
                                    </span>
                                </div>
                                <br />

                                <asp:Literal runat="server" ID="ltrListBiayaSekolah"></asp:Literal>
