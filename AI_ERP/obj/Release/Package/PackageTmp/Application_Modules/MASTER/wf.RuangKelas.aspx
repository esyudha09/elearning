<%@ Page Title="" Language="C#" MasterPageFile="~/Application_Masters/Main.Master" AutoEventWireup="true" CodeBehind="wf.RuangKelas.aspx.cs" Inherits="AI_ERP.Application_Modules.MASTER.wf_RuangKelas" %>
                                    ...
                                    <table style="width: 100%;">
                                        <tr>
                                            <td style="background-color: #295BC8; padding: 10px; font-weight: normal; vertical-align: middle; color: white; padding-left: 20px; font-size: 15px;">
                                                <img src="<%= ResolveUrl("~/Application_CLibs/images/svg/university-1.svg") %>" 
								                                ...
								                                <thead>
								                                    <tr style="background-color: #3367d6;">
                                                                        ...
                                                                        <th style="background-color: #3367d6; text-align: left; padding-left: 10px; vertical-align: middle;">
                                                                            <asp:LinkButton ID="H_Unit" runat="server" CommandName="Sort" CommandArgument="Unit" style="color: white; font-weight: bold;">
                                                                                Unit Sekolah
                                                                            </asp:LinkButton>
                                                                            <asp:Literal runat="server" ID="imgh_unit" Visible="false"></asp:Literal>
									                                    </th>
                                                                        <th style="background-color: #3367d6; text-align: left; padding-left: 10px; vertical-align: middle;">
                                            ...
                                            <div class="row" style="margin-left: 30px; margin-right: 30px;">
                                                <div class="col-xs-12" style="padding-left:  0px; padding-right: 0px;">
                                                    <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                        ...
                                                        <asp:RequiredFieldValidator ValidationGroup="vldInput" runat="server" ID="RequiredFieldValidator1"
