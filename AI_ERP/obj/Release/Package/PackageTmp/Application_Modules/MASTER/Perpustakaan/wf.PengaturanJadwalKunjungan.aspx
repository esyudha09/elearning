<%@ Page Title="" Language="C#" MasterPageFile="~/Application_Masters/Main.Master" AutoEventWireup="true" CodeBehind="wf.PengaturanJadwalKunjungan.aspx.cs" Inherits="AI_ERP.Application_Modules.MASTER.Perpustakaan.wf_PengaturanJadwalKunjungan" %>
    ...
    <script type="text/javascript">
        ...
        function InitModalFocus(){
            $('#ui_modal_input_data').on('shown.bs.modal', function () {
                document.getElementById("<%= cboJamKe.ClientID %>").focus();
            });
        }
    </script>
</asp:Content>
                                    ...
                                    <table style="width: 100%;">
                                        <tr>
                                            <td style="background-color: #295BC8; padding: 10px; font-weight: normal; vertical-align: middle; color: white; padding-left: 20px; font-size: 15px;">
                                                <img src="<%= ResolveUrl("~/Application_CLibs/images/svg/test-2.svg") %>" 
                                                ...
                                                <div class="row" style="margin-left: 15px; margin-right: 15px;">
                                                    <div class="col-xs-12" style="padding-left: 0px; padding-right: 0px;">
                                                        <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                            ...
                                                            <asp:DropDownList OnSelectedIndexChanged="cboUnit_SelectedIndexChanged" AutoPostBack="true" runat="server" ID="cboUnit" CssClass="form-control"></asp:DropDownList>
                                                        </div>
                                                    </div>
                                                </div>
								                                ...
								                                <thead>
								                                    <tr style="background-color: #3367d6;">
                                                                        ...
                                                                        <th style="background-color: #3367d6; text-align: left; padding-left: 10px; vertical-align: middle;">
                                                                            <asp:LinkButton ID="H_JamKe" runat="server" CommandName="Sort" CommandArgument="JamKe" style="color: white; font-weight: bold;">
                                                                                Jam Ke
                                                                            </asp:LinkButton>
                                                                            <asp:Literal runat="server" ID="imgh_jamke" Visible="false"></asp:Literal>
									                                    </th>
                                                                        <th style="background-color: #3367d6; text-align: left; padding-left: 10px; vertical-align: middle;">
                                                                            <asp:LinkButton ID="H_Waktu" runat="server" CommandName="Sort" CommandArgument="Waktu" style="color: white; font-weight: bold;">
                                                                                Waktu
                                                                            </asp:LinkButton>
                                                                            <asp:Literal runat="server" ID="imgh_waktu" Visible="false"></asp:Literal>
									                                    </th>
								                                    </tr>
							                                    </thead>
							                                    <tbody>     
                                                    ...
                                                    <ItemTemplate>
                                                        <tr class="<%# (Container.DisplayIndex % 2 == 0 ? "standardrow" : "oddrow") %>">
                                                            ...
                                                            <td style="font-weight: bold; padding: 10px; vertical-align: middle; text-align: left;">
                                                                <span style="color: grey; font-weight: normal; text-transform: none; text-decoration: none; font-weight: bold;">
                                                                    <%# 
                                                                        AI_ERP.Application_Libs.Libs.GetHTMLSimpleText(Eval("JamKe").ToString())
                                                                    %>
                                                                </span>
                                                            </td>
                                                            <td style="font-weight: bold; padding: 10px; vertical-align: middle; text-align: left;">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div style="width: 100%; background-color: white; padding-top: 15px;">
                                            <div class="row" style="margin-left: 15px; margin-right: 15px;">
                                                <div class="col-xs-12">
                                                    <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                        <label class="label-input" for="<%= cboJamKe.ClientID %>" style="text-transform: none;">Jam Ke</label>
                                                        <asp:RequiredFieldValidator ValidationGroup="vldInput" runat="server" ID="vldJamKe"
                                                            ControlToValidate="cboJamKe" Display="Dynamic" style="float: right; font-weight: bold;"
                                                            Text="<i class='fa fa-exclamation-triangle'></i>" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                                        <asp:DropDownList CssClass="form-control" runat="server" ID="cboJamKe"></asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row" style="margin-left: 15px; margin-right: 15px;">
                                                <div class="col-xs-12">
                                                    <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                        <label class="label-input" for="<%= txtWaktu.ClientID %>" style="text-transform: none;">Waktu</label>
                                                        <asp:RequiredFieldValidator ValidationGroup="vldInput" runat="server" ID="vldWaktu"
                                                            ControlToValidate="txtWaktu" Display="Dynamic" style="float: right; font-weight: bold;"
                                                            Text="<i class='fa fa-exclamation-triangle'></i>" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                                        <asp:TextBox CssClass="form-control" runat="server" ID="txtWaktu"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
										</div>  
