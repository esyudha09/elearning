<%@ Page Title="" Language="C#" MasterPageFile="~/Application_Masters/Main.Master" AutoEventWireup="true" CodeBehind="wf.ListKunjunganPerpustakaan.aspx.cs" Inherits="AI_ERP.Application_Modules.LIBRARY.wf_ListKunjunganPerpustakaan" %>
        ...
        function EndRequest() {
            ...
            switch (jenis_act) {
                ...
                case "<%= JenisAction.ShowInfoKunjungan %>":
                    ...
                    break;
                case "<%= JenisAction.ShowPengaturanTampilan %>":
                                                ...
                                                <asp:ListView ID="lvData" DataSourceID="sql_ds" runat="server" OnSorting="lvData_Sorting" OnPagePropertiesChanging="lvData_PagePropertiesChanging">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr class="<%# (Container.DisplayIndex % 2 == 0 ? "standardrow" : "oddrow") %>">
										                                ...
										                                <li class="dropdown">
											                                ...
											                                <ul class="dropdown-menu-list-table">
                                                                                <li style="background-color: white; padding: 10px;">
													                                <label
                                                                                        onclick="<%= txtID.ClientID %>.value = '<%# Eval("Kode").ToString() %>'; <%= btnShowInfoKunjungan.ClientID %>.click(); " 
                                                                                        id="btnDetail" style="color: darkblue; cursor: pointer; padding-left: 5px; padding-right: 5px; font-weight: bold;"><i class="fa fa-info-circle" title=" Lihat Detail "></i>&nbsp;&nbsp;&nbsp;Lihat Detail</label>
												                                </li>												                                
                                                            ...
                                                            <td style="font-weight: bold; padding: 10px; vertical-align: middle; text-align: left; width: 160px;">
                                                            ...
                                                            <td style="font-weight: bold; padding: 10px; vertical-align: middle; text-align: left; width: 150px;">
                                                                <span style="color: grey; font-weight: normal; text-transform: none; text-decoration: none;">
                                                                    <%# 
                                                                        Eval("KelasDet").ToString()
                                                                    %>
                                                                </span>
                                                            </td>
                                                            <td style="font-weight: bold; padding: 10px; vertical-align: middle; text-align: left; max-width: 150px;">
                                                                <span style="color: grey; font-weight: normal; text-transform: none; text-decoration: none;">
                                                                    <%# 
                                                                        Eval("Guru").ToString()
                                                                    %>
                                                                ...
                                                                <%# 
                                                                    ...
                                                                    (
                                                                        ...
                                                                        ? "<br />" +
                                                                          "<span style=\"color: grey; font-weight: normal; text-transform: none; text-decoration: none;\">" +
                                                                            AI_ERP.Application_Libs.Libs.GetHTMLSimpleText(
                                            ...
                                            <div class="fbtn-container" id="div_button_settings" runat="server">
		                                        <div class="fbtn-inner">
                                                    ...
                                                    <div class="fbtn-dropup" style="z-index: 999999;">
                                                        <asp:LinkButton ToolTip=" Tambah Data " runat="server" ID="btnDoShowTampilanData" CssClass="fbtn fbtn-green waves-attach waves-circle waves-effect" style="background-color: #257228;" OnClick="btnDoShowTampilanData_Click">
		        ...
		        <div class="modal-dialog modal-xs">
			        <div class="modal-content" style="border: none; border-top-left-radius: 6px; border-top-right-radius: 6px;">
                                            ...
                                            <div class="row" style="margin-left: 15px; margin-right: 15px;">
                                                <div class="col-xs-12">
                                                    <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                        <label class="label-input" for="<%= txtTanggal1.ClientID %>" style="font-weight: normal; text-transform: none;">Dari Tanggal</label>
                                                        <asp:TextBox runat="server" ID="txtTanggal1" CssClass="form-control"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row" style="margin-left: 15px; margin-right: 15px;">
                                                <div class="col-xs-12">
                                                    <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                        <label class="label-input" for="<%= txtTanggal2.ClientID %>" style="font-weight: normal; text-transform: none;">Sampai Tanggal</label>
                                                        <asp:TextBox runat="server" ID="txtTanggal2" CssClass="form-control"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row" style="margin-left: 15px; margin-right: 15px;">
                                                <div class="col-xs-12">
                                                    <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                        ...
                                                        <asp:DropDownList CssClass="form-control" runat="server" ID="cboUnitSekolah"></asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
										</div>  
				        ...
				        <div class="modal-footer">
					        <p class="text-right">
                                <br />
                                <asp:LinkButton CssClass="btn btn-flat btn-brand-accent waves-attach waves-effect pull-left" runat="server" ID="lnkOKTampilanDataSemua" OnClick="lnkOKTampilanDataSemua_Click" Text=" SEMUA  "></asp:LinkButton>
                                <asp:LinkButton CssClass="btn btn-flat btn-brand-accent waves-attach waves-effect pull-left" runat="server" ID="lnkOKHariIni" OnClick="lnkOKHariIni_Click" Text=" HARI INI "></asp:LinkButton>
            ...
            <div aria-hidden="true" class="modal fade" id="ui_modal_kunjungan_perpus" role="dialog" tabindex="-1" style="display: none; padding-right: 9px; z-index: 2000;">
		        <div class="modal-dialog modal-xs">
			        <div class="modal-content" style="border: none; border-top-left-radius: 6px; border-top-right-radius: 6px;">
							    ...
							    <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div style="width: 100%; background-color: white;">
                                            ...
                                            <div class="row" style="margin-left: 30px; margin-right: 30px; background-color: white;">
                                                <div class="col-xs-12" style="padding-left:  0px; padding-right: 0px;">
                                                    <div class="form-group form-group-label" style="margin-bottom: 5px; padding-bottom: 5px; margin-top: 10px;">
                                                        <label class="label-input" for="<%= cboStatus.ClientID %>" style="text-transform: none;">
                                                            <i class="fa fa-hashtag"></i>&nbsp;
                                                            Status
                                                        </label>
                                                        <asp:RequiredFieldValidator ValidationGroup="vldInput" runat="server" ID="vldSemester"
                                                            ControlToValidate="cboStatus" Display="Dynamic" style="float: right; font-weight: bold;"
                                                            Text="<i class='fa fa-exclamation-triangle'></i>" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                                        <asp:DropDownList CssClass="form-control" runat="server" ID="cboStatus"></asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div> 
						                </div>
				        ...
				        <div class="modal-footer">
					        <p class="text-right">
                                <asp:LinkButton ValidationGroup="vldInput" CssClass="btn btn-flat btn-brand-accent waves-attach waves-effect" runat="server" ID="lnkOKSave" OnClick="lnkOKSave_Click" Text="  OK  "></asp:LinkButton>
                                <a class="btn btn-flat btn-brand-accent waves-attach waves-effect" data-dismiss="modal">Batal</a>      
                                <br /><br />                              
					        </p>
				        </div>
