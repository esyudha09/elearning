!function(e, t) {
    ...
    r(l, [], function() {
        ...
        function n(e, t) {
            ...
            o.isImmediatePropagationStopped = n), "undefined" == typeof o.metaKey && (o.metaKey = !1), 
            o;
        }
        function r(n, r, i) {
            function o() {
        ...
        function i() {
            ...
            u = "onfocusin" in document.documentElement, f = {
                ...
                if (t && 3 !== t.nodeType && 8 !== t.nodeType) {
                    for (t[c] ? g = t[c] : (g = l++, t[c] = g, s[g] = {}), p = p || t, o = o.split(" "), 
                    y = o.length; y--; ) b = o[y], C = m, x = w = !1, "DOMContentLoaded" === b && (b = "ready"), 
                    a.domLoaded && "ready" === b && "complete" == t.readyState ? h.call(p, n({
                        type: b
                        ...
                        e.target = t, i(e, g));
                    })), u || "focusin" !== b && "focusout" !== b || (w = !0, x = "focusin" === b ? "focus" : "blur", 
                    C = function(e) {
                    ...
                    if (f = s[i], n) {
                        for (n = n.split(" "), l = n.length; l--; ) if (d = n[l], o = f[d]) {
                            if (r) for (u = o.length; u--; ) if (o[u].func === r) {
                                ...
                                o = o.slice(0, u).concat(o.slice(u + 1)), o.nativeHandler = h, o.fakeName = p, o.capture = m, 
                                f[d] = o;
                            }
        ...
        function e(e, t, n, r) {
            ...
            if (M && !r) {
                if (i = ve.exec(e)) if (a = i[1]) {
                    ...
                    if ((a = i[3]) && C.getElementsByClassName) return Z.apply(n, t.getElementsByClassName(a)), 
                    n;
                }
                if (C.qsa && (!H || !H.test(e))) {
                    if (h = d = F, p = t, m = 9 === s && e, 1 === s && "object" !== t.nodeName.toLowerCase()) {
                        for (c = N(e), (d = t.getAttribute("id")) ? h = d.replace(be, "\\$&") : t.setAttribute("id", h), 
                        h = "[id='" + h + "'] ", l = c.length; l--; ) c[l] = h + f(c[l]);
        ...
        C = e.support = {}, E = e.isXML = function(e) {
            ...
            return n !== D && 9 === n.nodeType && n.documentElement ? (D = n, L = n.documentElement, 
            M = !E(n), r && r !== r.top && (r.addEventListener ? r.addEventListener("unload", function() {
                B();
                ...
                t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("name", "D"), e.querySelectorAll("[name=d]").length && H.push("name" + re + "*[*^$|!~]?="), 
            ...
            }), H = H.length && new RegExp(H.join("|")), P = P.length && new RegExp(P.join("|")), 
            t = ge.test(L.compareDocumentPosition), I = t || ge.test(L.contains) ? function(e, t) {
                ...
                1 & r || !C.sortDetached && t.compareDocumentPosition(e) === r ? e === n || e.ownerDocument === z && I(z, e) ? -1 : t === n || t.ownerDocument === z && I(z, t) ? 1 : R ? te.call(R, e) - te.call(R, t) : 0 : 4 & r ? -1 : 1);
            } : function(e, t) {
                if (e === t) return A = !0, 0;
            ...
            preFilter: {
                ATTR: function(e) {
                    return e[1] = e[1].replace(xe, Ce), e[3] = (e[3] || e[4] || e[5] || "").replace(xe, Ce), 
                ...
                PSEUDO: function(e) {
                    var t, n = !e[6] && e[2];
                    return he.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && de.test(n) && (t = N(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t), 
                    ...
                    return 1 === r && 0 === i ? function(e) {
                        ...
                        if (g) {
                            ...
                            if (p = [ a ? g.firstChild : g.lastChild ], a && y) {
                                for (u = g[F] || (g[F] = {}), c = u[e] || [], h = c[0] === W && c[1], f = c[0] === W && c[2], 
                                d = h && g.childNodes[h]; d = ++h && d && d[m] || (f = h = 0) || p.pop(); ) if (1 === d.nodeType && ++f && d === t) {
                                    u[e] = [ W, h, f ];
                                    break;
                                }
                            } else if (y && (c = (t[F] || (t[F] = {}))[e]) && c[0] === W) f = c[1]; else for (;(d = ++h && d && d[m] || (f = h = 0) || p.pop()) && ((s ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++f || (y && ((d[F] || (d[F] = {}))[e] = [ W, f ]), 
                            d !== t)); ) ;
            ...
            pseudos: {
                ...
                lang: r(function(t) {
                    ...
                    function(e) {
                        var n;
                        do if (n = M ? e.lang : e.getAttribute("xml:lang") || e.getAttribute("lang")) return n = n.toLowerCase(), 
        ...
        }, C.sortStable = F.split("").sort(j).join("") === F, C.detectDuplicates = !!A, 
        B(), C.sortDetached = i(function(e) {
        ...
        n = window.opera && window.opera.buildNumber, u = /Android/.test(t), r = /WebKit/.test(t), 
        i = !r && !n && /MSIE/gi.test(t) && /Explorer/gi.test(e.appName), i = i && /MSIE (\w+)\./.exec(t)[1], 
        o = -1 == t.indexOf("Trident/") || -1 == t.indexOf("rv:") && -1 == e.appName.indexOf("Netscape") ? !1 : 11, 
        a = -1 == t.indexOf("Edge/") || i || o ? !1 : 12, i = i || o || a, s = !r && !o && /Gecko/.test(t), 
        l = -1 != t.indexOf("Mac"), c = /(iPad|iPhone)/.test(t), d = "FormData" in window && "FileReader" in window && "URL" in window && !!URL.createObjectURL, 
        a && (r = !1);
        ...
        return f.fn = f.prototype = {
            ...
            init: function(e, t) {
                ...
                if (a(e)) {
                    if (n.selector = e, r = "<" === e.charAt(0) && ">" === e.charAt(e.length - 1) && e.length >= 3 ? [ null, e, null ] : N.exec(e), 
                    !r) return f(t).find(e);
            ...
            add: function(e, t) {
                ...
                i = 0; i < r.length; i++) n[i] = r[i]; else _.apply(n, f.makeArray(e));
                return n;
            },
            attr: function(e, t) {
                var n = this, r;
            ...
            offset: function(e) {
                var t, n, r, i = 0, o = 0, a;
                return e ? this.css(e) : (t = this[0], t && (n = t.ownerDocument, r = n.documentElement, 
                t.getBoundingClientRect && (a = t.getBoundingClientRect(), i = a.left + (r.scrollLeft || n.body.scrollLeft) - r.clientLeft, 
        ...
        return function(e, t) {
            ...
            for (e = e || {}, t && (d = t.getValidStyles(), f = t.getInvalidStyles()), u = ("\\\" \\' \\; \\: ; : " + h).split(" "), 
            l = 0; l < u.length; l++) c[u[l]] = h + l, c[h + l] = u[l];
            return {
                toHex: function(e) {
                    ...
                    if (t) {
                        for (t = t.replace(/[\u0000-\u001F]/g, ""), t = t.replace(/\\[\"\';:\uFEFF]/g, f).replace(/\"[^\"]+\"|\'[^\']+\'/g, function(e) {
                            ...
                            if (v = g[1].replace(a, "").toLowerCase(), y = g[2].replace(a, ""), y = y.replace(/\\[0-9a-f]+/g, function(e) {
                                ...
                                y = y.replace(r, n), y = y.replace(i, p), m[v] = b ? h(y, !0) : y;
                            }
        ...
        function t(n) {
            ...
            function _(e, t, r) {
                ...
                o == i ? w(M[V], M[W], M[U], M[$]) > 0 && M.collapse(e) : M.collapse(e), M.collapsed = C(), 
            ...
            function N(e) {
                ...
                if (3 == M[V].nodeType) {
                    if (n = M[V].nodeValue, i = n.substring(M[W], M[$]), e != O && (o = M[V], c = M[W], 
                    u = M[$] - M[W], 0 === c && u >= o.nodeValue.length - 1 ? o.parentNode.removeChild(o) : o.deleteData(c, u), 
                    M.collapse(F)), e == I) return;
                    return i.length > 0 && t.appendChild(H.createTextNode(i)), t;
                }
                for (o = x(M[V], M[W]), a = M[$] - M[W]; o && a > 0; ) s = o.nextSibling, l = D(o, e), 
            ...
            function k(e, t) {
                var n, i, o, a, s, l;
                for (t != I && (n = r()), o = A(e, t), n && n.appendChild(o), i = j(e), ++i, a = M[$] - i, 
            ...
            function B(e, t, r, i) {
                ...
                if (t) return D(e, i);
                if (3 == e.nodeType) {
                    if (o = e.nodeValue, r ? (l = M[W], a = o.substring(l), s = o.substring(0, l)) : (l = M[$], 
        ...
        var f = {
            ...
            decode: function(e) {
                return e.replace(u, function(e, n) {
                    ...
                    n > 65535 ? (n -= 65536, String.fromCharCode(55296 + (n >> 10), 56320 + (1023 & n))) : d[n] || String.fromCharCode(n)) : a[e] || i[e] || t(e);
                });
            }
        };
        return f;
        ...
        return function(t, n) {
            ...
            function i(n, i, l) {
                ...
                function h() {
                    f(function() {
                        for (var e = t.styleSheets, n, r = e.length, i; r--; ) if (n = e[r], i = n.ownerNode ? n.ownerNode : n.owningElement, 
                        i && i.id === m.id) return c(), !0;
                    }, h);
                }
                function p() {
                    f(function() {
                ...
                if (n = e._addCacheSuffix(n), a[n] ? y = a[n] : (y = {
                    ...
                    if (y.status = 1, m = t.createElement("link"), m.rel = "stylesheet", m.type = "text/css", 
                    m.id = "u" + o++, m.async = !1, m.defer = !1, v = new Date().getTime(), "onload" in m && !d()) m.onload = h, 
                    m.onerror = u; else {
                        if (navigator.userAgent.indexOf("Firefox") > 0) return g = t.createElement("style"), 
                        g.textContent = '@import "' + n + '"', p(), void r(g);
                        h();
                    }
                    r(m), m.href = n;
                }
        ...
        function p(e, t) {
            var o = this, a;
            o.doc = e, o.win = window, o.files = {}, o.counter = 0, o.stdMode = !b || e.documentMode >= 8, 
            o.boxModel = !b || "CSS1Compat" == e.compatMode || o.stdMode, o.styleSheetLoader = new u(e), 
            o.boundEvents = [], o.settings = t = t || {}, o.schema = t.schema, o.styles = new r({
                url_converter: t.url_converter,
                url_converter_scope: t.url_converter_scope
            }, t.schema), o.fixDoc(e), o.events = t.ownEvents ? new i(t.proxy) : i.Event, o.attrHooks = d(o, t), 
            a = t.schema ? t.schema.getBlockElements() : {}, o.$ = n.overrideDefaults(function() {
                return {
                    context: e,
                    element: o.getRoot()
                };
        ...
        return p.prototype = {
            ...
            clone: function(e, t) {
                var n = this, r, i;
                return !b || 1 !== e.nodeType || t ? e.cloneNode(t) : (i = n.doc, t ? r.firstChild : (r = i.createElement(e.nodeName), 
            ...
            add: function(e, t, n, r, i) {
                ...
                return this.run(e, function(e) {
                    var a;
                    return a = g(t, "string") ? o.doc.createElement(t) : t, o.setAttribs(a, n), r && (r.nodeType ? a.appendChild(r) : o.setHTML(a, r)), 
                    i ? a : e.appendChild(a);
                });
            },
            ...
            setAttrib: function(e, t, n) {
                ...
                "" === n && (n = null), e = r.$$(e), i = e.attr(t), e.length && (o = r.attrHooks[t], 
                o && o.set ? o.set(e, n, t) : e.attr(t, n), i != n && a.onSetAttrib && a.onSetAttrib({
                    attrElm: e,
                    attrName: t,
                    attrValue: n
                }));
            ...
            getAttrib: function(e, t, n) {
                var r = this, i, o;
                return e = r.$$(e), e.length && (i = r.attrHooks[t], o = i && i.get ? i.get(e, t) : e.attr(t)), 
                "undefined" == typeof o && (o = n || ""), o;
            },
            getPos: function(e, t) {
                ...
                if (e = r.get(e), t = t || l, e) {
                    ...
                    t = r.boxModel ? s.documentElement : l, i = c.left + (s.documentElement.scrollLeft || l.scrollLeft) - t.clientLeft, 
                    o = c.top + (s.documentElement.scrollTop || l.scrollTop) - t.clientTop, {
                        x: i,
                        y: o
                    };
                    for (a = e; a && a != t && a.nodeType; ) i += a.offsetLeft || 0, o += a.offsetTop || 0, 
                    a = a.offsetParent;
                    for (a = e.parentNode; a && a != t && a.nodeType; ) i -= a.scrollLeft || 0, o -= a.scrollTop || 0, 
                    a = a.parentNode;
                }
                return {
                    x: i,
            ...
            loadCSS: function(e) {
                ...
                return t !== p.DOM && n === document ? void p.DOM.loadCSS(e) : (e || (e = ""), r = n.getElementsByTagName("head")[0], 
        ...
        function n() {
            function e(e, n) {
                ...
                var a = r, s, l;
                l = a.uniqueId(), s = document.createElement("script"), s.id = l, s.type = "text/javascript", 
                s.src = t._addCacheSuffix(e), "onreadystatechange" in s ? s.onreadystatechange = function() {
        ...
        function r(e) {
            this.walk = function(t, r) {
                ...
                p = s(c, h) || c, m = s(d, h) || d, l(c, p, !0), y = a(p == c ? p : p.nextSibling, "nextSibling", m == d ? m.nextSibling : m), 
                ...
                function r(r) {
                    ...
                    function c(n, r) {
                        var a, s, l;
                        if (r = r || u, l = e.getParent(r.parentNode, e.isBlock) || h, n && "BR" == r.nodeName && v && e.isEmpty(l)) return u = r.parentNode, 
                        d = e.nodeIndex(r), void (i = !0);
                        for (a = new t(r, l); p = a[n ? "prev" : "next"](); ) {
                            if ("false" === e.getContentEditableParent(p)) return;
                            if (3 === p.nodeType && p.nodeValue.length > 0) return u = p, d = n ? p.nodeValue.length : 0, 
                            void (i = !0);
                    ...
                    if (u = n[(r ? "start" : "end") + "Container"], d = n[(r ? "start" : "end") + "Offset"], 
                    v = 1 == u.nodeType && d === u.childNodes.length, m = e.schema.getNonEmptyElements(), 
                    g = r, 1 == u.nodeType && d > u.childNodes.length - 1 && (g = !1), 9 === u.nodeType && (u = e.getRoot(), 
                    d = 0), u === h) {
                        if (g && (p = u.childNodes[d > 0 ? d - 1 : 0], p && (m[p.nodeName] || "TABLE" == p.nodeName))) return;
                        if (u.hasChildNodes() && (d = Math.min(!g && d > 0 ? d - 1 : d, u.childNodes.length - 1), 
                        u = u.childNodes[d], d = 0, u.hasChildNodes() && !/TABLE/.test(u.nodeName))) {
                            p = u, f = new t(u, h);
                            do {
                    ...
                    o && (3 === u.nodeType && 0 === d && c(!0), 1 === u.nodeType && (p = u.childNodes[d], 
                    p || (p = u.childNodes[d - 1]), !p || "BR" !== p.nodeName || l(p, "A") || s(p) || s(p, !0) || c(!0, p))), 
                    g && !o && 3 === u.nodeType && d === u.nodeValue.length && c(!1), i && n["set" + (r ? "Start" : "End")](u, d);
                }
                var i, o;
        ...
        return function(n) {
            ...
            "onselectionchange" in n.getDoc() || n.on("NodeChange Click MouseUp KeyUp Focus", function(t) {
                ...
                }, "nodechange" != t.type && e.compareRanges(o, i) || n.fire("SelectionChange"), 
                i = o;
                ...
                n.initialized && t && !n.settings.disable_nodechange && !n.settings.readonly && (o = n.getBody(), 
                r = t.getStart() || o, r = r.ownerDocument != n.getDoc() ? n.getBody() : r, "IMG" == r.nodeName && t.isCollapsed() && (r = r.parentNode), 
                i = [], n.dom.getParent(r, function(e) {
        ...
        function n(e) {
            ...
            "html5-strict" != e && (l.push("xml:lang"), h = t("acronym applet basefont big font strike tt"), 
            u.push.apply(u, h), s(h, function(e) {
                n(e, "", u);
            ...
            n("q", "cite", u), n("ins del", "cite datetime", d), n("img", "src sizes srcset alt usemap ismap width height"), 
            ...
            n("canvas", "width height", d), n("video", "src crossorigin poster preload autoplay mediagroup loop muted controls width height buffered", d, "track source"), 
            n("audio", "src crossorigin preload autoplay mediagroup loop muted controls buffered volume", d, "track source"), 
            n("picture", "", "img source"), n("source", "src srcset type media sizes"), n("track", "kind src srclang label default"), 
            n("datalist", "", u, "option"), n("article section nav aside header footer", "", d), 
            n("hgroup", "", "h1 h2 h3 h4 h5 h6"), n("figure", "", d, "figcaption"), n("time", "datetime", u), 
            n("dialog", "open", d), n("command", "type label icon disabled checked radiogroup command"), 
            n("output", "for form name", u), n("progress", "value max", u), n("meter", "value min max low high optimum", u), 
        ...
        return function(e) {
            function o(t, n, r) {
                var o = e[t];
                return o ? o = a(o, /[, ]/, a(o.toUpperCase(), /[, ]/)) : (o = i[t], o || (o = a(n, " ", a(n.toUpperCase(), " ")), 
                o = l(o, r), i[t] = o)), o;
            }
            function d(e) {
            ...
            function f(e) {
                ...
                n = 0, r = e.length; r > n; n++) if (s = S.exec(e[n])) {
                    ...
                    if (f) for (f = t(f, "|"), i = 0, o = f.length; o > i; i++) if (s = k.exec(f[i])) {
                        if (c = {}, m = s[1], p = s[2].replace(/::/g, ":"), b = s[3], N = s[4], "!" === m && (l.attributesRequired = l.attributesRequired || [], 
                        l.attributesRequired.push(p), c.required = !0), "-" === m) {
                        ...
                        b && ("=" === b && (l.attributesDefault = l.attributesDefault || [], l.attributesDefault.push({
                            name: p,
                            value: N
                        }), c.defaultValue = N), ":" === b && (l.attributesForced = l.attributesForced || [], 
                        l.attributesForced.push({
                            name: p,
                            value: N
                        }), c.forcedValue = N), "<" === b && (c.validValues = a(N, "?"))), T.test(p) ? (l.attributePatterns = l.attributePatterns || [], 
                        c.pattern = d(p), l.attributePatterns.push(c)) : (g[p] || v.push(p), g[p] = c);
                    }
                    w || "@" != h || (w = g, _ = v), C && (l.outputName = h, y[C] = l), T.test(h) ? (l.pattern = d(h), 
                    x.push(l)) : y[h] = l;
                }
            }
            function h(e) {
            ...
            C = r(e.valid_styles), w = r(e.invalid_styles, "map"), T = r(e.valid_classes, "map"), 
            ...
            A = o("non_empty_elements", "td th iframe video audio object script", S), B = o("move_caret_before_on_enter_elements", "table", A), 
            ...
            R = o("block_elements", "hr table tbody thead tfoot th tr td li ol ul caption dl dt dd noscript menu isindex option datalist select optgroup", D), 
            ...
            })), p(e.custom_elements), m(e.valid_children), f(e.extended_valid_elements), m("+ol[ul|ol],+ul[ul|ol]"), 
            e.invalid_elements && s(c(e.invalid_elements), function(e) {
                ...
                return M;
            }, v.addValidElements = f, v.setValidElements = h, v.addCustomElements = p, v.addValidChildren = m, 
            v.elements = y;
        };
    }), r(S, [ N, v, f ], function(e, t, n) {
        function r(e, t, n) {
            var r = 1, i, o, a, s;
            for (s = e.getShortEndedElements(), a = /<([!?\/])?([A-Za-z0-9\-_\:\.]+)((?:\s+[^"\'>]+(?:(?:"[^"]*")|(?:\'[^\']*\')|[^>]*))*|\/|\s+)>/g, 
        ...
        function i(i, a) {
            ...
            o("comment cdata text start end pi doctype".split(" "), function(e) {
                ...
                for (H = new RegExp("<(?:(?:!--([\\w\\W]*?)-->)|(?:!\\[CDATA\\[([\\w\\W]*?)\\]\\]>)|(?:!DOCTYPE([\\w\\W]*?)>)|(?:\\?([^\\s\\/<>]+) ?([\\w\\W]*?)[?/]>)|(?:\\/([^>]+)>)|(?:([A-Za-z0-9\\-_\\:\\.]+)((?:\\s+[^\"'>]+(?:(?:\"[^\"]*\")|(?:'[^']*')|[^>]*))*|\\/|\\s+)>))", "g"), 
                P = /([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:[^\"])*)\")|(?:\'((?:[^\'])*)\')|([^>\s]+)))?/g, 
                x = a.getShortEndedElements(), M = i.self_closing_elements || a.getSelfClosingElements(), 
                C = a.getBoolAttrs(), _ = i.validate, b = i.remove_internals, W = i.fix_self_closing, 
                O = a.getSpecialElements(); c = H.exec(e); ) {
                    ...
                    ":" === d.charAt(0) && (d = d.substr(1)), o(d); else if (d = c[7]) {
                        if (d = d.toLowerCase(), ":" === d.charAt(0) && (d = d.substr(1)), w = d in x, W && M[d] && h.length > 0 && h[h.length - 1].name === d && o(d), 
                        !_ || (E = a.getElementRule(d))) {
                            if (N = !0, _ && (T = E.attributes, R = E.attributePatterns), (k = c[8]) ? (y = -1 !== k.indexOf("data-mce-type"), 
                            y && b && (N = !1), p = [], p.map = {}, k.replace(P, s)) : (p = [], p.map = {}), 
                            _ && !y) {
                                if (A = E.attributesRequired, B = E.attributesDefault, D = E.attributesForced, L = E.removeEmptyAttrs, 
                                L && !p.length && (N = !1), D) for (m = D.length; m--; ) S = D[m], v = S.name, I = S.value, 
                                "{$uid}" === I && (I = "mce_" + F++), p.map[v] = I, p.push({
                                    name: v,
                                    value: I
                                });
                                if (B) for (m = B.length; m--; ) S = B[m], v = S.name, v in p.map || (I = S.value, 
                                "{$uid}" === I && (I = "mce_" + F++), p.map[v] = I, p.push({
                                    name: v,
                                    value: I
                                }));
                        ...
                        if (f = O[d]) {
                            f.lastIndex = u = c.index + c[0].length, (c = f.exec(e)) ? (N && (g = e.substr(u, c.index - u)), 
                            u = c.index + c[0].length) : (g = e.substr(u), u = e.length), N && (g.length > 0 && l.text(g, !0), 
        ...
        return function(r, l) {
            function c(t) {
                ...
                for (m = i("tr,td,th,tbody,thead,tfoot,table"), p = l.getNonEmptyElements(), g = l.getTextBlockElements(), 
                v = l.getSpecialElements(), n = 0; n < t.length; n++) if (r = t[n], r.parent && !r.fixed) if (g[r.name] && "li" == r.parent.name) {
                    for (y = r.next; y && g[y.name]; ) y.name = "li", y.fixed = !0, r.parent.insert(y, r.parent), 
                    y = y.next;
                    r.unwrap(r);
                } else {
                    ...
                    if (o && a.length > 1) {
                        for (a.reverse(), s = c = u.filterNode(a[0].clone()), h = 0; h < a.length - 1; h++) {
                            for (l.isValidChild(c.name, a[h].name) ? (d = u.filterNode(a[h].clone()), c.append(d)) : d = c, 
                            f = a[h].firstChild; f && f != a[h + 1]; ) b = f.next, d.append(f), f = b;
                            c = d;
                        }
                        s.isEmpty(p) ? o.insert(r, a[0], !0) : (o.insert(s, a[0], !0), o.insert(r, s)), 
                        o = a[0], (o.isEmpty(p) || o.firstChild === o.lastChild && "br" === o.firstChild.name) && o.empty().remove();
                    } else if (r.parent) {
                        if ("li" === r.name) {
            ...
            u.schema = l = l || new t(), u.filterNode = function(e) {
                ...
                M = /^[ \t\r\n]+$/, v = new n({
                    ...
                    start: function(e, t, n) {
                        ...
                        if (o = k ? l.getElementRule(e) : {}) {
                            ...
                            a in t.map && (N = p[a], N ? N.push(r) : p[a] = [ r ]);
                        ...
                        if (r = k ? l.getElementRule(t) : {}) {
                            ...
                            T[b.name] ? b.empty().remove() : b.unwrap(), void (b = a);
                            b = b.parent;
                        }
                    }
                ...
                for (o.body = 1, n = 0; r > n; n++) if (i = t[n], c = i.parent, o[i.parent.name] && i === c.lastChild) {
                    ...
                    i && (i.remove(), c.isEmpty(a) && (h = l.getElementRule(c.name), h && (h.removeEmpty ? c.remove() : h.paddEmpty && (c.empty().append(new e("#text", 3)).value = " "))));
                } else {
                    for (u = i; c && c.firstChild === u && c.lastChild === u && (u = c, !o[c.name]); ) c = c.parent;
                    u === c && (p = new e("#text", 3), p.value = " ", i.replace(p));
                }
        ...
        return function(t) {
            ...
            s = e.getEncodeFunc(t.entity_encoding || "raw", t.entities), l = "html" == t.element_format, 
            {
                start: function(e, t, n) {
                    ...
                    !n || l ? r[r.length] = ">" : r[r.length] = " />", n && i && a[e] && r.length > 0 && (f = r[r.length - 1], 
                    f.length > 0 && "\n" !== f && r.push("\n"));
                },
                end: function(e) {
                    var t;
        ...
        return function(n, r) {
            ...
            i.writer = o, i.serialize = function(e) {
                function t(e) {
                    ...
                    if (n) n(e); else {
                        if (s = e.name, l = e.shortEnded, c = e.attributes, a && c && c.length > 1 && (f = [], 
                        f.map = {}, m = r.getElementRule(e.name))) {
                            for (h = 0, p = m.attributesOrder.length; p > h; h++) u = m.attributesOrder[h], 
                            u in c.map && (d = c.map[u], f.map[u] = d, f.push({
                                name: u,
                                value: d
                            }));
                            for (h = 0, p = c.length; p > h; h++) u = c[h].name, u in f.map || (d = c.map[u], 
                            f.map[u] = d, f.push({
                                name: u,
                                value: d
                            }));
        ...
        return function(e, i) {
            var s, f, h;
            return i && (s = i.dom, f = i.schema), s = s || d, f = f || new o(e), e.entity_encoding = e.entity_encoding || "named", 
            e.remove_trailing_brs = "remove_trailing_brs" in e ? e.remove_trailing_brs : !0, 
            h = new t(e, f), h.addAttributeFilter("data-mce-tabindex", function(e, t) {
                for (var n = e.length, r; n--; ) r = e[n], r.attr("tabindex", r.attributes.map["data-mce-tabindex"]), 
                r.attr(t, null);
                ...
                for (var t = e.length, n, r; t--; ) n = e[t], r = n.attr("class"), r && (r = n.attr("class").replace(/(?:^|\s)mce-item-\w+(?!\S)/g, ""), 
                ...
                for (var r = e.length, i, o, a; r--; ) i = e[r], o = i.firstChild ? i.firstChild.value : "", 
                ...
                serialize: function(t, n) {
                    ...
                    return a.ie && s.select("script,style,select,map").length > 0 ? (g = t.innerHTML, 
                    t = t.cloneNode(!1), s.setHTML(t, g)) : t = t.cloneNode(!0), o = t.ownerDocument.implementation, 
                    o.createHTMLDocument && (d = o.createHTMLDocument(""), c("BODY" == t.nodeName ? t.childNodes : [t], function (e) {
                        if (d !== null && d !== undefined) {
                            d.body.appendChild(d.importNode(e, !0));
                        }
                    }), t = "BODY" != t.nodeName ? d.body.firstChild : (d !== null && d !== undefined ? d.body : ""), p = s.doc, s.doc = d), 
                    n = n || {}, n.format = n.format || "html", n.selection && (n.forced_root_block = ""), 
                    n.no_events || (n.node = t, i.onPreProcess(n)), v = h.parse(u(n.getInner ? t.innerHTML : s.getOuterHTML(t)), n), 
                    l(v), m = new r(e, f), n.content = m.serialize(v), n.cleanup || (n.content = n.content.replace(/\uFEFF/g, "")), 
                    n.no_events || i.onPostProcess(n), p && (s.doc = p), n.node = null, n.content;
                },
                addRules: function(e) {
        ...
        function e(e) {
            ...
            this.getBookmark = function(n) {
                ...
                function n(e) {
                    var t, n, a, d, p;
                    a = i.create("a"), t = e ? s : c, n = e ? l : u, d = r.duplicate(), (t == f || t == f.documentElement) && (t = h, 
                    n = 0), 3 == t.nodeType ? (t.parentNode.insertBefore(a, t), d.moveToElementText(a), 
                    d.moveStart("character", n), i.remove(a), r.setEndPoint(e ? "StartToStart" : "EndToEnd", d)) : (p = t.childNodes, 
                ...
                r = h.createTextRange(), s == c && 1 == s.nodeType) {
                    ...
                    if (l == u - 1) try {
                        if (m = s.childNodes[l], a = h.createControlRange(), a.addElement(m), a.select(), 
                        p = e.getRng(), p.item && m === p.item(0)) return;
                    } catch (g) {}
                }
                n(!0), n(), r.select();
            }, this.getRangeAt = n;
        ...
        return function(r, i) {
            function o(e) {
                ...
                "false" === e.getAttribute("data-mce-resize") ? !1 : e == i.getBody() ? !1 : i.dom.is(e, t));
            }
            function a(t) {
                var n, r, o, a, s;
                n = t.screenX - T, r = t.screenY - R, P = n * S[2] + D, O = r * S[3] + L, P = 5 > P ? 5 : P, 
                O = 5 > O ? 5 : O, o = "IMG" == w.nodeName && i.settings.resize_img_proportional !== !1 ? !e.modifierPressed(t) : e.modifierPressed(t) || "IMG" == w.nodeName && S[2] * S[3] !== 0, 
                o && (W(n) > W(r) ? (O = V(P * M), P = V(O / M)) : (P = V(O / M), O = V(P * M))), 
                x.setStyles(_, {
                    width: P,
                    height: O
                }), a = S.startPos.x + n, s = S.startPos.y + r, a = a > 0 ? a : 0, s = s > 0 ? s : 0, 
                x.setStyles(E, {
                    left: a,
                    top: s,
                    display: "block"
                }), E.innerHTML = P + " &times; " + O, S[2] < 0 && _.clientWidth <= P && x.setStyle(_, "left", A + (D - P)), 
                S[3] < 0 && _.clientHeight <= O && x.setStyle(_, "top", B + (L - O)), n = U.scrollWidth - $, 
                r = U.scrollHeight - q, n + r !== 0 && x.setStyles(E, {
                    left: a - n,
                    top: s - r
            ...
            function s() {
                ...
                H = !1, e("width", P), e("height", O), x.unbind(I, "mousemove", a), x.unbind(I, "mouseup", s), 
                F != I && (x.unbind(F, "mousemove", a), x.unbind(F, "mouseup", s)), x.remove(_), 
                x.remove(E), z && "TABLE" != w.nodeName || l(w), i.fire("ObjectResized", {
                    target: w,
                    width: P,
                    height: O
            ...
            function l(e, t, r) {
                var l, u, d, f, h;
                g(), l = x.getPos(e, U), A = l.x, B = l.y, h = e.getBoundingClientRect(), u = h.width || h.right - h.left, 
                d = h.height || h.bottom - h.top, w != e && (m(), w = e, P = O = 0), f = i.fire("ObjectSelected", {
                    target: e
                    ...
                    function o(t) {
                        ...
                        S = e, e.startPos = {
                            x: u * e[0] + A,
                            y: d * e[1] + B
                        }, $ = U.scrollWidth, q = U.scrollHeight, _ = w.cloneNode(!0), x.addClass(_, "mce-clonedresizable"), 
                        x.setAttrib(_, "data-mce-bogus", "all"), _.contentEditable = !1, _.unSelectabe = !0, 
                        x.setStyles(_, {
                            left: A,
                            top: B,
                            margin: 0
                        }), _.removeAttribute("data-mce-selected"), U.appendChild(_), x.bind(I, "mousemove", a), 
                        x.bind(I, "mouseup", s), F != I && (x.bind(F, "mousemove", a), x.bind(F, "mouseup", s)), 
                        E = x.add(U, "div", {
                    ...
                    var l;
                    return t ? void (i == t && o(r)) : (l = x.get("mceResizeHandle" + i), l && x.remove(l), 
                    l = x.add(U, "div", {
            ...
            function u(e) {
                ...
                }), o = "mousedown" == e.type ? e.target : r.getNode(), o = x.$(o).closest(z ? "table" : "table,img,hr")[0], 
                t(o, U) && (v(), n = r.getStart(!0), t(n, o) && t(r.getEnd(!0), o) && (!z || o != n && "IMG" !== n.nodeName)) ? void l(o) : void c();
            }
            function d(e, t, n) {
            ...
            function h(e) {
                ...
                for (r in N) if (o = N[r], a = t.offsetWidth * o[0], s = t.offsetHeight * o[1], 
                W(a - c) < 8 && W(s - u) < 8) {
                    S = o;
                    break;
                }
            ...
            i.on("init", function() {
                z ? (i.on("ObjectResized", function(e) {
                    ...
                    !H && /^(TABLE|IMG|HR)$/.test(t) && (i.selection.select(e.target, "TABLE" == t), 
        ...
        function n(n) {
            ...
            this.getBookmark = function(e, i) {
                ...
                l.duplicate || l.item) {
                    ...
                    c = l.duplicate();
                    try {
                        l.collapse(), l.pasteHTML('<span data-mce-type="bookmark" id="' + u + '_start" style="' + m + '">' + p + "</span>"), 
                        d || (c.collapse(!1), l.moveToElementText(c.parentElement()), 0 === l.compareEndPoints("StartToEnd", c) && c.move("character", -1), 
                        c.pasteHTML('<span data-mce-type="bookmark" id="' + u + '_end" style="' + m + '">' + p + "</span>"));
                    } catch (g) {
                        return null;
                    }
                } else {
                ...
                function a(n) {
                    ...
                    if (o && (a = o.parentNode, "start" == n ? (p ? (a = o.firstChild, s = 1) : s = r.nodeIndex(o), 
                    u = d = a, f = h = s) : (p ? (a = o.firstChild, s = 1) : s = r.nodeIndex(o), d = a, 
                    h = s), !p)) {
                        ...
                        c.appendData(l.nodeValue), r.remove(l), "start" == n ? (u = d = c, f = h = s) : (d = c, 
                        h = s));
                    }
                }
                function s(t) {
                ...
                l.setEnd(s(d), h), n.setRng(l))) : i.name ? n.select(r.select(i.name)[i.index]) : i.rng && n.setRng(i.rng);
            };
        }
        ...
        return l.prototype = {
            ...
            getStart: function(e) {
                ...
                if (n.duplicate || n.item) {
                    ...
                    for (o = n.duplicate(), o.collapse(1), r = o.parentElement(), r.ownerDocument !== t.dom.doc && (r = t.dom.getRoot()), 
                    i = a = n.parentElement(); a = a.parentNode; ) if (a == r) {
                        r = i;
                        break;
                    }
                    return r;
                }
                return r = n.startContainer, 1 == r.nodeType && r.hasChildNodes() && (e && n.collapsed || (r = r.childNodes[Math.min(r.childNodes.length - 1, n.startOffset)])), 
                r && 3 == r.nodeType ? r.parentNode : r;
            },
            getEnd: function(e) {
                var t = this, n = t.getRng(), r, i;
                return n.duplicate || n.item ? n.item ? n.item(0) : (n = n.duplicate(), n.collapse(0), 
                r = n.parentElement(), r.ownerDocument !== t.dom.doc && (r = t.dom.getRoot()), r && "BODY" == r.nodeName ? r.lastChild || r : r) : (r = n.endContainer, 
                i = n.endOffset, 1 == r.nodeType && r.hasChildNodes() && (e && n.collapsed || (r = r.childNodes[i > 0 ? i - 1 : i])), 
                r && 3 == r.nodeType ? r.parentNode : r);
            },
            ...
            setRng: function(e, t) {
                ...
                if (e) if (e.select) try {
                    ...
                    e.collapsed || e.startContainer != e.endContainer || !r.setBaseAndExtent || a.ie || e.endOffset - e.startOffset < 2 && e.startContainer.hasChildNodes() && (i = e.startContainer.childNodes[e.startOffset], 
        ...
        return function(a) {
            ...
            function h() {
                a.addShortcut("meta+b", "bold_desc", "Bold"), a.addShortcut("meta+i", "italic_desc", "Italic"), 
                a.addShortcut("meta+u", "underline_desc", "Underline");
                for (var e = 1; 6 >= e; e++) a.addShortcut("access+" + e, "", [ "FormatBlock", !1, "h" + e ]);
                a.addShortcut("access+7", "", [ "FormatBlock", !1, "p" ]), a.addShortcut("access+8", "", [ "FormatBlock", !1, "div" ]), 
            ...
            function m(e, t) {
                e && ("string" != typeof e ? le(e, function(e, t) {
                    ...
                    e.deep === re && (e.deep = !e.selector), e.split === re && (e.split = !e.selector || e.inline), 
                    e.remove === re && e.selector && !e.inline && (e.remove = "none"), e.selector && e.inline && (e.mixed = !0, 
            ...
            function y(e) {
                var t;
                1 === e.nodeType && e.parentNode && 1 === e.parentNode.nodeType && (t = v(e.parentNode), 
                a.dom.getStyle(e, "color") && t ? a.dom.setStyle(e, "text-decoration", t) : a.dom.getStyle(e, "text-decoration") === t && a.dom.setStyle(e, "text-decoration", null));
            }
            function b(t, n, r) {
                function i(e, t) {
                    if (t = t || u, e) {
                ...
                function l(e, r, o) {
                    ...
                    l = u.inline || u.block, f = q.create(l), i(f), K.walk(e, function(e) {
                        function r(e) {
                            var g, v, y, b, x;
                            return x = h, g = e.nodeName.toLowerCase(), v = e.parentNode.nodeName.toLowerCase(), 
                            1 === e.nodeType && ie(e) && (x = h, h = "true" === ie(e), b = !0), R(g, "br") ? (p = 0, 
                            void (u.block && q.remove(e))) : u.wrapper && w(e, t, n) ? void (p = 0) : h && !b && u.block && !u.wrapper && s(g) && Y(v, l) ? (e = q.rename(e, l), 
                            i(e), a.push(e), void (p = 0)) : u.selector && (le(c, function(t) {
                                "collapsed" in t && t.collapsed !== m || q.is(e, t.selector) && !d(e) && (i(e, t), 
                                y = !0);
                            }), !u.inline || y) ? void (p = 0) : void (!h || b || !Y(l, g) || !Y(v, l) || !o && 3 === e.nodeType && 1 === e.nodeValue.length && 65279 === e.nodeValue.charCodeAt(0) || d(e) || u.inline && G(e) ? (p = 0, 
                            le(ce(e.childNodes), r), b && (h = x), p = 0) : (p || (p = q.clone(f, ee), e.parentNode.insertBefore(p, e), 
                            a.push(p)), p.appendChild(e)));
                        }
                        var p;
                        le(e, r);
                ...
                if (u) if (r) r.nodeType ? (h = q.createRng(), h.setStartBefore(r), h.setEndAfter(r), 
                l(H(h, c), null, !0)) : l(r, null, !0); else if (m && u.inline && !q.select("td.mce-item-selected,th.mce-item-selected").length) V("apply", t, n); else {
                    var g = a.selection.getNode();
                    X || !c[0].defaultBlock || q.getParent(g, q.isBlock) || b(c[0].defaultBlock), a.selection.setRng(o()), 
                    f = j.getBookmark(), l(H(j.getRng(te), c), f), u.styles && (u.styles.color || u.styles.textDecoration) && (ue(g, y, "childNodes"), 
                    y(g)), j.moveToBookmark(f), U(j.getRng(te)), a.nodeChanged();
                }
            }
            function x(e, t, n, r) {
                function i(e) {
                    var n, r, o, a, s;
                    if (1 === e.nodeType && ie(e) && (a = b, b = "true" === ie(e), s = !0), n = ce(e.childNodes), 
                    b && !s) for (r = 0, o = h.length; o > r && !O(h[r], t, e, e); r++) ;
                    if (m.deep && n.length) {
                ...
                function s(e, n, r, i) {
                    ...
                    if (e) {
                        ...
                        !i || m.mixed && G(e) || (n = q.split(e, n)), s && (r.parentNode.insertBefore(s, r), 
                        l.appendChild(r));
                    }
                    return n;
                }
                ...
                function d(e) {
                    ...
                    return se(n) && (n = n[e ? "firstChild" : "lastChild"]), 3 == n.nodeType && 0 === n.data.length && (n = e ? t.previousSibling || t.nextSibling : t.nextSibling || t.previousSibling), 
                    q.remove(t, !0), n;
                }
                function f(e) {
                    ...
                    if (e = H(e, h, te), m.split) {
                        if (t = W(e, te), n = W(e), t != n) {
                            ...
                            r && /^T(HEAD|BODY|FOOT|R)$/.test(r.nodeName) && l(n) && n.firstChild && (n = n.firstChild || n), 
                            q.isChildOf(t, n) && !G(n) && !l(t) && !l(n)) return t = M(t, "span", {
                                id: "_start",
                                "data-mce-type": "bookmark"
                            }), c(t), void (t = d(te));
                            t = M(t, "span", {
                        ...
                        e.startContainer = t.parentNode ? t.parentNode : t, e.startOffset = J(t), e.endContainer = n.parentNode ? n.parentNode : n, 
                        e.endOffset = J(n) + 1;
                    }
                    K.walk(e, function(e) {
                        le(e, function(e) {
                ...
                return n ? void (n.nodeType ? (y = q.createRng(), y.setStartBefore(n), y.setEndAfter(n), 
                f(y)) : f(n)) : void (j.isCollapsed() && m.inline && !q.select("td.mce-item-selected,th.mce-item-selected").length ? V("remove", e, t, r) : (g = j.getBookmark(), 
                f(j.getRng(te)), j.moveToBookmark(g), m.inline && _(e, t, j.getStart()) && U(j.getRng(!0)), 
                a.nodeChanged()));
            }
            function C(e, t, n) {
                var r = p(e);
            ...
            function B(e, t) {
                return ("color" == t || "backgroundColor" == t) && (e = q.toHex(e)), "fontWeight" == t && 700 == e && (e = "bold"), 
            ...
            function H(t, n, r) {
                function i(e) {
                    ...
                    var r, i, o, a, s;
                    if (r = i = e ? g : y, a = e ? "previousSibling" : "nextSibling", s = q.getRoot(), 
                    3 == r.nodeType && !L(r) && (e ? v > 0 : b < r.nodeValue.length)) return r;
                    for (;;) {
                ...
                function c(t, n, i) {
                    function o(e, t) {
                        ...
                        o = a.lastIndexOf(" ", t), n = n > o ? n : o, -1 === n || r || n++) : (n = a.indexOf(" ", t), 
                        o = a.indexOf(" ", t), n = -1 !== n && (-1 === o || o > n) ? n : o), n;
                    }
                    var s, l, c, u;
                    if (3 === t.nodeType) {
                ...
                function d(e, r) {
                    var i, o, a, s;
                    for (3 == e.nodeType && 0 === e.nodeValue.length && e[r] && (e = e[r]), i = u(e), 
                    o = 0; o < i.length; o++) for (a = 0; a < n.length; a++) if (s = n[a], !("collapsed" in s && s.collapsed !== t.collapsed) && q.is(i[o], s.selector)) return i[o];
                    return e;
                }
                function f(e, t) {
                    var r, i = q.getRoot();
                    if (n[0].wrapper || (r = q.getParent(e, n[0].block, i)), r || (r = q.getParent(3 == e.nodeType ? e.parentNode : e, function(e) {
                        return e != i && s(e);
                    })), r && n[0].wrapper && (r = u(r, "ul,ol").reverse()[0] || r), !r) for (r = e; r[t] && !G(r[t]) && (r = r[t], 
                    !R(r, "br")); ) ;
                    return r || e;
                }
                var h, p, m, g = t.startContainer, v = t.startOffset, y = t.endContainer, b = t.endOffset;
                if (1 == g.nodeType && g.hasChildNodes() && (h = g.childNodes.length - 1, g = g.childNodes[v > h ? h : v], 
                3 == g.nodeType && (v = 0)), 1 == y.nodeType && y.hasChildNodes() && (h = y.childNodes.length - 1, 
                y = y.childNodes[b > h ? h : b - 1], 3 == y.nodeType && (b = y.nodeValue.length)), 
                g = l(g), y = l(y), (se(g.parentNode) || se(g)) && (g = se(g) ? g : g.parentNode, 
                g = g.nextSibling || g, 3 == g.nodeType && (v = 0)), (se(y.parentNode) || se(y)) && (y = se(y) ? y : y.parentNode, 
                y = y.previousSibling || y, 3 == y.nodeType && (b = y.length)), n[0].inline && (t.collapsed && (m = c(g, v, !0), 
                m && (g = m.container, v = m.offset), m = c(y, b), m && (y = m.container, b = m.offset)), 
                p = o(y, b), p.node)) {
                ...
                n[0].inline && 3 == y.nodeType && b !== y.nodeValue.length || (y = i())), n[0].selector && n[0].expand !== ee && !n[0].inline && (g = d(g, "previousSibling"), 
                y = d(y, "nextSibling")), (n[0].block || n[0].selector) && (g = f(g, "previousSibling"), 
                y = f(y, "nextSibling"), n[0].block && (G(g) || (g = i(!0)), G(y) || (y = i()))), 
                1 == g.nodeType && (v = J(g), g = g.parentNode), 1 == y.nodeType && (b = J(y) + 1, 
                y = y.parentNode), {
                    startContainer: g,
                    startOffset: v,
                    endContainer: y,
            ...
            function O(e, t, n, r) {
                ...
                le(e.attributes, function(e, i) {
                    ...
                    if (e = D(e, t), "number" == typeof i && (i = e, r = 0), !r || R(q.getAttrib(r, i), e)) {
                        ...
                        "class" == i && n.removeAttribute("className"), Z.test(i) && n.removeAttribute("data-mce-" + i), 
                        n.removeAttribute(i);
                    }
            ...
            function I(e, t) {
                ...
                })) : G(e) && !G(r) && (n(e, ee) || n(e.firstChild, te, 1) || e.insertBefore(q.create("br"), e.firstChild), 
                n(e, te) || n(e.lastChild, ee, 1) || e.appendChild(q.create("br")))), t.selector && t.inline && !R(t.inline, e) || q.remove(e, 1);
            }
            function F(e, t, n) {
            ...
            function V(t, n, r, i) {
                ...
                function d(e, t) {
                    var n, r;
                    if (e) r = j.getRng(!0), l(e) ? (t !== !1 && (r.setStartBefore(e), r.setEndBefore(e)), 
                    q.remove(e)) : (n = u(e), n.nodeValue.charAt(0) === Q && (n.deleteData(0, 1), r.startContainer == n && r.startOffset > 0 && r.setStart(n, r.startOffset - 1), 
                    r.endContainer == n && r.endOffset > 0 && r.setEnd(n, r.endOffset - 1)), q.remove(e, 1)), 
                    j.setRng(r); else if (e = c(j.getStart()), !e) for (;e = q.get(g); ) d(e, !1);
                }
                function f() {
                    var e, t, i, a, s, l, d;
                    e = j.getRng(!0), a = e.startOffset, l = e.startContainer, d = l.nodeValue, t = c(j.getStart()), 
                    t && (i = u(t)), d && a > 0 && a < d.length && /\w/.test(d.charAt(a)) && /\w/.test(d.charAt(a - 1)) ? (s = j.getBookmark(), 
                    e.collapse(!0), e = H(e, p(n)), e = K.split(e), b(n, r, e), j.moveToBookmark(s)) : (t && i.nodeValue === Q ? b(n, r, t) : (t = o(!0), 
                    i = t.firstChild, e.insertNode(t), a = 1, b(n, r, t)), j.setCursorLocation(i, a));
                }
                function h() {
                    ...
                    if (d) if (c) l = j.getBookmark(), e.collapse(!0), e = H(e, p(n), !0), e = K.split(e), 
                    x(n, r, e), j.moveToBookmark(l); else {
                        ...
                        g && q.isEmpty(g) ? d.parentNode.replaceChild(m, d) : q.insertAfter(m, d), j.setCursorLocation(u, 1), 
                ...
                a._hasCaretEvents || (ae = function() {
                    ...
                    var t = e.keyCode;
                    d(), 8 == t && j.isCollapsed() && j.getStart().innerHTML == Q && d(c(j.getStart())), 
                    (37 == t || 39 == t) && d(c(j.getStart())), m();
            ...
            function U(t) {
                ...
                if ((t.startContainer != t.endContainer || !c(t.startContainer.childNodes[t.startOffset])) && (3 == n.nodeType && r >= n.nodeValue.length && (r = J(n), 
                n = n.parentNode, i = !0), 1 == n.nodeType)) for (s = n.childNodes, n = s[Math.min(r, s.length - 1)], 
                o = new e(n, q.getParent(n, q.isBlock)), (r > s.length - 1 || i) && o.next(), a = o.current(); a; a = o.next()) if (3 == a.nodeType && !L(a)) return l = q.create("a", {
                    "data-mce-bogus": "all"
        ...
        function(e) {
            function n() {
                ...
                for (t = t.replace(o, ""), u = d.getShortEndedElements(); c = n.exec(t); ) s = n.lastIndex, 
                l = c[0].length, a = u[c[1]] ? s : r.findEndTag(d, t, s), t = t.substring(0, s - l) + t.substring(a), 
                n.lastIndex = s - l;
                return i(t);
            }
            function a(t) {
            ...
            return e.on("init", function() {
                ...
                var i = r.keyCode;
                r.isDefaultPrevented() || ((i >= 33 && 36 >= i || i >= 37 && 40 >= i || 45 == i || 13 == i || r.ctrlKey) && (s(), 
                e.nodeChanged()), (46 == i || 8 == i || t.mac && (91 == i || 93 == i)) && e.nodeChanged(), 
                f && l.typing && (e.isDirty() || (a(u[0] && n() != u[0].content), e.isNotDirty || e.fire("change", {
                    level: u[0],
                    lastLevel: null
                ...
                if (!e.isDefaultPrevented()) {
                    ...
                    !(16 > t || t > 20) || 224 == t || 91 == t || l.typing || n || (l.beforeChange(), 
                    l.typing = !0, l.add({}, e), f = !0);
                }
            ...
            e.on("AddUndo Undo Redo ClearUndos", function(t) {
                ...
                add: function(t, r) {
                    ...
                    t.bookmark = e.selection.getBookmark(2, !0), c < u.length - 1 && (u.length = c + 1), 
                    u.push(t), c = u.length - 1;
                    var l = {
                        level: t,
                        lastLevel: s,
                        originalEvent: r
                ...
                undo: function() {
                    var t;
                    return l.typing && (l.add(), l.typing = !1), c > 0 && (t = u[--c], 0 === c && a(!1), 
        ...
        return function(i) {
            function o(o) {
                ...
                function m(e) {
                    var t;
                    a.isBlock(e) && (t = s.getRng(), e.appendChild(a.create("span", null, " ")), s.select(e), 
                    e.lastChild.outerHTML = "", s.setRng(t));
                }
                function g(e) {
                    var t = e, n = [], r;
                    if (t) {
                ...
                function v(t) {
                    ...
                    if (t) {
                        ...
                        /^(LI|DT|DD)$/.test(t.nodeName)) {
                            ...
                            d && /^(UL|OL|DL)$/.test(d.nodeName) && t.insertBefore(a.doc.createTextNode(" "), t.firstChild);
                        }
                        ...
                        } else "BR" == t.nodeName ? t.nextSibling && a.isBlock(t.nextSibling) ? ((!H || 9 > H) && (u = a.create("br"), 
                ...
                function x(e) {
                    ...
                    if (e || "TABLE" == z ? (n = a.create(e || V), y(n)) : n = M.cloneNode(!1), o = n, 
                ...
                function w(e, t) {
                    ...
                    if (r = a.getParent(e, a.isBlock), !r || !h(r)) {
                        if (r = r || B, c = r == i.getBody() || p(r) ? r.nodeName.toLowerCase() : r.parentNode.nodeName.toLowerCase(), 
                        !r.hasChildNodes()) return n = a.create(d), y(n), r.appendChild(n), R.setStart(n, 0), 
                        R.setEnd(n, 0), n;
                ...
                function _() {
                    ...
                    if (F != i.getBody()) {
                        ...
                        /^(OL|UL|LI)$/.test(n) && (V = "LI"), O = V ? x(V) : a.create("BR"), e(!0) && e() ? "LI" == n ? a.insertAfter(O, t()) : a.replace(O, F) : e(!0) ? "LI" == n ? (a.insertAfter(O, t()), 
                        O.appendChild(a.doc.createTextNode(" ")), O.appendChild(F)) : F.parentNode.insertBefore(O, F) : e() ? (a.insertAfter(O, t()), 
                        m(O)) : (F = t(), A = R.cloneRange(), A.setStartAfter(M), A.setEndAfter(F), I = A.extractContents(), 
                        "LI" == V && "LI" == I.firstChild.nodeName ? (O = I.firstChild, a.insertAfter(I, F)) : (a.insertAfter(I, F), 
                        a.insertAfter(O, F))), a.remove(M), v(O), c.add();
                    }
                }
                function E() {
                ...
                function T() {
                    O = /^(H[1-6]|PRE|FIGURE)$/.test(z) && "HGROUP" != W ? x(V) : x(), l.end_container_on_empty_block && h(F) && a.isEmpty(M) ? O = a.split(F, M) : a.insertAfter(O, M), 
                    v(O);
                }
                var R, A, B, D, L, M, H, P, O, I, F, z, W, V, U;
                if (R = s.getRng(!0), !o.isDefaultPrevented()) {
                    if (!R.collapsed) return void i.execCommand("Delete");
                    if (new t(a).normalize(R), D = R.startContainer, L = R.startOffset, V = (l.force_p_newlines ? "p" : "") || l.forced_root_block, 
                    V = V ? V.toUpperCase() : "", H = a.doc.documentMode, P = o.shiftKey, 1 == D.nodeType && D.hasChildNodes() && (U = L > D.childNodes.length - 1, 
                    D = D.childNodes[Math.min(L, D.childNodes.length - 1)] || D, L = U && 3 == D.nodeType ? D.nodeValue.length : 0), 
                    B = S(D)) {
                        if (c.beforeChange(), !a.isBlock(B) && B != a.getRoot()) return void ((!V || P) && E());
                        if ((V && !P || !V && P) && (D = w(D, L)), M = a.getParent(D, a.isBlock), F = M ? a.getParent(M.parentNode, a.isBlock) : null, 
                        z = M ? M.nodeName.toUpperCase() : "", W = F ? F.nodeName.toUpperCase() : "", "LI" != W || o.ctrlKey || (M = F, 
                        z = W), /^(LI|DT|DD)$/.test(z)) {
                        ...
                        V && M === i.getBody() || (V = V || "P", C() ? T() : C(!0) ? (O = M.parentNode.insertBefore(x(), M), 
                        m(O), v(M)) : (A = R.cloneRange(), A.setEndAfter(M), I = A.extractContents(), N(I), 
                        O = I.firstChild, a.insertAfter(I, M), g(O), k(M), a.isEmpty(M) && b(M), a.isEmpty(O) ? (a.remove(O), 
                        T()) : v(O)), a.setAttrib(O, "id", ""), i.fire("NewBlock", {
                            newBlock: O
                        }), c.add());
                    }
                }
            ...
            function t() {
                ...
                if (x = n.forced_root_block, t && 1 === t.nodeType && x) {
                    ...
                    for (t = s.firstChild, b = s.nodeName.toLowerCase(); t; ) if ((3 === t.nodeType || 1 == t.nodeType && !a[t.nodeName]) && o.isValidChild(b, x.toLowerCase())) {
                        ...
                        h || (h = r.create(x, e.settings.forced_root_block_attrs), t.parentNode.insertBefore(h, t), 
                        g = !0), p = t, t = t.nextSibling, h.appendChild(p);
        ...
        return function(r) {
            ...
            r.on("PreInit", function() {
                ...
                "InsertUnorderedList,InsertOrderedList": function(e) {
                    var t, n;
                    S(e), t = B.getParent(D.getNode(), "ol,ul"), t && (n = t.parentNode, /^(H[1-6]|P|ADDRESS|PRE)$/.test(n.nodeName) && (R(), 
                    B.split(n, t), A()));
                },
                ...
                FontSize: function(e, t, n) {
                    var r, i;
                    n >= 1 && 7 >= n && (i = d(H.font_size_style_values), r = d(H.font_size_classes), 
                    n = r ? r[n - 1] || n : i[n - 1] || n), T(e, n);
                },
                ...
                mceInsertContent: function(t, n, o) {
                    function a(e) {
                        ...
                        var n, r, i;
                        return n = D.getRng(!0), r = n.startContainer, i = n.startOffset, 3 == r.nodeType && (i > 0 ? e = e.replace(/^&nbsp;/, " ") : t("previousSibling") || (e = e.replace(/^ /, "&nbsp;")), 
                        i < r.length ? e = e.replace(/&nbsp;(<br>|)$/, " ") : t("nextSibling") || (e = e.replace(/(&nbsp;| )(<br>|)$/, "&nbsp;"))), 
                        e;
                    }
                    function l() {
                        var e, t, n;
                        e = D.getRng(!0), t = e.startContainer, n = e.startOffset, 3 == t.nodeType && e.collapsed && (" " === t.data[n] ? (t.deleteData(n, 1), 
                        /[\u00a0| ]$/.test(o) || (o += " ")) : " " === t.data[n - 1] && (t.deleteData(n - 1, 1), 
                        /[\u00a0| ]$/.test(o) || (o = " " + o)));
                    }
                    function c(e) {
                    ...
                    "string" != typeof o && (_ = o.merge, E = o.data, o = o.content), /^ | $/.test(o) && (o = a(o)), 
                    d = r.parser, f = new e({
                        validate: H.validate
                    }, r.schema), w = '<span id="mce_marker" data-mce-type="bookmark">&#xFEFF;&#x200B;</span>', 
                    v = {
                        content: o,
                        format: "html",
                        selection: !0
                    }, r.fire("BeforeSetContent", v), o = v.content, -1 == o.indexOf("{$caret}") && (o += "{$caret}"), 
                    o = o.replace(/\{\$caret\}/, w), b = D.getRng();
                    var S = b.startContainer || (b.parentElement ? b.parentElement() : null), k = r.getBody();
                    S === k && D.isCollapsed() && B.isBlock(k.firstChild) && B.isEmpty(k.firstChild) && (b = B.createRng(), 
                    b.setStart(k.firstChild, 0), b.setEnd(k.firstChild, 0), D.setRng(b)), D.isCollapsed() || (r.getDoc().execCommand("Delete", !1, null), 
                    l()), p = D.getNode();
                    var T = {
                        context: p.nodeName.toLowerCase(),
                        data: E
                    };
                    if (g = d.parse(o, T), c(g), x = g.lastChild, "mce_marker" == x.attr("id")) for (y = x, 
                    x = x.prev; x; x = x.walk(!0)) if (3 == x.type || !B.isBlock(x.name)) {
                        r.schema.isValidChild(x.parent.name, "span") && x.parent.insert(y, x, "br" === x.name);
                        break;
                    }
                    if (T.invalid) {
                        for (D.setContent(w), p = D.getNode(), m = r.getBody(), 9 == p.nodeType ? p = x = m : x = p; x !== m; ) p = x, 
                        x = x.parentNode;
                    ...
                    u(), y = B.get("mce_marker"), D.scrollIntoView(y), b = B.createRng(), x = y.previousSibling, 
                    x && 3 == x.nodeType ? (b.setStart(x, x.nodeValue.length), h || (C = y.nextSibling, 
                    C && 3 == C.nodeType && (x.appendData(C.data), C.parentNode.removeChild(C)))) : (b.setStartBefore(y), 
                    b.setEndBefore(y)), B.remove(y), D.setRng(b), r.fire("SetContent", v), r.addVisual();
                },
                ...
                "Indent,Outdent": function(e) {
                    var t, n, i;
                    t = H.indentation, n = /[a-z%]+$/i.exec(t), t = parseInt(t, 10), y("InsertUnorderedList") || y("InsertOrderedList") ? S(e) : (H.forced_root_block || B.getParent(D.getNode(), B.isBlock) || L.apply("div"), 
                    s(D.getSelectedBlocks(), function(o) {
                        if ("LI" != o.nodeName) {
                            var a = r.getParam("indent_use_margin", !1) ? "margin" : "padding";
                            a += "rtl" == B.getStyle(o, "direction", !0) ? "Right" : "Left", "outdent" == e ? (i = Math.max(0, parseInt(o.style[a] || 0, 10) - t), 
                            B.setStyle(o, a, i ? i + n : "")) : (i = parseInt(o.style[a] || 0, 10) + t + n, 
                            B.setStyle(o, a, i));
                        }
                    }));
                },
                ...
                mceInsertLink: function(e, t, n) {
                    ...
                    "string" == typeof n && (n = {
                        href: n
                    }), r = B.getParent(D.getNode(), "a"), n.href = n.href.replace(" ", "%20"), r && n.href || L.remove("link"), 
                    n.href && L.apply("link", n, r);
                },
                selectAll: function() {
                    var e = B.getRoot(), t;
                    D.getRng().setStart ? (t = B.createRng(), t.setStart(e, 0), t.setEnd(e, e.childNodes.length), 
                    D.setRng(t)) : (t = D.getRng(), t.item || (t.moveToElementText(e), t.select()));
                },
                "delete": function() {
                    S("Delete");
                    var e = r.getBody();
                ...
                InsertLineBreak: function(e, t, n) {
                    ...
                    "LI" != x || C || (v = b, y = x), h && 3 == h.nodeType && f >= h.nodeValue.length && (p || i() || (l = B.create("br"), 
                    d.insertNode(l), d.setStartAfter(l), d.setEndAfter(l), c = !0)), l = B.create("br"), 
                    d.insertNode(l);
                    var w = B.doc.documentMode;
                    return p && "PRE" == y && (!w || 8 > w) && l.parentNode.insertBefore(B.doc.createTextNode("\r"), l), 
                    u = B.create("span", {}, "&nbsp;"), l.parentNode.insertBefore(u, l), D.scrollIntoView(u), 
                    B.remove(u), c ? (d.setStartBefore(l), d.setEndBefore(l)) : (d.setStartAfter(l), 
                    d.setEndAfter(l)), D.setRng(d), r.undoManager.add(), m;
                }
            }), x({
                ...
                "FontSize,FontName": function(e) {
                    var t = 0, n;
                    return (n = B.getParent(D.getNode(), "span")) && (t = "fontsize" == e ? n.style.fontSize : n.style.fontFamily.replace(/, /g, ",").replace(/[\'\"]/g, "").toLowerCase()), 
                    t;
                }
            }, "value"), x({
                Undo: function() {
        ...
        function t(t) {
            ...
            function i(e, i) {
                ...
                }, i.isDefaultPrevented = n, i.isPropagationStopped = n, i.isImmediatePropagationStopped = n), 
                t.beforeFire && t.beforeFire(i), o = d[e]) for (s = 0, l = o.length; l > s; s++) {
            ...
            function o(t, r, i, o) {
                ...
                a = d[t], a || (a = d[t] = [], f(t, !0)), i ? a.unshift(r) : a.push(r);
                return c;
            }
            function a(e, t) {
                var n, r, i, o, a;
                if (e) for (o = e.toLowerCase().split(" "), n = o.length; n--; ) {
                    ...
                    if (r) {
                        if (t) for (a = r.length; a--; ) r[a].func === t && (r = r.slice(0, a).concat(r.slice(a + 1)), 
                        d[e] = r); else r.length = 0;
            ...
            var c = this, u, d = {}, f;
            t = t || {}, u = t.scope || c, f = t.toggleEvent || n, c.fire = i, c.on = o, c.off = a, 
            c.once = s, c.has = l;
        }
        ...
        return e.create = function(t, n) {
            return new e({
                create: function(e, r) {
                    ...
                    var a;
                    return e.on("change:" + r, o), t.on("change:" + n, i), a = e._bindings, a || (a = e._bindings = [], 
        ...
        function d(e) {
            ...
            function i(t) {
                t.preventDefault(), "mousewheel" == t.type ? (t.deltaY = -1 / 40 * t.wheelDelta, 
                t.wheelDeltaX && (t.deltaX = -1 / 40 * t.wheelDeltaX)) : (t.deltaX = 0, t.deltaY = t.detail), 
                t = e.fire("wheel", t);
            }
            var o, s, l, c, u, d;
            if (u = e._nativeEvents) {
                ...
                for (d in u) {
                    ...
                    c._hasMouseEnter = 1) : p[d] || (a(c.getEl()).on(d, t), p[d] = !0), u[d] = !1) : f ? a(e.getEl()).on("mousewheel", i) : a(e.getEl()).on("DOMMouseScroll", i);
                }
            }
        }
        var f = "onmousewheel" in document, h = !1, p = "mce-", m, g = 0, v = {
            ...
            init: function(e) {
                ...
                }), i.classes.prefix = i.classPrefix, o = e.classes, o && (i.Defaults && (c = i.Defaults.classes, 
                c && o != c && n(c)), n(o)), t.each("title text name visible disabled active value".split(" "), function(t) {
                    t in e && i[t](e[t]);
                }), i.on("click", function() {
                    return i.disabled() ? !1 : void 0;
                }), i.settings = e, i.borderBox = s.parseBox(e.border), i.paddingBox = s.parseBox(e.padding), 
                i.marginBox = s.parseBox(e.margin), e.hidden && i.hide();
            },
            ...
            initLayoutRect: function() {
                ...
                n = e.borderBox = e.borderBox || s.measureBox(i, "border"), e.paddingBox = e.paddingBox || s.measureBox(i, "padding"), 
                e.marginBox = e.marginBox || s.measureBox(i, "margin"), p = o.getSize(i), f = t.minWidth, 
                h = t.minHeight, c = f || p.width, u = h || p.height, a = t.width, l = t.height, 
                d = t.autoResize, d = "undefined" != typeof d ? d : !a && !l, a = a || c, l = l || u;
            ...
            layoutRect: function(e) {
                ...
                e.contentH !== s && (n.contentH = e.contentH), r = t._lastLayoutRect, (r.x !== n.x || r.y !== n.y || r.w !== n.w || r.h !== n.h) && (l = m.repaintControls, 
            ...
            repaint: function() {
                ...
                c = document.createRange ? function(e) {
                    return e;
                } : Math.round, t = e.getEl().style, i = e._layoutRect, l = e._lastRepaintRect || {}, 
                o = e.borderBox, a = o.left + o.right, s = o.top + o.bottom, i.x !== l.x && (t.left = c(i.x) + "px", 
                l.x = i.x), i.y !== l.y && (t.top = c(i.y) + "px", l.y = i.y), i.w !== l.w && (u = c(i.w - a), 
                t.width = (u >= 0 ? u : 0) + "px", l.w = i.w), i.h !== l.h && (u = c(i.h - s), t.height = (u >= 0 ? u : 0) + "px", 
                l.h = i.h), e._hasBody && i.innerW !== l.innerW && (u = c(i.innerW), r = e.getEl("body"), 
                r && (n = r.style, n.width = (u >= 0 ? u : 0) + "px"), l.innerW = i.innerW), e._hasBody && i.innerH !== l.innerH && (u = c(i.innerH), 
                r = r || e.getEl("body"), r && (n = n || r.style, n.height = (u >= 0 ? u : 0) + "px"), 
                l.innerH = i.innerH), e._lastRepaintRect = l, e.fire("repaint", {}, !1);
            },
            on: function(e, t) {
                function n(e) {
                    var t, n;
            ...
            fire: function(e, t, n) {
                var r = this;
                if (t = t || {}, t.control || (t.control = r), t = u(r).fire(e, t), n !== !1 && r.parent) for (var i = r.parent(); i && !t.isPropagationStopped(); ) i.fire(e, t, !1), 
                i = i.parent();
                return t;
            },
            hasEventListeners: function(e) {
            ...
            aria: function(e, t) {
                ...
                return "undefined" == typeof t ? n._aria[e] : (n._aria[e] = t, n.state.get("rendered") && r.setAttribute("role" == e ? e : "aria-" + e, t), 
                n);
            },
            encode: function(e, t) {
            ...
            renderTo: function(e) {
                return a(e || this.getContainerElm()).append(this.renderHtml()), this.postRender(), 
                this;
            },
            preRender: function() {},
            render: function() {},
            ...
            postRender: function() {
                ...
                d(e), t.style && (n = e.getEl(), n && (n.setAttribute("style", t.style), n.style.cssText = t.style)), 
                ...
                e.state.get("visible") === !1 && (e.getEl().style.display = "none"), e.bindStates(), 
                e.state.on("change:visible", function(t) {
                    var n = t.value, r;
                    e.state.get("rendered") && (e.getEl().style.display = n === !1 ? "none" : "", e.getEl().getBoundingClientRect()), 
                    r = e.parent(), r && (r._lastRect = null), e.fire(n ? "show" : "hide"), c.add(e);
                }), e.fire("postrender", {}, !1);
            },
            bindStates: function() {},
            scrollIntoView: function(e) {
        ...
        return e.extend({
            init: function(e) {
                var n = this;
                n._super(e), e = n.settings, e.fixed && n.state.set("fixed", !0), n._items = new t(), 
                n.isRtl() && n.classes.add("rtl"), n.bodyClasses = new s(function() {
                    n.state.get("rendered") && (n.getEl("body").className = this.toString());
                }), n.bodyClasses.prefix = n.classPrefix, n.classes.add("container"), n.bodyClasses.add("container-body"), 
                e.containerCls && n.classes.add(e.containerCls), n._layout = r.create((e.layout || "") + "layout"), 
                n.settings.items ? n.add(n.settings.items) : n.add(n.render()), n._hasBody = !0;
            },
            items: function() {
                return this._items;
            },
            ...
            renderNew: function() {
                ...
                return e.items().each(function(t, n) {
                    var r;
                    t.parent(e), t.state.get("rendered") || (r = e.getEl("body"), r.hasChildNodes() && n <= r.childNodes.length - 1 ? a(r.childNodes[n]).before(t.renderHtml()) : a(r).append(t.renderHtml()), 
                    t.postRender(), l.add(t));
            ...
            postRender: function() {
                var e = this, t;
                return e.items().exec("postRender"), e._super(), e._layout.postRender(e), e.state.set("rendered", !0), 
                e.settings.style && e.$el.css(e.settings.style), e.settings.border && (t = e.borderBox, 
                e.$el.css({
        ...
        function n(e) {
            var t, n;
            if (e.changedTouches) for (t = "screenX screenY pageX pageY clientX clientY".split(" "), 
            n = 0; n < t.length; n++) e[t[n]] = e.changedTouches[0][t[n]];
        }
        return function(r, i) {
            function o() {
            ...
            i = i || {}, c = function(r) {
                var c = t(s), p, m;
                n(r), r.preventDefault(), l = r.button, p = o(), f = r.screenX, h = r.screenY, m = window.getComputedStyle ? window.getComputedStyle(p, null).getPropertyValue("cursor") : p.runtimeStyle.cursor, 
                a = e("<div>").css({
                    position: "absolute",
                    top: 0,
                    left: 0,
                    ...
                    opacity: 1e-4,
                    cursor: m
                }).appendTo(s.body), e(s).on("mousemove touchmove", d).on("mouseup touchend", u), 
                i.start(r);
            }, d = function(e) {
                return n(e), e.button !== l ? u(e) : (e.deltaX = e.screenX - f, e.deltaY = e.screenY - h, 
                e.preventDefault(), void i.drag(e));
            }, u = function(t) {
                n(t), e(s).off("mousemove touchmove", d).off("mouseup touchend", u), a.remove(), 
                i.stop && i.stop(t);
                ...
                function n() {
                    function t(t, a, s, l, c, u) {
                        ...
                        if (f = i.getEl("scroll" + t)) {
                            if (y = a.toLowerCase(), b = s.toLowerCase(), e(i.getEl("absend")).css(y, i.layoutRect()[l] - 1), 
                            !c) return void e(f).css("display", "none");
                            e(f).css("display", "block"), d = i.getEl("body"), h = i.getEl("scroll" + t + "t"), 
                            p = d["client" + s] - 2 * o, p -= n && r ? f["client" + u] : 0, m = d["scroll" + s], 
                            g = p / m, v = {}, v[y] = d["offset" + a] + o, v[b] = p, e(f).css(v), v = {}, v[y] = d["scroll" + a] * g, 
                            v[b] = p * g, e(h).css(v);
                        }
                    }
                    var n, r, a;
                    ...
                    function n(n, r, a, s, l) {
                        ...
                        i.draghelper = new t(u + "t", {
                            ...
                            drag: function(e) {
                                ...
                                u = h.contentW > h.innerW, d = h.contentH > h.innerH, f = i.getEl("body")["client" + a] - 2 * o, 
        ...
        return e.extend({
            ...
            renderHtml: function() {
                ...
                return e.preRender(), t.preRender(e), "undefined" == typeof n ? n = '<div id="' + e._id + '-body" class="' + e.bodyClasses + '">' + t.renderHtml(e) + "</div>" : ("function" == typeof n && (n = n.call(e)), 
        ...
        function t(t, n, r) {
            ...
            return f = e.getViewPort(), o = e.getPos(n), a = o.x, s = o.y, t.state.get("fixed") && "static" == e.getRuntimeStyle(document.body, "position") && (a -= f.x, 
            s -= f.y), i = t.getEl(), h = e.getSize(i), l = h.width, c = h.height, h = e.getSize(n), 
            u = h.width, d = h.height, r = (r || "").split(""), "b" === r[0] && (s += d), "r" === r[1] && (a += u), 
        ...
        function d(e, t) {
            ...
            if (v.length) for (n = 0; n < v.length; n++) v[n].modal && (r++, o = v[n]), v[n].getEl().style.zIndex = r, 
            v[n].zIndex = r, r++;
            var a = document.getElementById(t.classPrefix + "modal-block");
            o ? i(a).css("z-index", o.zIndex - 1) : a && (a.parentNode.removeChild(a), y = !1), 
            b.currentZIndex = r;
        }
        function f(e) {
            var t;
        ...
        var h, p, m, g = [], v = [], y, b = e.extend({
            ...
            init: function(e) {
                var t = this;
                t._super(e), t._eventsRoot = t, t.classes.add("floatpanel"), e.autohide && (s(), 
                c(), g.push(t)), e.autofix && (l(), t.on("move", function() {
                    u(this);
                })), t.on("postrender show", function(e) {
                    if (e.control == t) {
                        var n, r = t.classPrefix;
                        t.modal && !y && (n = i("#" + r + "modal-block"), n[0] || (n = i('<div id="' + r + 'modal-block" class="' + r + "reset " + r + 'fade"></div>').appendTo(t.getContainerElm())), 
                        setTimeout(function() {
        ...
        function s(e) {
            ...
            a.overrideViewPort !== !1 && (n || (n = document.createElement("meta"), n.setAttribute("name", "viewport"), 
            document.getElementsByTagName("head")[0].appendChild(n)), i = n.getAttribute("content"), 
            i && "undefined" != typeof d && (d = i), n.setAttribute("content", e ? t : d));
        }
        function l(e) {
        ...
        var u = [], d = "", f = e.extend({
            ...
            init: function(e) {
                var n = this;
                n._super(e), n.isRtl() && n.classes.add("rtl"), n.classes.add("window"), n.bodyClasses.add("window-body"), 
                n.state.set("fixed", !0), e.buttons && (n.statusbar = new t({
                    layout: "flex",
                    border: "1 0 0 0",
                    spacing: 3,
                    padding: 10,
            ...
            initLayoutRect: function() {
                ...
                return t.x = e.settings.x || Math.max(0, a.w / 2 - t.w / 2), t.y = e.settings.y || Math.max(0, a.h / 2 - t.h / 2), 
                t;
            },
            renderHtml: function() {
                var e = this, t = e._layout, n = e._id, r = e.classPrefix, i = e.settings, o = "", a = "", s = i.html;
                return e.preRender(), t.preRender(e), i.title && (o = '<div id="' + n + '-head" class="' + r + 'window-head"><div id="' + n + '-title" class="' + r + 'title">' + e.encode(i.title) + '</div><button type="button" class="' + r + 'close" aria-hidden="true">×</button><div id="' + n + '-dragh" class="' + r + 'dragh"></div></div>'), 
                i.url && (s = '<iframe src="' + i.url + '" tabindex="-1"></iframe>'), "undefined" == typeof s && (s = t.renderHtml(e)), 
                e.statusbar && (a = e.statusbar.renderHtml()), '<div id="' + n + '" class="' + e.classes + '" hidefocus="1"><div class="' + e.classPrefix + 'reset" role="application">' + o + '<div id="' + n + '-body" class="' + e.bodyClasses + '">' + s + "</div>" + a + "</div></div>";
            },
            fullscreen: function(e) {
                ...
                if (e != t._fullscreen) if (r(window).on("resize", function() {
                    ...
                    t._initial = {
                        ...
                        w: l.w,
                        h: l.h
                    }, t.borderBox = o.parseBox("0"), t.getEl("head").style.display = "none", l.deltaH -= l.headerH + 2, 
                    r([ i, document.body ]).addClass(s + "fullscreen"), t.classes.add("fullscreen");
                    var c = n.getWindowSize();
                    t.moveTo(0, 0).resizeTo(c.w, c.h);
                } else t.borderBox = o.parseBox(t.settings.border), t.getEl("head").style.display = "", 
                l.deltaH += l.headerH, r([ i, document.body ]).removeClass(s + "fullscreen"), t.classes.remove("fullscreen"), 
            ...
            remove: function() {
                var e = this, t;
                for (e.dragHelper.destroy(), e._super(), e.statusbar && this.statusbar.remove(), 
                t = u.length; t--; ) u[t] === e && u.splice(t, 1);
        ...
        return function(n) {
            ...
            i.windows = o, n.on("remove", function() {
                ...
                var i;
                return n.editorManager.setActive(n), t.title = t.title || " ", t.url = t.url || t.file, 
                ...
                }), i.features = t || {}, i.params = r || {}, 1 === o.length && n.nodeChanged(), 
                i.renderTo().reflow();
        ...
        return function(l) {
            ...
            function f(e) {
                var t, n;
                e.dataTransfer && (l.selection.isCollapsed() && "IMG" == e.target.tagName && J.select(e.target), 
                t = l.selection.getContent(), t.length > 0 && (n = ie + escape(l.id) + "," + escape(t), 
            ...
            function m() {
                ...
                function c(e) {
                    var n, r, i, o, s;
                    if (!e.collapsed && (n = b.getParent(t.getNode(e.startContainer, e.startOffset), b.isBlock), 
                    r = b.getParent(t.getNode(e.endContainer, e.endOffset), b.isBlock), s = l.schema.getTextBlockElements(), 
                    n != r && s[n.nodeName] && s[r.nodeName] && "false" !== b.getContentEditable(n) && "false" !== b.getContentEditable(r))) return e.deleteContents(), 
                    i = a(n, !1), o = a(r, !0), b.isEmpty(r) || K(n).append(r.childNodes), K(r).remove(), 
                    i ? 1 == i.nodeType ? "BR" == i.nodeName ? (e.setStartBefore(i), e.setEndBefore(i)) : (e.setStartAfter(i), 
                    e.setEndAfter(i)) : (e.setStart(i, i.data.length), e.setEnd(i, i.data.length)) : o && (1 == o.nodeType ? (e.setStartBefore(o), 
                    e.setEndBefore(o)) : (e.setStart(o, 0), e.setEnd(o, 0))), x.setRng(e), !0;
                }
                function u(e, n) {
                    var r, i, s, c, u, d;
                    ...
                    if (r = t.getNode(e.startContainer, e.startOffset), s = b.getParent(r, b.isBlock), 
                    i = a(l.getBody(), n, r), c = b.getParent(i, b.isBlock), !r || !i) return e;
                    if (c && s != c) if (n) {
                        if (!o(s, c)) return e;
                ...
                function g(e, t) {
                    function n(e, n) {
                        return m = K(n).parents().filter(function(e, t) {
                            ...
                            return e = e.cloneNode(!1), c.hasChildNodes() ? (e.appendChild(c.firstChild), c.appendChild(e)) : c.appendChild(e), 
                            c.appendChild(e), e;
                        }), m.length ? (p = b.create("br"), m[0].appendChild(p), b.replace(c, e), t.setStartBefore(p), 
                        t.setEndBefore(p), l.selection.setRng(t), p) : null;
                    }
                    function i(e) {
                        return e && l.schema.getTextBlockElements()[e.tagName];
                    }
                    var o, a, c, u, d, f, h, p, m;
                    if (t.collapsed && (f = t.startContainer, h = t.startOffset, a = b.getParent(f, b.isBlock), 
                    i(a))) if (1 == f.nodeType) {
                        if (f = f.childNodes[h], f && "BR" != f.tagName) return;
                        if (d = e ? a.nextSibling : a.previousSibling, b.isEmpty(a) && i(d) && b.isEmpty(d) && n(a, f)) return b.remove(d), 
                        !0;
                ...
                function v(e) {
                    ...
                    }), l.getDoc().execCommand(e ? "ForwardDelete" : "Delete", !1, null), n = l.selection.getRng(), 
                    r = n.startContainer.parentNode, s.each(t.takeRecords(), function(e) {
                        if (b.isChildOf(e.target, l.getBody())) {
                            ...
                            s.each(e.addedNodes, function(e) {
                                if ("SPAN" == e.nodeName && !e.getAttribute("mce-data-marked")) {
                                    var t, i;
                                    e == r && (t = n.startOffset, i = e.firstChild), b.remove(e, !0), i && (n.setStart(i, t), 
                                    n.setEnd(i, t), l.selection.setRng(n));
                                }
                            });
                        }
                ...
                C || (w = !0, C = function() {
                    ...
                    if (!d(e) && (t || e.keyCode == Y)) {
                        ...
                        e.preventDefault(), n && l.selection.getSel().modify("extend", t ? "forward" : "backward", e.metaKey ? "lineboundary" : "word"), 
                        v(t);
                    }
                }), l.on("keypress", function(t) {
                    if (!d(t) && !x.isCollapsed() && t.charCode > 31 && !e.metaKeyPressed(t)) {
                        var n, r, i, o, a, s;
                        n = l.selection.getRng(), s = String.fromCharCode(t.charCode), t.preventDefault(), 
                        r = K(n.startContainer).parents().filter(function(e, t) {
                            return !!l.schema.getTextInlineElements()[t.nodeName];
                        }), v(!0), r = r.filter(function(e, t) {
                            return !K.contains(l.getBody(), t);
                        }), r.length ? (i = b.createFragment(), r.each(function(e, t) {
                            t = t.cloneNode(!1), i.hasChildNodes() ? (t.appendChild(i.firstChild), i.appendChild(t)) : (a = t, 
                            i.appendChild(t)), i.appendChild(t);
                        }), a.appendChild(l.getDoc().createTextNode(s)), o = b.getParent(n.startContainer, b.isBlock), 
                        b.isEmpty(o) ? K(o).empty().append(i) : n.insertNode(i), n.setStart(a.firstChild, 1), 
                        n.setEnd(a.firstChild, 1), l.selection.setRng(n)) : l.selection.setContent(s);
                    }
                    ...
                    d(e) || !e.clipboardData || l.selection.isCollapsed() || (e.preventDefault(), e.clipboardData.clearData(), 
                    e.clipboardData.setData("text/html", l.selection.getContent()), e.clipboardData.setData("text/plain", l.selection.getContent({
                        format: "text"
            ...
            function g() {
                ...
                l.on("keydown", function(e) {
                    ...
                    if (!d(e) && (t == G || t == Y)) {
                        ...
                        e.preventDefault(), l.setContent(""), i.firstChild && X.isBlock(i.firstChild) ? l.selection.setCursorLocation(i.firstChild, 0) : l.selection.setCursorLocation(i, 0), 
                        l.nodeChanged();
                    }
                });
            }
            ...
            function C() {
                l.on("click", function(e) {
                    var t = e.target;
                    /^(IMG|HR)$/.test(t.nodeName) && (e.preventDefault(), J.getSel().setBaseAndExtent(t, 0, t, 1), 
                    l.nodeChanged()), "A" == t.nodeName && X.hasClass(t, "mce-item-anchor") && (e.preventDefault(), 
                    J.select(t));
                });
            }
            function w() {
                ...
                l.on("keypress", function(n) {
                    var r;
                    return d(n) || 8 != n.keyCode && 46 != n.keyCode || !t() ? void 0 : (r = e(), l.getDoc().execCommand("delete", !1, null), 
            ...
            function N() {
                u() > 7 || (c("RespectVisibilityInDesign", !0), l.contentStyles.push(".mceHideBrInPre pre br {display: none}"), 
                X.addClass(l.getBody(), "mceHideBrInPre"), Z.addNodeFilter("pre", function(e) {
                    for (var t = e.length, n, r, o, a; t--; ) for (n = e[t].getAll("br"), r = n.length; r--; ) o = n[r], 
            ...
            function S() {
                X.bind(l.getBody(), "mouseup", function() {
                    var e, t = J.getNode();
                    "IMG" == t.nodeName && ((e = X.getStyle(t, "width")) && (X.setAttrib(t, "width", e.replace(/[^0-9%]+/g, "")), 
                    X.setStyle(t, "width", "")), (e = X.getStyle(t, "height")) && (X.setAttrib(t, "height", e.replace(/[^0-9%]+/g, "")), 
                    X.setStyle(t, "height", "")));
                });
            }
            function k() {
                l.on("keydown", function(t) {
                    var n, r, i, o, a;
                    if (!d(t) && t.keyCode == e.BACKSPACE && (n = J.getRng(), r = n.startContainer, 
                    i = n.startOffset, o = X.getRoot(), a = r, n.collapsed && 0 === i)) {
                        for (;a && a.parentNode && a.parentNode.firstChild == a && a.parentNode != o; ) a = a.parentNode;
                        "BLOCKQUOTE" === a.tagName && (l.formatter.toggle("blockquote", null, a), n = X.createRng(), 
                        n.setStart(r, 0), n.setEnd(r, 0), J.setRng(n));
                    }
                });
            }
            function T() {
                function e() {
                    l._refreshContentEditable(), c("StyleWithCSS", !1), c("enableInlineTableEditing", !1), 
            ...
            function D() {
                l.on("keydown", function(e) {
                    var t;
                    d(e) || e.keyCode != Y || (t = l.getDoc().selection.createRange(), t && t.item && (e.preventDefault(), 
                    l.undoManager.beforeChange(), X.remove(t.item(0)), l.undoManager.add()));
                });
            }
            function L() {
                var e;
            ...
            function M() {
                u() < 9 && (Z.addNodeFilter("noscript", function(e) {
                    ...
                    for (var t = e.length, n, r, a; t--; ) n = e[t], r = e[t].firstChild, r ? r.value = o.decode(r.value) : (a = n.attributes.map["data-mce-innertext"], 
                    a && (n.attr("data-mce-innertext", null), r = new i("#text", 3), r.value = a, r.raw = !0, 
                    n.append(r)));
                }));
            }
            function H() {
                ...
                function n() {
                    ...
                    a && !e.item && 0 === e.compareEndPoints("StartToEnd", e) && a.select(), X.unbind(r, "mouseup", n), 
                    X.unbind(r, "mousemove", t), a = o = 0;
                }
                ...
                r.documentElement.unselectable = !0, X.bind(r, "mousedown contextmenu", function(i) {
                    if ("HTML" === i.target.nodeName) {
                        ...
                        o = 1, a = e(i.x, i.y), a && (X.bind(r, "mouseup", n), X.bind(r, "mousemove", t), 
                        X.getRoot().focus(), a.select());
                    }
                });
            }
            function P() {
            ...
            function F() {
                l.inline || (l.contentStyles.push("body {min-height: 150px}"), l.on("click", function(e) {
                    ...
                    if ("HTML" == e.target.nodeName) {
                        ...
                        t = l.selection.getRng(), l.getBody().focus(), l.selection.setRng(t), l.selection.normalize(), 
                        l.nodeChanged();
                    }
                }));
            }
            function z() {
                a.mac && l.on("keydown", function(t) {
                    ...
                    l.selection.getSel().modify("move", 37 == t.keyCode ? "backward" : "forward", "lineboundary"));
                });
            }
            function W() {
                c("AutoUrlDetect", !1);
            ...
            k(), g(), P(), re && (m(), y(), C(), A(), U(), E(), $(), a.iOS ? (I(), F(), V()) : v()), 
            ne && a.ie < 11 && (b(), _(), N(), S(), D(), L(), M(), H()), a.ie >= 11 && (F(), 
            E()), a.ie && (v(), W(), q()), te && (b(), x(), w(), T(), R(), B(), O(), z(), E());
        };
    }), r(ge, [ K, b, f ], function(e, t, n) {
        function r(e, t) {
            return "selectionchange" == t ? e.getDoc() : !e.inline && /^mouse|click|contextmenu|drop|dragover|dragend/.test(t) ? e.getDoc().documentElement : e.settings.event_root ? (e.eventRoot || (e.eventRoot = o.select(e.settings.event_root)[0]), 
        ...
        var o = t.DOM, a, s = {
            ...
            toggleNativeEvent: function(e, t) {
                var n = this;
                n.settings.readonly || "focus" != e && "blur" != e && (t ? n.initialized ? i(n, e) : n._pendingNativeEvents ? n._pendingNativeEvents.push(e) : n._pendingNativeEvents = [ e ] : n.initialized && (n.dom.unbind(r(n, e), e, n.delegates[e]), 
            ...
            unbindAllNativeEvents: function() {
                ...
                e.dom.unbind(e.getBody()), e.dom.unbind(e.getContainer());
            }
        };
        ...
        return function(a) {
            function s(e, s, l, c) {
                ...
                f = {
                    ...
                    e in o ? f[e] = !0 : /^[0-9]{2,}$/.test(e) ? f.keyCode = parseInt(e, 10) : (f.charCode = e.charCodeAt(0), 
                    f.keyCode = i[e] || e.toUpperCase().charCodeAt(0));
                }), u = [ f.keyCode ];
                for (d in o) f[d] ? u.push(d) : f[d] = !1;
                return f.id = u.join(","), f.access && (f.alt = !0, t.mac ? f.ctrl = !0 : f.shift = !0), 
                f.meta && (t.mac ? f.meta = !0 : (f.ctrl = !0, f.meta = !1)), f;
            }
            var l = this, c = {};
            a.on("keyup keypress keydown", function(e) {
                (e.altKey || e.ctrlKey || e.metaKey) && !e.isDefaultPrevented() && n(c, function(t) {
                    return t.ctrl == e.ctrlKey && t.meta == e.metaKey && t.alt == e.altKey && t.shift == e.shiftKey && (e.keyCode == t.keyCode || e.charCode && e.charCode == t.charCode) ? (e.preventDefault(), 
                    "keydown" == e.type && t.func.call(t.scope), !0) : void 0;
                });
        ...
        return function(r) {
            ...
            function s(e, t, n) {
                var a, s;
                a = new XMLHttpRequest(), a.open("POST", r.url), a.withCredentials = r.credentials, 
                a.onload = function() {
                    var e;
                    return 200 != a.status ? void n("HTTP Error: " + a.status) : (e = JSON.parse(a.responseText), 
                    e && "string" == typeof e.location ? void t(o(r.basePath, e.location)) : void n("Invalid JSON: " + a.responseText));
        ...
        return function(i) {
            ...
            function a(e, t, n) {
                var r = 0;
                do r = e.indexOf(t, r), -1 !== r && (e = e.substring(0, r) + n + e.substr(r + t.length), 
        ...
        function S(e, t, i) {
            ...
            o.id = t.id = e, o.isNotDirty = !0, o.plugins = {}, o.documentBaseURI = new p(t.document_base_url || a, {
                base_uri: s
            }), o.baseURI = s, o.contentCSS = [], o.contentStyles = [], o.shortcuts = new E(o), 
            o.loadedCSS = {}, o.editorCommands = new h(o), t.target && (o.targetElm = t.target), 
            o.suffix = i.suffix, o.editorManager = i, o.inline = t.inline, t.cache_suffix && (C.cacheSuffix = t.cache_suffix.replace(/^[\?\&]+/, "")), 
            t.override_viewport === !1 && (C.overrideViewPort = !1), i.fire("SetupEditor", o), 
        ...
        return S.prototype = {
            render: function() {
                ...
                function t() {
                    ...
                    r.language_url && e.add(r.language_url), r.theme && "function" != typeof r.theme && "-" != r.theme.charAt(0) && !T.urls[r.theme]) {
                        var t = r.theme_url;
            ...
            init: function() {
                ...
                if (this.editorManager.i18n.setCode(n.language), t.rtl = n.rtl_ui || this.editorManager.i18n.rtl, 
                t.editorManager.add(t), n.aria_label = n.aria_label || k.getAttrib(r, "aria-label", t.getLang("aria.rich_text_area")), 
                n.theme && ("function" != typeof n.theme ? (n.theme = n.theme.replace(/-/, ""), 
                c = T.get(n.theme), t.theme = new c(t, T.urls[n.theme]), t.theme.init && t.theme.init(t, T.urls[n.theme] || t.documentBaseUrl.replace(/\/$/, ""), t.$)) : t.theme = n.theme), 
                B(n.plugins.replace(/\-/g, "").split(/[ ,]/), e), n.render_ui && t.theme && (t.orgDisplay = r.style.display, 
                "function" != typeof n.theme ? (i = n.width || r.style.width || r.offsetWidth, o = n.height || r.style.height || r.offsetHeight, 
                a = n.min_height || 100, h = /^[0-9\.]+(|px)$/i, h.test("" + i) && (i = Math.max(parseInt(i, 10), 100)), 
                h.test("" + o) && (o = Math.max(parseInt(o, 10), a)), l = t.theme.renderUI({
                    targetNode: r,
                    width: i,
                    height: o,
                ...
                o = l.iframeHeight || r.offsetHeight), t.editorContainer = l.editorContainer), n.content_css && B(D(n.content_css), function(e) {
                ...
                f = f[t.id] || ""), n.content_security_policy && (t.iframeHTML += '<meta http-equiv="Content-Security-Policy" content="' + n.content_security_policy + '" />'), 
                ...
                }, k.setAttrib(y, "src", u || 'javascript:""'), t.contentAreaContainer = l.iframeContainer, 
                t.iframeElement = y, s = k.add(l.iframeContainer, y), I) try {
                    t.getDoc();
                } catch (b) {
                    s.src = u = v;
                }
                l.editorContainer && (k.get(l.editorContainer).style.display = t.orgDisplay, t.hidden = k.isHidden(l.editorContainer)), 
                t.getElement().style.display = "none", k.setAttrib(t.id, "aria-hidden", !0), u || t.initContentBody(), 
                r = s = l = null;
            },
            initContentBody: function(t) {
                ...
                }), k.addClass(s, "mce-content-body"), n.contentDocument = h = r.content_document || document, 
                n.contentWindow = r.content_window || window, n.bodyElement = s, r.content_document = r.content_window = null, 
                r.root_name = s.nodeName.toLowerCase()), p = n.getBody(), p.disabled = !0, r.readonly || (n.inline && "static" == k.getStyle(p, "position", !0) && (p.style.position = "relative"), 
                p.contentEditable = n.getParam("content_editable_state", !0)), p.disabled = !1, 
                n.editorUpload = new N(n), n.schema = new y(r), n.dom = new e(h, {
                    keep_values: !0,
                    ...
                    for (var r = e.length, i, o = n.dom, a, s; r--; ) if (i = e[r], a = i.attr(t), s = "data-mce-" + t, 
                    !i.attributes.map[s]) {
                        if (0 === a.indexOf("data:") || 0 === a.indexOf("blob:")) continue;
                        "style" === t ? (a = o.serializeStyle(o.parseStyle(a), i.name), a.length || (a = null), 
                        i.attr(s, a), i.attr(t, a)) : "tabindex" === t ? (i.attr(s, a), i.attr(t, null)) : i.attr(s, n.convertURL(a, t, i.name));
                    }
                ...
                }), n.serializer = new a(r, n), n.selection = new l(n.dom, n.getWin(), n.serializer, n), 
                n.formatter = new c(n), n.undoManager = new u(n), n.forceBlocks = new f(n), n.enterKey = new d(n), 
                n._nodeChangeDispatcher = new i(n), n.fire("PreInit"), r.browser_spellcheck || r.gecko_spellcheck || (h.body.spellcheck = !1, 
                k.setAttrib(p, "spellcheck", "false")), n.fire("PostRender"), n.quirks = new x(n), 
                r.directionality && (p.dir = r.directionality), r.nowrap && (p.style.whiteSpace = "nowrap"), 
            ...
            focus: function(e) {
                ...
                if (!e) {
                    if (i = n.getRng(), i.item && (o = i.item(0)), t._refreshContentEditable(), r || (C.opera || t.getBody().focus(), 
                    t.getWin().focus()), O || r) {
                    ...
                    o && o.ownerDocument == a && (i = a.body.createControlRange(), i.addElement(o), 
                    i.select());
                }
            ...
            execCallback: function(e) {
                ...
                "string" == typeof n && (r = n.replace(/\.\w+$/, ""), r = r ? H(r) : 0, n = H(n), 
            ...
            show: function() {
                var e = this;
                e.hidden && (e.hidden = !1, e.inline ? e.getBody().contentEditable = !0 : (k.show(e.getContainer()), 
                k.hide(e.id)), e.load(), e.fire("show"));
            },
            hide: function() {
                var e = this, t = e.getDoc();
                e.hidden || (I && t && !e.inline && t.execCommand("SelectAll"), e.save(), e.inline ? (e.getBody().contentEditable = !1, 
                e == e.editorManager.focusedEditor && (e.editorManager.focusedEditor = null)) : (k.hide(e.getContainer()), 
                k.setStyle(e.id, "display", e.orgDisplay)), e.hidden = !0, e.fire("hide"));
            },
            isHidden: function() {
                return !!this.hidden;
            },
            ...
            save: function(e) {
                ...
                e.no_events || t.fire("SaveContent", e), "raw" == e.format && t.fire("RawSaveContent", e), 
                r = e.content, /TEXTAREA|INPUT/i.test(n.nodeName) ? n.value = r : (t.inline || (n.innerHTML = r), 
                (i = k.getParent(t.id, "form")) && B(i.elements, function(e) {
            ...
            setContent: function(e, t) {
                ...
                e = t.content, 0 === e.length || /^\s+$/.test(e) ? (o = I && 11 > I ? "" : '<br data-mce-bogus="1">', 
                "TABLE" == r.nodeName ? e = "<tr><td>" + o + "</td></tr>" : /^(UL|OL)$/.test(r.nodeName) && (e = "<li>" + o + "</li>"), 
                i = n.settings.forced_root_block, i && n.schema.isValidChild(r.nodeName.toLowerCase(), i.toLowerCase()) ? (e = o, 
                e = n.dom.createHTML(i, n.settings.forced_root_block_attrs, e)) : I || e || (e = '<br data-mce-bogus="1">'), 
                n.dom.setHTML(r, e), n.fire("SetContent", t)) : ("raw" !== t.format && (e = new s({
                    validate: n.validate
                }, n.schema).serialize(n.parser.parse(e, {
                    isRootContent: !0
                }))), t.content = M(e), n.dom.setHTML(r, t.content), t.no_events || n.fire("SetContent", t)), 
                t.content;
            },
            getContent: function(e) {
                ...
                "text" != e.format ? e.content = M(n) : e.content = n, e.no_events || t.fire("GetContent", e), 
                e.content;
            },
            ...
            remove: function() {
                var e = this;
                e.removed || (e.save(), e.removed = 1, e.unbindAllNativeEvents(), e.hasHiddenInput && k.remove(e.getElement().nextSibling), 
                e.inline || (I && 10 > I && e.getDoc().execCommand("SelectAll", !1, null), k.setStyle(e.id, "display", e.orgDisplay), 
                e.getBody().onload = null), e.fire("remove"), e.editorManager.remove(e), k.remove(e.getContainer()), 
                e.editorUpload.destroy(), e.destroy());
            },
            destroy: function(e) {
                var t = this, n;
                if (!t.destroyed) {
                    ...
                    t.selection.destroy(), t.dom.destroy()), n = t.formElement, n && (n._mceOldSubmit && (n.submit = n._mceOldSubmit, 
                    n._mceOldSubmit = null), k.unbind(n, "submit reset", t.formEventDelegate)), t.contentAreaContainer = t.formElement = t.container = t.editorContainer = null, 
                    t.bodyElement = t.contentDocument = t.contentWindow = null, t.iframeElement = t.targetElm = null, 
            ...
            function d(n) {
                ...
                d.on("init", function() {
                    (d.inline || t.ie) && ("onbeforedeactivate" in document && t.ie < 9 ? d.dom.bind(d.getBody(), "beforedeactivate", function(e) {
                        ...
                        var t = s();
                        "nodechange" == e.type && e.selectionChange || (t && t.id == d.id + "_ifr" && (t = d.getBody()), 
                        d.dom.isChildOf(t, d.getBody()) && (d.lastRng = d.selection.getRng()));
                    ...
                    n && t.target.ownerDocument == document && (n.selection && t.target != n.getBody() && (n.selection.lastFocusBookmark = l(n.dom, n.lastRng)), 
                    t.target == document.body || u(t.target) || e.focusedEditor != n || (n.fire("blur", {
                        focusedEditor: null
        ...
        function d(e) {
            ...
            return b.activeEditor == e && (b.activeEditor = t[0]), b.focusedEditor == e && (b.focusedEditor = null), 
            n;
        }
        function f(e) {
            return e && !(e.getContainer() || e.getBody()).parentNode && (d(e), e.unbindAllNativeEvents(), 
            e.destroy(!0), e = null), e;
        }
            ...
            remove: function(e) {
                var t = this, n, r = t.editors, i;
                {
                    if (e) return "string" == typeof e ? (e = e.selector || e, void m(h.select(e), function(e) {
                        ...
                        editor: i
                    }), r.length || h.unbind(window, "beforeunload", y), i.remove(), u(r, r.length > 0), 
                    i) : null);
        ...
        var n = {
            send: function(e) {
                ...
                e.async = e.async === !1 ? !1 : !0, e.data = e.data || "", i = new XMLHttpRequest()) {
                    if (i.overrideMimeType && i.overrideMimeType(e.content_type), i.open(e.type || (e.data ? "POST" : "GET"), e.url, e.async), 
                    e.crossDomain && (i.withCredentials = !0), e.content_type && i.setRequestHeader("Content-Type", e.content_type), 
        ...
        return e.extend({
            ...
            applyClasses: function(e) {
                ...
                r = n.firstControlClass, i = n.lastControlClass, e.each(function(e) {
                    e.classes.remove(r).remove(i).add(n.controlClass), e.visible() && (o || (o = e), 
                    a = e);
        ...
        var n, r = e.extend({
            init: function(e) {
                ...
                t._super(e), e = t.settings, t.canFocus = !0, e.tooltip && r.tooltips !== !1 && (t.on("mouseenter", function(n) {
                    ...
                    if (n.control == t) {
                        ...
                        r.classes.toggle("tooltip-n", "bc-tc" == i), r.classes.toggle("tooltip-nw", "bc-tl" == i), 
                        r.classes.toggle("tooltip-ne", "bc-tr" == i), r.moveRel(t.getEl(), i);
                    } else r.hide();
            ...
            postRender: function() {
                ...
                e._super(), e.parent() || !t.width && !t.height || (e.initLayoutRect(), e.repaint()), 
                t.autofocus && e.focus();
            },
            bindStates: function() {
                function e(e) {
        ...
        return e.extend({
            ...
            renderHtml: function() {
                ...
                i = " style=\"background-image: url('" + i + "')\"") : i = "", o && e.classes.add("btn-has-text"), 
                r = e.settings.icon ? n + "ico " + n + "i-" + r : "", '<div id="' + t + '" class="' + e.classes + '" tabindex="-1" aria-labelledby="' + t + '"><button role="presentation" type="button" tabindex="-1">' + (r ? '<i class="' + r + '"' + i + "></i>" : "") + (o ? e.encode(o) : "") + "</button></div>";
            },
            bindStates: function() {
                function e(e) {
                ...
                return t.state.on("change:text", function(t) {
                    ...
                    r ? (a && a == o.firstChild || (a = document.createElement("i"), o.insertBefore(a, o.firstChild)), 
                    a.className = r) : a && o.removeChild(a), e(t.state.get("text"));
                }), t._super();
            }
        });
    }), r(We, [ ie ], function(e) {
        ...
        return e.extend({
            ...
            bindStates: function() {
                ...
                return t.state.on("change:text", function(e) {
                    ...
                    n ? (o && o == i.firstChild || (o = document.createElement("i"), i.insertBefore(o, i.firstChild)), 
        ...
        return e.extend({
            init: function(e) {
                var t = this;
                t._super(e), e = t.settings, t.classes.add("combobox"), t.subinput = !0, t.ariaTarget = "inp", 
                e.menu = e.menu || e.values, e.menu && (e.icon = "caret"), t.on("click", function(n) {
                    var i = n.target, o = t.getEl();
                    if (r.contains(o, i) || i == o) for (;i && i != o; ) i.id && -1 != i.id.indexOf("-open") && (t.fire("action"), 
                    e.menu && (t.showMenu(), n.aria && t.menu.items()[0].focus())), i = i.parentNode;
                }), t.on("keydown", function(e) {
                    "INPUT" == e.target.nodeName && 13 == e.keyCode && t.parents().reverse().each(function(n) {
                        var r = t.state.get("value"), i = t.getEl("inp").value;
                        return e.preventDefault(), t.state.set("value", i), r != i && t.fire("change"), 
            ...
            renderHtml: function() {
                ...
                e.classes.add("has-open")), '<div id="' + t + '" class="' + e.classes + '"><input id="' + t + '-inp" class="' + r + 'textbox" value="' + e.encode(i, !1) + '" hidefocus="1"' + l + ' placeholder="' + e.encode(n.placeholder) + '" />' + s + "</div>";
            },
            value: function(e) {
        ...
        return e.extend({
            init: function(e) {
                var t = this;
                e.spellcheck = !1, e.onaction && (e.icon = "none"), t._super(e), t.classes.add("colorbox"), 
        ...
        function e(e) {
            function i(e, i, o) {
                ...
                u == d ? (l = u, {
                    ...
                    s: 0,
                    v: 100 * l
                }) : (c = e == u ? i - o : o == u ? e - i : o - e, a = e == u ? 3 : o == u ? 1 : 5, 
                a = 60 * (a - c / (d - u)), s = (d - u) / d, l = d, {
                    h: r(a),
                    s: r(100 * s),
                    v: r(100 * l)
                });
            ...
            function o(e, i, o) {
                ...
                i = n(0, t(i, 1)), o = n(0, t(o, 1)), 0 === i) return void (d = f = h = r(255 * o));
            ...
            function c(e) {
                ...
                f = parseInt(t[2], 10), h = parseInt(t[3], 10)) : (t = /#([0-F]{2})([0-F]{2})([0-F]{2})/gi.exec(e)) ? (d = parseInt(t[1], 16), 
                f = parseInt(t[2], 16), h = parseInt(t[3], 16)) : (t = /#([0-F])([0-F])([0-F])/gi.exec(e)) && (d = parseInt(t[1] + t[1], 16), 
                f = parseInt(t[2] + t[2], 16), h = parseInt(t[3] + t[3], 16)), d = 0 > d ? 0 : d > 255 ? 255 : d, 
                f = 0 > f ? 0 : f > 255 ? 255 : f, h = 0 > h ? 0 : h > 255 ? 255 : h, u;
            }
        ...
        return e.extend({
            init: function(e) {
                var t = this;
                e.delimiter || (e.delimiter = "»"), t._super(e), t.classes.add("path"), t.canFocus = !0, 
                t.on("click", function(e) {
                    var n, r = e.target;
        ...
        return e.extend({
            ...
            bindStates: function() {
                function e() {
                    var e = 0, n = [], r, i, o;
                    if (t.settings.labelGapCalc !== !1) for (o = "children" == t.settings.labelGapCalc ? t.find("formitem") : t.items(), 
        ...
        return e.extend({
            recalc: function(e) {
                ...
                for (r = e.items().filter(":visible"), i = e.layoutRect(), o = e.paddingBox, a = e.settings, 
                ...
                f = f.split("-")[0]), "column" == f ? (S = "y", E = "h", N = "minH", k = "maxH", 
                R = "innerH", T = "top", A = "deltaH", B = "contentH", P = "left", M = "w", D = "x", 
                L = "innerW", H = "minW", O = "right", I = "deltaW", F = "contentW") : (S = "x", 
                E = "w", N = "minW", k = "maxW", R = "innerW", T = "left", A = "deltaW", B = "contentW", 
                P = "top", M = "h", D = "y", L = "innerH", H = "minH", O = "bottom", I = "deltaH", 
                F = "contentH"), d = i[R] - o[T] - o[T], _ = u = 0, t = 0, n = r.length; n > t; t++) h = r[t], 
                p = h.layoutRect(), m = h.settings, g = m.flex, d -= n - 1 > t ? c : 0, g > 0 && (u += g, 
                p[k] && v.push(h), p.flex = g), d -= p[N], y = o[P] + p[H] + o[O], y > _ && (_ = y);
                if (C = {}, 0 > d ? C[N] = i[N] - d + i[A] : C[N] = i[R] - d + i[A], C[H] = _ + i[I], 
                C[B] = i[R] - d, C[F] = _, C.minW = W(C.minW, i.maxW), C.minH = W(C.minH, i.maxH), 
                C.minW = z(C.minW, i.startMinWidth), C.minH = z(C.minH, i.startMinHeight), !i.autoResize || C.minW == i.minW && C.minH == i.minH) {
                    for (x = d / u, t = 0, n = v.length; n > t; t++) h = v[t], p = h.layoutRect(), b = p[k], 
                    y = p[N] + p.flex * x, y > b ? (d -= p[k] - p[N], u -= p.flex, p.flex = 0, p.maxFlexSize = b) : p.maxFlexSize = 0;
                    for (x = d / u, w = o[T], C = {}, 0 === u && ("end" == l ? w = d + o[T] : "center" == l ? (w = Math.round(i[R] / 2 - (i[R] - d) / 2) + o[T], 
                    0 > w && (w = o[T])) : "justify" == l && (w = o[T], c = Math.floor(d / (r.length - 1)))), 
                    C[D] = o[P], t = 0, n = r.length; n > t; t++) h = r[t], p = h.layoutRect(), y = p.maxFlexSize || p[N], 
                    "center" === s ? C[D] = Math.round(i[L] / 2 - p[M] / 2) : "stretch" === s ? (C[M] = z(p[H] || 0, i[L] - o[P] - o[O]), 
                    C[D] = o[P]) : "end" === s && (C[D] = i[L] - p[M] - o.top), p.flex > 0 && (y += p.flex * x), 
                    C[E] = y, C[S] = w, h.layoutRect(C), h.recalc && h.recalc(), w += y + c;
        ...
        return e.extend({
            recalc: function(e) {
                ...
                x = t.alignH || t.align, C = t.alignV || t.align, g = e.paddingBox, A = "reverseRows" in t ? t.reverseRows : e.isRtl(), 
                x && "string" == typeof x && (x = [ x ]), C && "string" == typeof C && (C = [ C ]);
                for (d = 0; r > d; d++) E.push(0);
                for (f = 0; n > f; f++) N.push(0);
                for (f = 0; n > f; f++) for (d = 0; r > d && (u = i[f * r + d], u); d++) c = u.layoutRect(), 
                S = c.minW, k = c.minH, E[d] = S > E[d] ? S : E[d], N[f] = k > N[f] ? k : N[f];
                ...
                l.minH = Math.max(l.minH, o.startMinHeight), !o.autoResize || l.minW == o.minW && l.minH == o.minH) {
                    ...
                    for (p = g.top, f = 0; n > f; f++) {
                        for (h = g.left, s = N[f] + D, d = 0; r > d && (B = A ? f * r + r - 1 - d : f * r + d, 
                        u = i[B], u); d++) m = u.settings, c = u.layoutRect(), a = Math.max(E[d], c.startMinWidth), 
                        c.x = h, c.y = p, v = m.alignH || (x ? x[d] || x[0] : null), "center" == v ? c.x = h + a / 2 - c.w / 2 : "right" == v ? c.x = h + a - c.w : "stretch" == v && (c.w = a), 
                        v = m.alignV || (C ? C[d] || C[0] : null), "center" == v ? c.y = p + s / 2 - c.h / 2 : "bottom" == v ? c.y = p + s - c.h : "stretch" == v && (c.h = s), 
                        u.layoutRect(c), h += a + y, u.recalc && u.recalc();
                        p += s + b;
                    }
        ...
        return e.extend({
            init: function(e) {
                var t = this;
                t._super(e), t.classes.add("widget").add("label"), t.canFocus = !1, e.multiline && t.classes.add("autoscroll"), 
            ...
            initLayoutRect: function() {
                ...
                if (e.settings.multiline) {
                    ...
                    r.width > n.maxW && (n.minW = n.maxW, e.classes.add("multiline")), e.getEl().style.width = n.minW + "px", 
        ...
        var i = e.extend({
            init: function(e) {
                var t = this;
                t._renderOpen = !0, t._super(e), e = t.settings, t.classes.add("menubtn"), e.fixedWidth && t.classes.add("fixed-width"), 
                t.aria("haspopup", !0), t.state.set("menu", e.menu || t.render());
            },
            showMenu: function() {
                var e = this, n;
                ...
                n.length ? n = {
                    type: "menu",
                    items: n
                } : n.type = n.type || "menu", n.renderTo ? e.menu = n.parent(e).show().renderTo() : e.menu = t.create(n).parent(e).renderTo(), 
                e.fire("createmenu"), e.menu.reflow(), e.menu.on("cancel", function(t) {
            ...
            renderHtml: function() {
                ...
                return o = e.settings.image, o ? (i = "none", "string" != typeof o && (o = window.getSelection ? o[0] : o[1]), 
                o = " style=\"background-image: url('" + o + "')\"") : o = "", i = e.settings.icon ? r + "ico " + r + "i-" + i : "", 
                e.aria("role", e.parent() instanceof n ? "menuitem" : "button"), '<div id="' + t + '" class="' + e.classes + '" tabindex="-1" aria-labelledby="' + t + '"><button id="' + t + '-open" role="presentation" type="button" tabindex="-1">' + (i ? '<i class="' + i + '"' + o + "></i>" : "") + (a ? (i ? " " : "") + e.encode(a) : "") + ' <i class="' + r + 'caret"></i></button></div>';
            },
            postRender: function() {
                var e = this;
        ...
        return e.extend({
            ...
            init: function(e) {
                var t = this, n;
                t._super(e), e = t.settings, t.classes.add("menu-item"), e.menu && t.classes.add("menu-item-expand"), 
                e.preview && t.classes.add("menu-item-preview"), n = t.state.get("text"), ("-" === n || "|" === n) && (t.classes.add("menu-item-sep"), 
                t.aria("role", "separator"), t.state.set("text", "-")), e.selectable && (t.aria("role", "menuitemcheckbox"), 
                t.classes.add("menu-item-checkbox"), e.icon = "selected"), e.preview || e.selectable || t.classes.add("menu-item-normal"), 
            ...
            showMenu: function() {
                ...
                if (i.items().each(function(t) {
                    ...
                    r.moveRel(e.getEl(), o), r.rel = o, o = "menu-sub-" + o, r.classes.remove(r._lastRel).add(o), 
                    r._lastRel = o, e.classes.add("selected"), e.aria("expanded", !0);
                }
            },
            hideMenu: function() {
                var e = this;
            ...
            renderHtml: function() {
                ...
                return s && t.parent().classes.add("menu-has-icons"), i.image && (s = "none", l = " style=\"background-image: url('" + i.image + "')\""), 
                c && (c = e(c)), s = o + "ico " + o + "i-" + (t.settings.icon || "none"), '<div id="' + r + '" class="' + t.classes + '" tabindex="-1">' + ("-" !== a ? '<i class="' + s + '"' + l + "></i> " : "") + ("-" !== a ? '<span id="' + r + '-text" class="' + o + 'text">' + a + "</span>" : "") + (c ? '<div id="' + r + '-shortcut" class="' + o + 'menu-shortcut">' + c + "</div>" : "") + (i.menu ? '<div class="' + o + 'caret"></div>' : "") + "</div>";
            },
            postRender: function() {
            ...
            init: function(e) {
                function t(r) {
                    for (var a = 0; a < r.length; a++) {
                        if (i = r[a].selected || e.value === r[a].value) return o = o || r[a].text, n.state.set("value", r[a].value), 
                        !0;
                        if (r[a].menu && t(r[a].menu)) return !0;
                    }
                }
                var n = this, r, i, o, a;
                n._super(e), e = n.settings, n._values = r = e.values, r && ("undefined" != typeof e.value && t(r), 
                !i && r.length > 0 && (o = r[0].text, n.state.set("value", r[0].value)), n.state.set("menu", r)), 
                n.state.set("text", e.text || o || r[0].text), n.classes.add("listbox"), n.on("select", function(t) {
                    var r = t.control;
                    a && (t.lastControl = a), e.multiple ? r.active(!r.active()) : n.value(t.control.value()), 
                    a = r;
                });
            },
            bindStates: function() {
        ...
        function e(e, t, n) {
            var r, i, o, a, l, c;
            return r = t.x, i = t.y, o = e.w, a = e.h, l = t.w, c = t.h, n = (n || "").split(""), 
            "b" === n[0] && (i += c), "r" === n[1] && (r += l), "c" === n[0] && (i += s(c / 2)), 
            "c" === n[1] && (r += s(l / 2)), "b" === n[3] && (i -= a), "r" === n[4] && (r -= o), 
            "c" === n[3] && (i -= s(a / 2)), "c" === n[4] && (r -= s(o / 2)), {
                x: r,
                y: i,
                w: o,
                h: a
        ...
        function r(e, t) {
            var n, r, i, s;
            return n = a(e.x, t.x), r = a(e.y, t.y), i = o(e.x + e.w, t.x + t.w), s = o(e.y + e.h, t.y + t.h), 
            0 > i - n || 0 > s - r ? null : {
                x: n,
                y: r,
                w: i - n,
        ...
        function i(e, t, n) {
            ...
            return l = e.x, c = e.y, u = e.x + e.w, d = e.y + e.h, f = t.x + t.w, h = t.y + t.h, 
            r = a(0, t.x - l), i = a(0, t.y - c), o = a(0, u - f), s = a(0, d - h), l += r, 
            c += i, n && (u += r, d += i, l -= o, c -= s), u -= o, d -= s, {
                x: l,
                y: c,
                w: u - l,
                h: d - c
        ...
        return e.extend({
            renderHtml: function() {
                var e = this, t = e.classPrefix;
                return e.classes.add("resizehandle"), "both" == e.settings.direction && e.classes.add("resizehandle-both"), 
        ...
        function i(e, t) {
            var r, i, o, a, s;
            "v" == e.settings.orientation ? (a = "top", o = "height", i = "h") : (a = "left", 
            o = "width", i = "w"), r = (e.layoutRect()[i] || 100) - n.getSize(e.getEl("handle"))[o], 
            s = r * ((t - e._minValue) / (e._maxValue - e._minValue)) + "px", e.getEl("handle").style[a] = s, 
        ...
        return e.extend({
            init: function(e) {
                ...
                }), t._super(e), t.classes.add("slider"), "v" == e.orientation && t.classes.add("vertical"), 
                t._minValue = e.minValue || 0, t._maxValue = e.maxValue || 100, t._initValue = t.state.get("value");
            },
            renderHtml: function() {
                var e = this, t = e._id, n = e.classPrefix;
            ...
            postRender: function() {
                ...
                l = e._minValue, c = e._maxValue, s = e.value(), "v" == e.settings.orientation ? (d = "screenY", 
                f = "top", h = "height", p = "h") : (d = "screenX", f = "left", h = "width", p = "w"), 
                e._super(), e._dragHelper = new t(e._id, {
                    handle: e._id + "-handle",
                    start: function(t) {
                        i = t[d], o = parseInt(e.getEl("handle").style[f], 10), u = (e.layoutRect()[p] || 100) - n.getSize(e.getEl("handle"))[h], 
                        e.fire("dragstart", {
                            value: s
                        });
                    },
                    drag: function(t) {
                        ...
                        a = r(o + n, 0, u), h.style[f] = a + "px", s = l + a / u * (c - l), e.value(s), 
                        e.tooltip().text("" + e.settings.previewFilter(s)).show().moveRel(h, "bc tc"), e.fire("drag", {
                            value: s
                        });
                    },
                    stop: function() {
        ...
        return e.extend({
            ...
            renderHtml: function() {
                ...
                return r = e.settings.image, r ? (i = "none", "string" != typeof r && (r = window.getSelection ? r[0] : r[1]), 
                r = " style=\"background-image: url('" + r + "')\"") : r = "", i = e.settings.icon ? n + "ico " + n + "i-" + i : "", 
                '<div id="' + t + '" class="' + e.classes + '" role="button" tabindex="-1"><button type="button" hidefocus="1" tabindex="-1">' + (i ? '<i class="' + i + '"' + r + "></i>" : "") + (o ? (i ? " " : "") + o : "") + '</button><button type="button" class="' + n + 'open" hidefocus="1" tabindex="-1">' + (e._menuBtnText ? (i ? " " : "") + e._menuBtnText : "") + ' <i class="' + n + 'caret"></i></button></div>';
            },
            postRender: function() {
                var e = this, t = e.settings.onclick;
        ...
        return e.extend({
            ...
            activateTab: function(e) {
                var n;
                this.activeTabId && (n = this.getEl(this.activeTabId), t(n).removeClass(this.classPrefix + "active"), 
                n.setAttribute("aria-selected", "false")), this.activeTabId = "t" + e, n = this.getEl("t" + e), 
                n.setAttribute("aria-selected", "true"), t(n).addClass(this.classPrefix + "active"), 
            ...
            initLayoutRect: function() {
                ...
                return e.settings.minWidth = r, e.settings.minHeight = i + o, t = e._super(), t.deltaH += o, 
        ...
        return e.extend({
            ...
            repaint: function() {
                ...
                r = e.borderBox, i = r.left + r.right + 8, o = r.top + r.bottom + (e.settings.multiline ? 8 : 0), 
            ...
            value: function(e) {
                return arguments.length ? (this.state.set("value", e), this) : (this.state.get("rendered") && this.state.set("value", this.getEl().value), 
                this.state.get("value"));
            },
            postRender: function() {
                var e = this;
        ...
        return function(n, r) {
            ...
            i.show = function(t, s) {
                return i.hide(), o = !0, window.setTimeout(function() {
                    o && (e(n).append('<div class="' + a + "throbber" + (r ? " " + a + "throbber-inline" : "") + '"></div>'), 
                    s && s());
                }, t || 0), i;
            }, i.hide = function() {
                var e = n.lastChild;
