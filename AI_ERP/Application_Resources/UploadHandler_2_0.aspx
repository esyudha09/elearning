...
<script language="C#" runat="server">
    ...
    private static string FILES_PATH {
        get {
            ...
            string tr = AI_ERP.Application_Libs.Libs.GetQueryString("tr");
                            ...
                            if (m_kelas != null)
                            {
                                if (m_kelas.Nama != null)
                                {
                                    ...
                                    if (m_sekolah != null)
                                    {
                                        ...
                                        {
                                            if (tr.Trim().ToUpper() == AI_ERP.Application_Libs.TipeRapor.LTS.ToUpper().Trim())
                                            {
                                                return AI_ERP.Application_Libs.Libs.GetLokasiFolderFileLTS(
                                                    id, tahun_ajaran, semester, rel_kelasdet,
                                                    (AI_ERP.Application_Libs.Libs.UnitSekolah)m_sekolah.UrutanJenjang
                                                );
                                            }
                                            else if (tr.Trim().ToUpper() == AI_ERP.Application_Libs.TipeRapor.SEMESTER.ToUpper().Trim())
                                            {
