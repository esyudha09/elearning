...
namespace AI_ERP.Application_Reports.SMP {
    ...
    public class RaporKTSP_OK : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "AI_ERP.Application_Reports.SMP.RaporKTSP-OK.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRaporKTSP_OK : Component, ICachedReport {
        
        public CachedRaporKTSP_OK() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RaporKTSP_OK rpt = new RaporKTSP_OK();
            rpt.Site = this.Site;
            return rpt;
        }
