...
namespace AI_ERP.Application_Controls.AutocompleteRuangKelas
{
    public partial class AutocompleteRuangKelas : System.Web.UI.UserControl
    {
        ...
        {
            RuangKelas m = DAO_RuangKelas.GetByID_Entity(s_val);
