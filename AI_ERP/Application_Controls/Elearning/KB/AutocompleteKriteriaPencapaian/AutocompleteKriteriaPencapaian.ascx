<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AutocompleteKriteriaPencapaian.ascx.cs" Inherits="AI_ERP.Application_Controls.Elearning.KB.AutocompleteKriteriaPencapaian.AutocompleteKriteriaPencapaian" %>
    ...
    function <%=txtNama.ClientID%>_SHOW_AUTOCOMPLETE(){
        $('[id*=<%=txtNama.ClientID%>]').typeahead({
            ...
            source: function (request, response) {
                $.ajax({
                    url: '<%=ResolveUrl("~/APIs/Elearning/KB/KriteriaPencapaian.svc/ShowAutocompleteKriteriaPencapaian?kata_kunci=") %>' + request,
                    dataType: "json",
                    type: "GET",
