...
namespace AI_ERP.Application_Controls.Elearning.KB.AutocompleteKriteriaPencapaian
{
    public partial class AutocompleteKriteriaPencapaian : System.Web.UI.UserControl
    {
        ...
        private void CekDataByValue(string s_val)
        {
            ...
            Rapor_KategoriPencapaian m = DAO_Rapor_KategoriPencapaian.GetByID_Entity(s_val);
