<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AutocompleteKategoriPencapaian.ascx.cs" Inherits="AI_ERP.Application_Controls.Elearning.KB.AutocompleteKategoriPencapaian.AutocompleteKategoriPencapaian" %>
    ...
    function <%=txtNama.ClientID%>_SHOW_AUTOCOMPLETE(){
        $('[id*=<%=txtNama.ClientID%>]').typeahead({
            ...
            source: function (request, response) {
                $.ajax({
                    url: '<%=ResolveUrl("~/APIs/Elearning/KB/KategoriPencapaian.svc/ShowAutocompleteKategoriPencapaian?kata_kunci=") %>' + request,
                    dataType: "json",
                    type: "GET",
