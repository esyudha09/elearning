<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AutocompleteKomponenPenilaian.ascx.cs" Inherits="AI_ERP.Application_Controls.Elearning.SMA.AutocompleteKomponenPenilaian.AutocompleteKomponenPenilaian" %>
    ...
    function <%=txtNama.ClientID%>_SHOW_AUTOCOMPLETE(){
        $('[id*=<%=txtNama.ClientID%>]').typeahead({
            ...
            source: function (request, response) {
                $.ajax({
                    url: '<%=ResolveUrl("~/APIs/Elearning/SMA/KomponenPenilaian.svc/ShowAutocompleteKomponenPenilaian?kata_kunci=") %>' + request,
                    dataType: "json",
                    type: "GET",
