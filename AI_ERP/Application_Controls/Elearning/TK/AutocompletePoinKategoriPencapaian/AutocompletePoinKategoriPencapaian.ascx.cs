...
namespace AI_ERP.Application_Controls.Elearning.TK.AutocompletePoinKategoriPencapaian
{
    public partial class AutocompletePoinKategoriPencapaian : System.Web.UI.UserControl
    {
        ...
        private void CekDataByValue(string s_val)
        {
            ...
            Rapor_PoinKategoriPencapaian m = DAO_Rapor_PoinKategoriPencapaian.GetByID_Entity(s_val);
