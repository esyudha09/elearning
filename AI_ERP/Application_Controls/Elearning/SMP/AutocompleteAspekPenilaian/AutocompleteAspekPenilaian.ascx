<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AutocompleteAspekPenilaian.ascx.cs" Inherits="AI_ERP.Application_Controls.Elearning.SMP.AutocompleteAspekPenilaian.AutocompleteAspekPenilaian" %>
    ...
    function <%=txtNama.ClientID%>_SHOW_AUTOCOMPLETE(){
        $('[id*=<%=txtNama.ClientID%>]').typeahead({
            ...
            source: function (request, response) {
                $.ajax({
                    url: '<%=ResolveUrl("~/APIs/Elearning/SMP/AspekPenilaian.svc/ShowAutocompleteAspekPenilaian?kata_kunci=") %>' + request,
                    dataType: "json",
                    type: "GET",
