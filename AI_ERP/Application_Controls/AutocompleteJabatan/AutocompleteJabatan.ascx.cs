...
namespace AI_ERP.Application_Controls.AutocompleteJabatan
{
    public partial class AutocompleteJabatan : System.Web.UI.UserControl
    {
        ...
        {
            Jabatan m = DAO_Jabatan.GetByID_Entity(s_val);
