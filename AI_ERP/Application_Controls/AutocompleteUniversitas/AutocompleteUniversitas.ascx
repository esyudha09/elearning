<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AutocompleteUniversitas.ascx.cs" Inherits="AI_ERP.Application_Controls.AutocompleteUniversitas.AutocompleteUniversitas" %>
    ...
    function <%=txtNama.ClientID%>_SHOW_AUTOCOMPLETE(){
        $('[id*=<%=txtNama.ClientID%>]').typeahead({
            ...
            source: function (request, response) {
                $.ajax({
                    url: '<%=ResolveUrl("~/APIs/Master/Universitas.svc/ShowAutocomplete?kata_kunci=") %>' + request,
                    dataType: "json",
                    type: "GET",
